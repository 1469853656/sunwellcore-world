...
-- Proof of Demise, Timear Foresees
UPDATE `quest_template` SET `RewardItemId1` = 45624 /*Emblem of Conquest*/ WHERE `Id` IN (13245,13246,13247,13248,13249,13250,13251,13252,13253,13254,13255,13256,14199,13244,13240,13241,13243);
-- RDF rewards
UPDATE `quest_template` SET `RewardItemId1`= 45624 /*Emblem of Conquest*/, `RewardItemCount1`=2 WHERE `Id`=24788; -- 1st daily heroic random
UPDATE `quest_template` SET `RewardItemId1`= 40753 /*Emblem of Valor*/, `RewardItemCount1`=2 WHERE `Id`=24789; -- nth daily heroic random
UPDATE `quest_template` SET `RewardItemId1`= 40753 /*Emblem of Valor*/, `RewardItemCount1`=2 WHERE `Id`=24790; -- 1st daily normal random


-- Disable mythic+
UPDATE `creature` SET `phaseMask` = 2 WHERE `guid` = 310008;
UPDATE `gameobject` SET `phaseMask` = 2 WHERE `guid` = 300089;