...
void LoadDBCStores(const std::string& dataPath)
{
    ...
    LoadDBC(availableDbcLocales, bad_dbc_files, sCharacterFacialHairStylesStore, dbcPath, "CharacterFacialHairStyles.dbc");
    ...
    LoadDBC(availableDbcLocales, bad_dbc_files, sCreatureDisplayInfoStoreRaw, dbcPath, "CreatureDisplayInfo.dbc");
    ...
    if (!sAreaTableStore.LookupEntry(3617) ||        // last area (areaflag) added in 3.3.5a
