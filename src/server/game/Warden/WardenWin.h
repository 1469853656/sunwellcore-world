...
public:
    ...
    bool CanSendLuaCode() const override;
    void SendCharacterScreenScript() override;
    void SendLuaChecks() override;
    bool IsAddonMessageResult(std::string const& target) const override;
    void HandleAddonMessageResult(Player* /*sender*/, std::string&& /*message*/) override;
    void OnLuaCodeSent() override;
