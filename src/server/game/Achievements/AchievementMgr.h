...
struct AchievementCriteriaData
{
    ...
    AchievementCriteriaData()
        : dataType(ACHIEVEMENT_CRITERIA_DATA_TYPE_NONE)
    {
        raw.value1 = 0;
        raw.value2 = 0;
        ScriptId   = 0;
...
class AchievementGlobalMgr : public Sunwell::Singleton<AchievementGlobalMgr>
{
    friend class Sunwell::Singleton<AchievementGlobalMgr>;
