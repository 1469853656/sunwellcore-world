...
//  LANG_BG_EY_START_TWO_MINUTES        = 755, - defined above
    ...
    LANG_BG_STARTED_80_ANNOUNCE_WORLD   = 788,
    ...
    LANG_MAIL_SPAM_REQ_LEVEL                = 10507,
    LANG_WINTERGRASP_CHEAT                  = 10508,
    LANG_POSSIBLE_WINTRADER                 = 10509,
    LANG_ARENA_WIN_REWARD                   = 10510,
    LANG_ARENA_LOSS_REWARD                  = 10511,
    LANG_DUNGEON_CHEST_CHEATER              = 10512,
    LANG_INVITE_SPAMM_GM_NOTICE             = 10513,
    LANG_ARENA_ANNOUNCE_GM                  = 10514,
    LANG_CHAT_MESSAGE_SIZE_ANNOUNCE_GM = 10515,
