...
// Premium Services
enum class PremiumServices
{
    HealthyResurrection,
    IndestructibleArmor,
    UnlimitedHearthstone,
    InstantFlight ,
    RapidExperience,
    WhitemanePlus,
    Max
...
constexpr std::array<std::string_view, static_cast<uint32>(PremiumServices::Max)> PremiumServicesNames
{
    "Healthy Resurrection",
...
enum PremiumServiceData
{
    PREMIUM_HEARTHSTONE_SPELL_ID = 8690
};

// used in some custom events
enum Days
{
    DAY_SUNDAY    = 0,
    DAY_MONDAY    = 1,
...
#define RACEMASK_ALL_PLAYABLE \
    ((1 << (RACE_HUMAN - 1)) | (1 << (RACE_ORC - 1)) | (1 << (RACE_DWARF - 1)) | (1 << (RACE_NIGHTELF - 1)) | (1 << (RACE_UNDEAD_PLAYER - 1)) | (1 << (RACE_TAUREN - 1)) | (1 << (RACE_GNOME - 1)) | (1 << (RACE_TROLL - 1)) | (1 << (RACE_BLOODELF - 1)) | (1 << (RACE_DRAENEI - 1)))

#define RACEMASK_ALLIANCE \
    ((1 << (RACE_HUMAN - 1)) | (1 << (RACE_DWARF - 1)) | (1 << (RACE_NIGHTELF - 1)) | (1 << (RACE_GNOME - 1)) | (1 << (RACE_DRAENEI - 1)))
...
#define CLASSMASK_ALL_PLAYABLE \
    ((1 << (CLASS_WARRIOR - 1)) | (1 << (CLASS_PALADIN - 1)) | (1 << (CLASS_HUNTER - 1)) | (1 << (CLASS_ROGUE - 1)) | (1 << (CLASS_PRIEST - 1)) | (1 << (CLASS_SHAMAN - 1)) | (1 << (CLASS_MAGE - 1)) | (1 << (CLASS_WARLOCK - 1)) | (1 << (CLASS_DRUID - 1)) | (1 << (CLASS_DEATH_KNIGHT - 1)))
...
enum SpellAttr4
{
    ...
    SPELL_ATTR4_UNK3                      = 0x00000008, //  3 Check Hellground: SPELL_ATTR_EX4_CANT_PROC_FROM_SELFCAST
    ...
    SPELL_ATTR4_UNK15                     = 0x00008000, // 15 warrior throws (see dbc corrections)
...
enum SpellAttr5
{
    ...
    SPELL_ATTR5_TREAT_AS_AREA_EFFECT             = 0x00008000, // 15
...
enum SpellAttr6
{
    ...
    SPELL_ATTR6_DELAY_MELEE_DURING_CAST       = 0x00080000, // 19 only 47488, 50782
...
#define CLIENT_MAX_TALENT_SPECS 2
#define MAX_TALENT_SPECS 8
...
#define IMMUNE_TO_MOVEMENT_IMPAIRMENT_AND_LOSS_CONTROL_MASK ( \
    (1 << MECHANIC_CHARM) | (1 << MECHANIC_DISORIENTED) | (1 << MECHANIC_FEAR) | (1 << MECHANIC_ROOT) | (1 << MECHANIC_SLEEP) | (1 << MECHANIC_SNARE) | (1 << MECHANIC_STUN) | (1 << MECHANIC_FREEZE) | (1 << MECHANIC_KNOCKOUT) | (1 << MECHANIC_POLYMORPH) | (1 << MECHANIC_BANISH) | (1 << MECHANIC_SHACKLE) | (1 << MECHANIC_TURN) | (1 << MECHANIC_HORROR) | (1 << MECHANIC_DAZE) | (1 << MECHANIC_SAPPED))
...
enum RangeIndex
{
    RANGE_INDEX_SELF_ONLY                    = 1,
    RANGE_INDEX_COMBAT_5YD                   = 2,
    RANGE_INDEX_20YD                         = 3,
    RANGE_INDEX_MEDIUM_RANGE_30YD            = 4,
    RANGE_INDEX_LONG_RANGE_40YD              = 5,
    RANGE_INDEX_VISION_RANGE_100YD           = 6,
    RANGE_INDEX_10YD                         = 7,
    RANGE_INDEX_MIN_RANGE_10YD_20YD          = 8,
    RANGE_INDEX_MEDIUM_RANGE_30YD_2          = 9,
    RANGE_INDEX_LONG_RANGE_40YD_2            = 10,
    RANGE_INDEX_15YD                         = 11,
    RANGE_INDEX_INTERACT_RANGE_5YD           = 12,
    RANGE_INDEX_ANYWHERE_50000YD             = 13,
    RANGE_INDEX_EXTRA_LONG_RANGE_60YD        = 14,
    RANGE_INDEX_25YD                         = 34,
    RANGE_INDEX_MEDIUM_LONG_RANGE_35YD       = 35,
    RANGE_INDEX_LONGER_RANGE_45YD            = 36,
    RANGE_INDEX_EXTENDED_RANGE_50YD          = 37,
    RANGE_INDEX_MIN_RANGE_10YD_25YD          = 38,
    RANGE_INDEX_MONSTER_SHOOT_30YD           = 54,
    RANGE_INDEX_RANGED_WEAPON_30YD           = 74,
    RANGE_INDEX_STING_40YD                   = 94,
    RANGE_INDEX_CHARGE_25YD                  = 95,
    RANGE_INDEX_TRAP_2YD                     = 96,
    RANGE_INDEX_HUNTER_RANGE_35YD            = 114,
    RANGE_INDEX_TOWER_80YD                   = 134,
    RANGE_INDEX_TOWER_100YD                  = 135,
    RANGE_INDEX_30YD_TO_80YD                 = 136,
    RANGE_INDEX_8YD                          = 137,
    RANGE_INDEX_LONG_RANGE_HUNTER_45YD       = 139,
    RANGE_INDEX_6YD                          = 140,
    RANGE_INDEX_7YD                          = 141,
    RANGE_INDEX_VALGARDE_8YD_100YD           = 150,
    RANGE_INDEX_LONG_RANGE_HUNTER_2_45YD     = 151,
    RANGE_INDEX_SUPER_LONG_150YD             = 152,
    RANGE_INDEX_CHARGE_60YD                  = 153,
    RANGE_INDEX_TOWER_10YD_80YD              = 154,
    RANGE_INDEX_LONG_RANGE_HUNTER_3_45YD     = 155,
    RANGE_INDEX_BOULDER_RANGE_200YD          = 156,
    RANGE_INDEX_90YD                         = 157,
    RANGE_INDEX_SUPER_LONG_15YD_150YD        = 158,
    RANGE_INDEX_TEST_LONG_RANGE_40YD_100YD   = 159,
    RANGE_INDEX_MEDIUM_LONG_RANGE_30YD_40YD  = 160,
    RANGE_INDEX_SHORT_LONG_RANGE_20YD_40YD   = 161,
    RANGE_INDEX_MEDIUM_SHORT_RANGE_20YD_30YD = 162,
    RANGE_INDEX_DEATH_GRIP_30YD              = 163,
    RANGE_INDEX_CATAPULT_RANGE_70YD          = 164,
    RANGE_INDEX_14YD                         = 165,
    RANGE_INDEX_13YD                         = 166,
    RANGE_INDEX_SUPER_LONG_RANGE_150YD       = 167,
    RANGE_INDEX_MEDIUM_LONG_RANGE_38YD       = 168,
    RANGE_INDEX_3YD                          = 169,
    RANGE_INDEX_55YD                         = 170,
    RANGE_INDEX_1YD_TO_10YD                  = 171,
    RANGE_INDEX_11YD                         = 172,
    RANGE_INDEX_ANYWHERE_50000YD_2           = 173,
    RANGE_INDEX_ULTRA_1000YD                 = 174,
    RANGE_INDEX_70YD                         = 176,
    RANGE_INDEX_DONUT_20YD_TO_70YD           = 177,
    RANGE_INDEX_MIN_RANGE_5YD_TO_15YD        = 179,
    RANGE_INDEX_TOURNAMENT_RANGED_25YD       = 180,
    RANGE_INDEX_200YD_REACH                  = 181,
    RANGE_INDEX_MIN_RANGE_5YD_TO_25YD        = 184,
    RANGE_INDEX_300YD                        = 187
};
...
constexpr uint32 MAIL_SUBJECT_MAXIMUM_SIZE{ 64 };
constexpr uint32 MAIL_BODY_MAXIMUM_SIZE{ 500 };
...
enum BattlegroundQueueTypeId
{
    ...
    BATTLEGROUND_QUEUE_SOLO_QUEUE = 10,
    BATTLEGROUND_QUEUE_AV_TWINK   = 11,
    BATTLEGROUND_QUEUE_WS_TWINK   = 12,
    BATTLEGROUND_QUEUE_AB_TWINK   = 13,
    BATTLEGROUND_QUEUE_EY_TWINK   = 14,
    BATTLEGROUND_QUEUE_SA_TWINK   = 15,
    BATTLEGROUND_QUEUE_IC_TWINK   = 16,
