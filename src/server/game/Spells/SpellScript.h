...
#define SPELLSCRIPT_FUNCTION_CAST_DEFINES(CLASSNAME)                                                                                                                      \
    ...
    public:                                                                                                                                                               \
        CastHandlerFunction(SpellCastFnType _pCastHandlerScript)                                                                                                          \
            : SpellScript::CastHandler((SpellScript::SpellCastFnType)_pCastHandlerScript)                                                                                 \
        {                                                                                                                                                                 \
        }                                                                                                                                                                 \
    };                                                                                                                                                                    \
    ...
    {                                                                                                                                                                     \
    public:                                                                                                                                                               \
        EffectHandlerFunction(SpellEffectFnType _pEffectHandlerScript, uint8 _effIndex, uint16 _effName)                                                                  \
            : SpellScript::EffectHandler((SpellScript::SpellEffectFnType)_pEffectHandlerScript, _effIndex, _effName)                                                      \
        {                                                                                                                                                                 \
        }                                                                                                                                                                 \
    };                                                                                                                                                                    \
    ...
    class ObjectAreaTargetSelectHandlerFunction : public SpellScript::ObjectAreaTargetSelectHandler                                                                       \
    {                                                                                                                                                                     \
    public:                                                                                                                                                               \
        ObjectAreaTargetSelectHandlerFunction(SpellObjectAreaTargetSelectFnType _pObjectAreaTargetSelectHandlerScript, uint8 _effIndex, uint16 _targetType)               \
            : SpellScript::ObjectAreaTargetSelectHandler((SpellScript::SpellObjectAreaTargetSelectFnType)_pObjectAreaTargetSelectHandlerScript, _effIndex, _targetType)   \
        {                                                                                                                                                                 \
        }                                                                                                                                                                 \
    };                                                                                                                                                                    \
    class ObjectTargetSelectHandlerFunction : public SpellScript::ObjectTargetSelectHandler                                                                               \
    {                                                                                                                                                                     \
    public:                                                                                                                                                               \
        ObjectTargetSelectHandlerFunction(SpellObjectTargetSelectFnType _pObjectTargetSelectHandlerScript, uint8 _effIndex, uint16 _targetType)                           \
            : SpellScript::ObjectTargetSelectHandler((SpellScript::SpellObjectTargetSelectFnType)_pObjectTargetSelectHandlerScript, _effIndex, _targetType)               \
        {                                                                                                                                                                 \
        }                                                                                                                                                                 \
    };                                                                                                                                                                    \
    ...
    {                                                                                                                                                                     \
    public:                                                                                                                                                               \
        DestinationTargetSelectHandlerFunction(SpellDestinationTargetSelectFnType _DestinationTargetSelectHandlerScript, uint8 _effIndex, uint16 _targetType)             \
            : SpellScript::DestinationTargetSelectHandler((SpellScript::SpellDestinationTargetSelectFnType)_DestinationTargetSelectHandlerScript, _effIndex, _targetType) \
        {                                                                                                                                                                 \
        }                                                                                                                                                                 \
    };
...
#define AURASCRIPT_FUNCTION_CAST_DEFINES(CLASSNAME)                                                                                                      \
    class CheckAreaTargetFunction : public AuraScript::CheckAreaTargetHandler                                                                            \
    {                                                                                                                                                    \
    public:                                                                                                                                              \
        CheckAreaTargetFunction(AuraCheckAreaTargetFnType _pHandlerScript)                                                                               \
            : AuraScript::CheckAreaTargetHandler((AuraScript::AuraCheckAreaTargetFnType)_pHandlerScript)                                                 \
        {                                                                                                                                                \
        }                                                                                                                                                \
    };                                                                                                                                                   \
    ...
    public:                                                                                                                                              \
        AuraDispelFunction(AuraDispelFnType _pHandlerScript)                                                                                             \
            : AuraScript::AuraDispelHandler((AuraScript::AuraDispelFnType)_pHandlerScript)                                                               \
        {                                                                                                                                                \
        }                                                                                                                                                \
    };                                                                                                                                                   \
    class EffectPeriodicHandlerFunction : public AuraScript::EffectPeriodicHandler                                                                       \
    {                                                                                                                                                    \
    public:                                                                                                                                              \
        EffectPeriodicHandlerFunction(AuraEffectPeriodicFnType _pEffectHandlerScript, uint8 _effIndex, uint16 _effName)                                  \
            : AuraScript::EffectPeriodicHandler((AuraScript::AuraEffectPeriodicFnType)_pEffectHandlerScript, _effIndex, _effName)                        \
        {                                                                                                                                                \
        }                                                                                                                                                \
    };                                                                                                                                                   \
    class EffectUpdatePeriodicHandlerFunction : public AuraScript::EffectUpdatePeriodicHandler                                                           \
    {                                                                                                                                                    \
    public:                                                                                                                                              \
        EffectUpdatePeriodicHandlerFunction(AuraEffectUpdatePeriodicFnType _pEffectHandlerScript, uint8 _effIndex, uint16 _effName)                      \
            : AuraScript::EffectUpdatePeriodicHandler((AuraScript::AuraEffectUpdatePeriodicFnType)_pEffectHandlerScript, _effIndex, _effName)            \
        {                                                                                                                                                \
        }                                                                                                                                                \
    };                                                                                                                                                   \
    class EffectCalcAmountHandlerFunction : public AuraScript::EffectCalcAmountHandler                                                                   \
    {                                                                                                                                                    \
    public:                                                                                                                                              \
        EffectCalcAmountHandlerFunction(AuraEffectCalcAmountFnType _pEffectHandlerScript, uint8 _effIndex, uint16 _effName)                              \
            : AuraScript::EffectCalcAmountHandler((AuraScript::AuraEffectCalcAmountFnType)_pEffectHandlerScript, _effIndex, _effName)                    \
        {                                                                                                                                                \
        }                                                                                                                                                \
    };                                                                                                                                                   \
    ...
    {                                                                                                                                                    \
    public:                                                                                                                                              \
        EffectCalcPeriodicHandlerFunction(AuraEffectCalcPeriodicFnType _pEffectHandlerScript, uint8 _effIndex, uint16 _effName)                          \
            : AuraScript::EffectCalcPeriodicHandler((AuraScript::AuraEffectCalcPeriodicFnType)_pEffectHandlerScript, _effIndex, _effName)                \
        {                                                                                                                                                \
        }                                                                                                                                                \
    };                                                                                                                                                   \
    class EffectCalcSpellModHandlerFunction : public AuraScript::EffectCalcSpellModHandler                                                               \
    {                                                                                                                                                    \
    public:                                                                                                                                              \
        EffectCalcSpellModHandlerFunction(AuraEffectCalcSpellModFnType _pEffectHandlerScript, uint8 _effIndex, uint16 _effName)                          \
            : AuraScript::EffectCalcSpellModHandler((AuraScript::AuraEffectCalcSpellModFnType)_pEffectHandlerScript, _effIndex, _effName)                \
        {                                                                                                                                                \
        }                                                                                                                                                \
    };                                                                                                                                                   \
    ...
    {                                                                                                                                                    \
    public:                                                                                                                                              \
        EffectApplyHandlerFunction(AuraEffectApplicationModeFnType _pEffectHandlerScript, uint8 _effIndex, uint16 _effName, AuraEffectHandleModes _mode) \
            : AuraScript::EffectApplyHandler((AuraScript::AuraEffectApplicationModeFnType)_pEffectHandlerScript, _effIndex, _effName, _mode)             \
        {                                                                                                                                                \
        }                                                                                                                                                \
    };                                                                                                                                                   \
    ...
    {                                                                                                                                                    \
    public:                                                                                                                                              \
        EffectAbsorbFunction(AuraEffectAbsorbFnType _pEffectHandlerScript, uint8 _effIndex)                                                              \
            : AuraScript::EffectAbsorbHandler((AuraScript::AuraEffectAbsorbFnType)_pEffectHandlerScript, _effIndex)                                      \
        {                                                                                                                                                \
        }                                                                                                                                                \
    };                                                                                                                                                   \
    class EffectManaShieldFunction : public AuraScript::EffectManaShieldHandler                                                                          \
    {                                                                                                                                                    \
    public:                                                                                                                                              \
        EffectManaShieldFunction(AuraEffectAbsorbFnType _pEffectHandlerScript, uint8 _effIndex)                                                          \
            : AuraScript::EffectManaShieldHandler((AuraScript::AuraEffectAbsorbFnType)_pEffectHandlerScript, _effIndex)                                  \
        {                                                                                                                                                \
        }                                                                                                                                                \
    };                                                                                                                                                   \
    ...
    {                                                                                                                                                    \
    public:                                                                                                                                              \
        EffectSplitFunction(AuraEffectSplitFnType _pEffectHandlerScript, uint8 _effIndex)                                                                \
            : AuraScript::EffectSplitHandler((AuraScript::AuraEffectSplitFnType)_pEffectHandlerScript, _effIndex)                                        \
        {                                                                                                                                                \
        }                                                                                                                                                \
    };                                                                                                                                                   \
    ...
    public:                                                                                                                                              \
        CheckProcHandlerFunction(AuraCheckProcFnType handlerScript)                                                                                      \
            : AuraScript::CheckProcHandler((AuraScript::AuraCheckProcFnType)handlerScript)                                                               \
        {                                                                                                                                                \
        }                                                                                                                                                \
    };                                                                                                                                                   \
    ...
    public:                                                                                                                                              \
        AuraProcHandlerFunction(AuraProcFnType handlerScript)                                                                                            \
            : AuraScript::AuraProcHandler((AuraScript::AuraProcFnType)handlerScript)                                                                     \
        {                                                                                                                                                \
        }                                                                                                                                                \
    };                                                                                                                                                   \
    ...
    {                                                                                                                                                    \
    public:                                                                                                                                              \
        EffectProcHandlerFunction(AuraEffectProcFnType effectHandlerScript, uint8 effIndex, uint16 effName)                                              \
            : AuraScript::EffectProcHandler((AuraScript::AuraEffectProcFnType)effectHandlerScript, effIndex, effName)                                    \
        {                                                                                                                                                \
        }                                                                                                                                                \
    };
