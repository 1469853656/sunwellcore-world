...
enum SpellCustomAttributes : uint32
{
    ...
    SPELL_ATTR0_CU_IGNORE_REMOVE_MECHANICS       = 0x00000020, // Riztazz
    SPELL_ATTR0_CU_AURA_CC                       = 0x00000040,
    SPELL_ATTR0_CU_IGNORE_HEALING_PCT_MODS       = 0x00000080,
...
enum SpellCustomAttributes1 : uint32
{
    ...
    SPELL_ATTR1_CU_DONT_REMOVE_AURA_ON_ABSORB       = 0x00000004,
    ...
    SPELL_ATTR1_CU_PERSIST_AFTER_EVADE              = 0x00000040, // Spells with this attribute can't be removed on evade
    SPELL_ATTR1_CU_INCLUDE_CASTER_SIZE              = 0x00000080,
    SPELL_ATTR1_CU_EXCLUDE_PLAYER_SIZE              = 0x00000100,
};
...
public:
    ...
    bool IsDelayableEffect(uint32 effect) const;
    ...
    bool IsSpellRemovedOnEvade() const;
    ...
    bool IsRidingSpell() const;
    bool RequiresInstantSave() const;
    ...
    int32 CalcPowerCost(Unit const* caster, SpellSchoolMask schoolMask, Spell* spell = nullptr, uint32 manaPercentCu = 0) const;
