...
#define CREATURE_FLAG_EXTRA_DB_ALLOWED (CREATURE_FLAG_EXTRA_INSTANCE_BIND | CREATURE_FLAG_EXTRA_CIVILIAN | CREATURE_FLAG_EXTRA_NO_PARRY | CREATURE_FLAG_EXTRA_NO_PARRY_HASTEN | CREATURE_FLAG_EXTRA_NO_BLOCK | CREATURE_FLAG_EXTRA_NO_CRUSH | CREATURE_FLAG_EXTRA_NO_XP_AT_KILL | CREATURE_FLAG_EXTRA_TRIGGER | CREATURE_FLAG_EXTRA_NO_TAUNT | CREATURE_FLAG_EXTRA_WORLDEVENT | CREATURE_FLAG_EXTRA_NO_CRIT | CREATURE_FLAG_EXTRA_NO_SKILLGAIN | CREATURE_FLAG_EXTRA_TAUNT_DIMINISH | CREATURE_FLAG_EXTRA_ALL_DIMINISH | CREATURE_FLAG_EXTRA_GUARD | CREATURE_FLAG_EXTRA_KNOCKBACK_IMMUNE | CREATURE_FLAG_EXTRA_AVOID_AOE | CREATURE_FLAG_EXTRA_NO_DODGE | CREATURE_FLAG_EXTRA_IGNORE_PATHFINDING | CREATURE_FLAG_EXTRA_DISABLE_CHAIN_PULL | CREATURE_FLAG_EXTRA_NO_PLAYER_DAMAGE_REQ | CREATURE_FLAG_EXTRA_NO_PICKPOCKET)

enum MechanicImmuneMask
{
    MECHANIC_MASK_CHARM           = 0x00000001,
    MECHANIC_MASK_DISORIENTED     = 0x00000002,
    MECHANIC_MASK_DISARM          = 0x00000004,
    MECHANIC_MASK_DISTRACT        = 0x00000008,
    MECHANIC_MASK_FEAR            = 0x00000010,
    MECHANIC_MASK_GRIP            = 0x00000020,
    MECHANIC_MASK_ROOT            = 0x00000040,
    MECHANIC_MASK_SLOW_ATTACK     = 0x00000080,
    MECHANIC_MASK_SILENCE         = 0x00000100,
    MECHANIC_MASK_SLEEP           = 0x00000200,
    MECHANIC_MASK_SNARE           = 0x00000400,
    MECHANIC_MASK_STUN            = 0x00000800,
    MECHANIC_MASK_FREEZE          = 0x00001000,
    MECHANIC_MASK_KNOCKOUT        = 0x00002000,
    MECHANIC_MASK_BLEED           = 0x00004000,
    MECHANIC_MASK_BANDAGE         = 0x00008000,
    MECHANIC_MASK_POLYMORPH       = 0x00010000,
    MECHANIC_MASK_BANISH          = 0x00020000,
    MECHANIC_MASK_SHIELD          = 0x00040000,
    MECHANIC_MASK_SHACKLE         = 0x00080000,
    MECHANIC_MASK_MOUNT           = 0x00100000,
    MECHANIC_MASK_INFECTED        = 0x00200000,
    MECHANIC_MASK_TURN            = 0x00400000,
    MECHANIC_MASK_HORROR          = 0x00800000,
    MECHANIC_MASK_INVULNERABILITY = 0x01000000,
    MECHANIC_MASK_INTERRUPT       = 0x02000000,
    MECHANIC_MASK_DAZE            = 0x04000000,
    MECHANIC_MASK_DISCOVERY       = 0x08000000,
    MECHANIC_MASK_IMMUNE_SHIELD   = 0x10000000,
    MECHANIC_MASK_SAPPED          = 0x20000000,
    MECHANIC_MASK_ENRAGED         = 0x40000000,

    MECHANIC_IMMUNE_MASK_BOSS_ALL = MECHANIC_MASK_CHARM | MECHANIC_MASK_DISORIENTED | MECHANIC_MASK_DISARM | MECHANIC_MASK_DISTRACT | MECHANIC_MASK_FEAR | MECHANIC_MASK_GRIP | MECHANIC_MASK_ROOT | MECHANIC_MASK_SLOW_ATTACK | MECHANIC_MASK_SILENCE | MECHANIC_MASK_SLEEP | MECHANIC_MASK_SNARE | MECHANIC_MASK_STUN | MECHANIC_MASK_FREEZE | MECHANIC_MASK_KNOCKOUT | MECHANIC_MASK_BLEED | MECHANIC_MASK_POLYMORPH | MECHANIC_MASK_BANISH | MECHANIC_MASK_SHACKLE | MECHANIC_MASK_TURN | MECHANIC_MASK_HORROR | MECHANIC_MASK_INTERRUPT | MECHANIC_MASK_DAZE | MECHANIC_MASK_SAPPED,

    MECHANIC_IMMUNE_MASK_ALL = MECHANIC_IMMUNE_MASK_BOSS_ALL | MECHANIC_MASK_BANDAGE | MECHANIC_MASK_SHIELD | MECHANIC_MASK_MOUNT | MECHANIC_MASK_INVULNERABILITY | MECHANIC_MASK_DISCOVERY | MECHANIC_MASK_IMMUNE_SHIELD | MECHANIC_MASK_ENRAGED,
};
...
struct CreatureTemplate
{
    ...
    uint32 flags_extra;
    uint32 ScriptID;
    uint32 MythicTemplateId;
    uint64 PresetGossipFlags;
    float detection_range;
    float Experience_mod = 1.0f;
...
struct VendorItemCount
{
    explicit VendorItemCount(uint32 _item, uint32 _count)
        : itemId(_item)
        , count(_count)
        , lastIncrementTime(time(nullptr))
    {
    }
...
public:
    ...
    bool IsSubjectToAllDiminishingReturns() const;
    ...
    void SetMechanicImmuneMask(MechanicImmuneMask mechanicMask) { _mechanicImmuneMask |= mechanicMask; }
    void RemoveMechanicImmuneMask(MechanicImmuneMask mechanicMask) { _mechanicImmuneMask &= ~mechanicMask; }
    ...
    void SetLootRecipientGroup(uint32 group) { m_lootRecipientGroup = group; }
    bool hasLootRecipient() const { return m_lootRecipient || m_lootRecipientGroup; }

    bool HasPlayersAllowedToLoot() const { return !m_playersAllowedToLoot.empty(); }
    bool IsPlayerAllowedToLoot(uint64 guid) const { return m_playersAllowedToLoot.empty() || m_playersAllowedToLoot.find(guid) != m_playersAllowedToLoot.end(); }
    ...
    std::set<uint64> GetPlayersAllowedToLoot() const { return m_playersAllowedToLoot; }
    ...
    float GetDetectionRange() const { return _detectionDistance; }
    void SetDetectionRange(float dist) { _detectionDistance = dist; }
    ...
    bool IsDancingRuneWeapon() const { return GetEntry() == 27893; }
    ...
    void SetNeedsMotionInitialize(bool apply) { m_needsMotionInitialize = apply; }
    bool IsNeedingMotionInitialize() const { return m_needsMotionInitialize; }

    std::unique_ptr<MythicScaling> m_mythicScaling;
    bool m_mythicBoss;

    bool LootForBody = false;
...
protected:
    ...
    float _detectionDistance = 20.0f;
...
{
public:
    ForcedDespawnDelayEvent(Creature& owner, uint32 respawnTimer)
        : BasicEvent()
        , m_owner(owner)
...
{
public:
    NearbyCreatureChainPullDo(Unit const* _me, Unit* _target, float _range)
        : caller(_me)
...
{
public:
    DelayedAttackStartEvent(uint64 const _targetGUID, Creature* owner)
        : attackTarget(_targetGUID)
        , m_owner(owner)
    {
    }
