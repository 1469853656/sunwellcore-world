...
void Corpse::SaveToDB()
{
    ...
    auto stmt = CharacterDatabase.GetPreparedStatement(CHAR_INS_CORPSE);
...
void Corpse::DeleteFromDB(const CharacterDatabaseTransaction& trans)
{
    auto stmt = CharacterDatabase.GetPreparedStatement(CHAR_DEL_PLAYER_CORPSES);
