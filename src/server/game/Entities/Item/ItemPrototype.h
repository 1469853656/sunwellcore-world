...
enum ItemFlagsCustom
{
    ...
    ITEM_FLAGS_CU_AUTO_LOOTED         = 0x0008  // Item will be auto-looted when boss dies
};
...
#define ITEM_SUBCLASS_MASK_WEAPON_RANGED ( \
    (1 << ITEM_SUBCLASS_WEAPON_BOW) | (1 << ITEM_SUBCLASS_WEAPON_GUN) | (1 << ITEM_SUBCLASS_WEAPON_CROSSBOW) | (1 << ITEM_SUBCLASS_WEAPON_THROWN))
...
struct ItemTemplate
{
    ...
    bool IsAutoLooted() const { return FlagsCu & ITEM_FLAGS_CU_AUTO_LOOTED; }
