...
void CreatureTextMgr::LoadCreatureTexts()
{
    ...
    auto stmt    = WorldDatabase.GetPreparedStatement(WORLD_SEL_CREATURE_TEXT);
    ...
    sLog->outString(">> Loaded %u creature texts for " SIZEFMTD " creatures in %u ms", textCount, mTextMap.size(), GetMSTimeDiffToNow(oldMSTime));
    sLog->outString();
}
