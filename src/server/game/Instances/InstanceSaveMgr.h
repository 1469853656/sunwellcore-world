...
public:
    ...
    void SetCustomDifficulty(CustomDifficulty difficulty) { _customDifficulty = difficulty; }
    CustomDifficulty GetCustomDifficulty() const { return _customDifficulty; }
    ...
    bool RemovePlayer(uint32 guidLow, InstanceSaveManager* ism, bool deleteSave = true);
...
private:
    ...
    CustomDifficulty _customDifficulty = CustomDifficulty::Disabled;
...
struct InstancePlayerBind
{
    ...
    bool perm : 1;
    bool extended : 1;
    uint32 CompletedAscendedEncounters = 0;
    InstancePlayerBind()
        : save(nullptr)
        , perm(false)
        , extended(false)
...
class InstanceSaveManager : public Sunwell::Singleton<InstanceSaveManager>
{
    friend class Sunwell::Singleton<InstanceSaveManager>;
...
public:
    ...
    InstancePlayerBind* PlayerBindToInstance(uint32 guidLow, InstanceSave* save, bool permanent, Player* player = nullptr, uint32 ascendedEncounterIndexMask = 0);
