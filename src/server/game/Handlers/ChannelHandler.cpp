...
void WorldSession::HandleJoinChannel(WorldPacket& recvPacket)
{
    ...
    TeamId channelTeam = sWorld->IsCrossfactionEnabled(Crossfaction::Channels) ? TEAM_NEUTRAL : GetPlayer()->GetTeam(CF_DENY);
    if (Channel* channel = sChannelMgr->GetJoinChannel(channelName, channelId, channelTeam))
...
void WorldSession::HandleLeaveChannel(WorldPacket& recvPacket)
{
    ...
    if (Channel* channel = sChannelMgr->GetChannel(channelName, GetPlayer()))
...
void WorldSession::HandleChannelPassword(WorldPacket& recvPacket)
{
    ...
    if (password.length() > ChannelConstants::MaxPasswordLength)
        return;
...
void WorldSession::HandleChannelSetOwner(WorldPacket& recvPacket)
{
    ...
    {
        sLog->outError("WorldSession::HandleChannelSetOwner: invalid UTF8 sequence - blocked, Player (GUID: %s).", std::to_string(GetPlayer()->GetGUID()).c_str());
        return;
    }
...
void WorldSession::HandleChannelModerator(WorldPacket& recvPacket)
{
    ...
    if (!utf8::is_valid(targetName.begin(), targetName.end()))
    {
        sLog->outError("WorldSession::HandleChannelModerator: invalid UTF8 sequence - blocked, Player (GUID: %s).", std::to_string(GetPlayer()->GetGUID()).c_str());
        return;
    }
...
void WorldSession::HandleChannelUnmoderator(WorldPacket& recvPacket)
{
    ...
    if (!utf8::is_valid(targetName.begin(), targetName.end()))
    {
        sLog->outError("WorldSession::HandleChannelUnmoderator: invalid UTF8 sequence - blocked, Player (GUID: %s).", std::to_string(GetPlayer()->GetGUID()).c_str());
        return;
    }
...
void WorldSession::HandleChannelMute(WorldPacket& recvPacket)
{
    ...
    if (!utf8::is_valid(targetName.begin(), targetName.end()))
    {
        sLog->outError("WorldSession::HandleChannelMute: invalid UTF8 sequence - blocked, Player (GUID: %s).", std::to_string(GetPlayer()->GetGUID()).c_str());
        return;
    }
...
void WorldSession::HandleChannelUnmute(WorldPacket& recvPacket)
{
    ...
    if (!utf8::is_valid(targetName.begin(), targetName.end()))
    {
        sLog->outError("WorldSession::HandleChannelUnmute: invalid UTF8 sequence - blocked, Player (GUID: %s).", std::to_string(GetPlayer()->GetGUID()).c_str());
        return;
    }
...
void WorldSession::HandleChannelInvite(WorldPacket& recvPacket)
{
    ...
    if (!utf8::is_valid(targetName.begin(), targetName.end()))
    {
        sLog->outError("WorldSession::HandleChannelInvite: invalid UTF8 sequence - blocked, Player (GUID: %s).", std::to_string(GetPlayer()->GetGUID()).c_str());
        return;
    }
...
void WorldSession::HandleChannelKick(WorldPacket& recvPacket)
{
    ...
    if (!utf8::is_valid(targetName.begin(), targetName.end()))
    {
        sLog->outError("WorldSession::HandleChannelKick: invalid UTF8 sequence - blocked, Player (GUID: %s).", std::to_string(GetPlayer()->GetGUID()).c_str());
        return;
    }
...
void WorldSession::HandleChannelBan(WorldPacket& recvPacket)
{
    ...
    if (!utf8::is_valid(targetName.begin(), targetName.end()))
    {
        sLog->outError("WorldSession::HandleChannelBan: invalid UTF8 sequence - blocked, Player (GUID: %s).", std::to_string(GetPlayer()->GetGUID()).c_str());
        return;
    }
...
void WorldSession::HandleChannelUnban(WorldPacket& recvPacket)
{
    ...
    if (!utf8::is_valid(targetName.begin(), targetName.end()))
    {
        sLog->outError("WorldSession::HandleChannelUnban: invalid UTF8 sequence - blocked, Player (GUID: %s).", std::to_string(GetPlayer()->GetGUID()).c_str());
        return;
    }
...
void WorldSession::HandleSetChannelWatch(WorldPacket& recvPacket)
{
    ...
    // TODO: find out what this does, it wasn't supported before rework anyway
    // if (Channel* channel = sChannelMgr->GetChannel(channelName, nullptr, false))
