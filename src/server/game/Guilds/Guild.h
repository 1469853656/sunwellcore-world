...
private:
    ...
    public:
        ...
        EventLogEntry(uint32 guildId, uint32 guid, time_t timestamp, GuildEventLogTypes eventType, uint32 playerGuid1, uint32 playerGuid2, uint8 newRank)
            : LogEntry(guildId, guid, timestamp)
            , m_eventType(eventType)
            , m_playerGuid1(playerGuid1)
            , m_playerGuid2(playerGuid2)
            , m_newRank(newRank)
    ...
    public:
        ...
        {
            return eventType == GUILD_BANK_LOG_DEPOSIT_MONEY || eventType == GUILD_BANK_LOG_WITHDRAW_MONEY || eventType == GUILD_BANK_LOG_REPAIR_MONEY;
        }
    ...
    public:
        ...
        void CreateMissingTabsIfNeeded(uint8 ranks, const CharacterDatabaseTransaction& trans, bool logOnCreate = false);
    ...
    public:
        ...
        bool SetItem(CharacterDatabaseTransaction& trans, uint8 slotId, ItemRef const& pItem);
    ...
    public:
        ...
        bool CanStore(ItemRef const& pItem, bool swap, bool sendError);
        // Clones stored item
        ...
        virtual ItemRef StoreItem(CharacterDatabaseTransaction& trans, ItemRef& pItem) = 0;
        // Log bank event
    ...
    protected:
        virtual InventoryResult CanStore(ItemRef const& pItem, bool swap) = 0;
    ...
    public:
        ...
        ItemRef StoreItem(CharacterDatabaseTransaction& trans, ItemRef& pItem);
    ...
    private:
        ItemRef _StoreItem(CharacterDatabaseTransaction& trans, BankTab* pTab, ItemRef& pItem, ItemPosCount& pos, bool clone) const;
...
public:
    ...
    bool AddMember(uint64 guid, uint8 rankId = GUILD_RANK_NONE, CharacterDatabaseTransaction trans = nullptr);
...
private:
    ...
    {
        auto stmt = CharacterDatabase.GetPreparedStatement(CHAR_DEL_GUILD_MEMBER);
    ...
    void _CreateDefaultGuildRanks(LocaleConstant loc, CharacterDatabaseTransaction& trans);
    // Creates new rank
    bool _CreateRank(std::string const& name, uint32 rights, CharacterDatabaseTransaction& trans);
    ...
    ItemRef _GetItem(uint8 tabId, uint8 slotId) const;
