...
public:
    ...
    void SetDifficultyChangePrevention(DifficultyPreventionChangeType type)
    {
        ...
        if (type == DIFFICULTY_PREVENTION_ROLL_ACTIVE && GetDifficultyChangePreventionReason() == DIFFICULTY_PREVENTION_ROLL_ACTIVE && GetDifficultyChangePreventionTime())
            return;
    ...
    // Mythic
    bool const IsMythicGroup() const;
    void SetMythicGroup(bool /*enableMythic*/);
    void SetGroupMythicKeyLevel(uint32 level) { m_groupMythicKeyLevel = level; }
    uint32 const GetGroupMythicKeyLevel() const { return m_groupMythicKeyLevel; }
