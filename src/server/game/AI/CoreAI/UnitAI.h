...
{
public:
    PositionDistanceOrderPred(Position const pos, bool ascending = true)
        : m_refPosition(pos)
        , m_ascending(ascending)
    {
    }
...
public:
    ...
    virtual uint64 GetData64(uint32 /*data = 0*/) const { return 0; }
    ...
    virtual void sGossipSelectSenderAction(Player* /*player*/, uint32 /*sender*/, uint32 /*action*/) { }
