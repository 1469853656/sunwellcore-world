...
class SmartWaypointMgr : public Sunwell::Singleton<SmartWaypointMgr>
{
    friend class Sunwell::Singleton<SmartWaypointMgr>;
    SmartWaypointMgr() {}
...
class SmartAIMgr : public Sunwell::Singleton<SmartAIMgr>
{
    friend class Sunwell::Singleton<SmartAIMgr>;
    SmartAIMgr(){};
