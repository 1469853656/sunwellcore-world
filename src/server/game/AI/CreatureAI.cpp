...
bool CreatureAI::DoZoneInCombat(Creature* creature /*= NULL*/, float maxRangeToNearestTarget /* = 50.0f*/)
{
    if (!creature)
        creature = me;
...
bool CreatureAI::_EnterEvadeMode()
{
    ...
    me->ClearSpellValuesForUnit();

    if (me->IsNeedingMotionInitialize())
    {
        me->GetMotionMaster()->Initialize();
        me->SetNeedsMotionInitialize(false);
    }
