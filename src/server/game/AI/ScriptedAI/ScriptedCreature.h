...
public:
    ...
    void DoAction(int32 info, Predicate& predicate, uint16 max = 0)
    {
        ...
        StorageType listCopy = storage_;
        Trinity::Containers::RandomResize(listCopy, predicate, max);
...
struct ScriptedAI : public CreatureAI
{
    ...
    Unit* DoSelectLowestHpFriendly(float range, uint32 minHPDiff = 1, bool excludePlayers = false);
    ...
    template<class T>
    inline const T& RAID_MODE(const T& normal10, const T& normal25, const T& heroic10, const T& heroic25) const
    {
        switch (_difficulty)
        {
            case RAID_DIFFICULTY_10MAN_NORMAL:
...
public:
    ...
    Milliseconds GetEncounterElapsedTime() const;
