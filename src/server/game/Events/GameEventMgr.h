...
struct GameEventData
{
    GameEventData()
        ...
        , occurence(0)
        , length(0)
        , holiday_id(HOLIDAY_NONE)
        , state(GAMEEVENT_NORMAL)
    {
    }
...
class GameEventMgr : public Sunwell::Singleton<GameEventMgr>
{
    friend class Sunwell::Singleton<GameEventMgr>;
...
public:
    ...
    void OverrideEventStartTime(uint16 event_id, time_t newStartTime);
