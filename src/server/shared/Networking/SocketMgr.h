#ifndef NETWORKING_SOCKET_MGR_H
#define NETWORKING_SOCKET_MGR_H
...
public:
    ...
    virtual bool StartNetwork(std::string const& bindIp, uint16 port, int threadCount)
    {
