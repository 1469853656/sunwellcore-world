...
template<>
struct ContainerArrayList<TypeNull>
{
};
// recursion
template<class H, class T>
struct ContainerArrayList<TypeList<H, T> >
{
...
public:
    ...
    size_t Count() const { return Trinity::Count(i_elements, (SPECIFIC_TYPE*)nullptr); }
