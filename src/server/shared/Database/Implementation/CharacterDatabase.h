...
enum CharacterDatabaseStatements
{
    ...
    */
    ...
    CHAR_REP_CHARACTER_SEASONALQUESTSTATUS,
    ...
    CHAR_INS_PET_SPELL,
    CHAR_INS_PET_AURA,
    CHAR_DEL_PET_AURA_BY_ID_AND_OWNER,
    ...
    CHAR_UDP_CHAR_HUNTER_PET_SLOT_BY_SLOT,
    ...
    // LOOT SAVE SYSTEM
    CHAR_SEL_LOOT_SYSTEM_ITEM_COUNT,
    CHAR_UPD_LOOT_SYSTEM_ITEM_COUNT,
    CHAR_INS_LOOT_SYSTEM_ITEM,
    CHAR_DEL_LOOT_SYSTEM_CREATURE_LOOT,
    CHAR_DEL_LOOT_SYSTEM_ITEM,
    CHAR_SEL_LOOT_SYSTEM_LOOT,
    CHAR_DEL_LOOT_SYSTEM_LOOT,
    // LOOT LOG SYSTEM
    CHAR_INS_LOOT_LOG_ITEM_LOOTED,
    CHAR_INS_LOOT_LOG_LOOT_CREATED,
    //CHAR_INS_ARENA_LOG_MEMBERSTATS,
    // boss records
    ...
    CHAR_REP_NINJA_LOOTER,
    CHAR_SEL_NINJA_LOOTER,
    CHAR_SEL_NINJA_LOOTER_PER_GUID,
    CHAR_DEL_NINJA_LOOTER,
    CHAR_UPD_ADD_TRANSMOG_VISIBILITY,
    CHAR_UPD_REMOVE_TRANSMOG_VISIBILITY,
    CHAR_SEL_MAIL_EXTERNAL,
    CHAR_DEL_MAIL_EXTERNAL,
    CHAR_SEL_MAIL_EXTERNAL_WORLD,
    CHAR_SEL_MAIL_EXTERNAL_MAX,
    CHAR_SEL_PVPSTATS_MAXID,
    CHAR_INS_PVPSTATS_BATTLEGROUND,
    CHAR_INS_PVPSTATS_PLAYER,
    CHAR_SEL_PVPSTATS_FACTIONS_OVERALL,
    CHAR_INS_LOG_TRADE,
    CHAR_SEL_WARDEN_CHECKS_COUNT,
    CHAR_SEL_WARDEN_CHECKS_OLD_COUNT,
    CHAR_DEL_WARDEN_CHECKS_TOO_OLD,
    CHAR_INS_WARDEN_CHECK_FAILURE,

    CHAR_SEL_WEB_COMMANDS,
    CHAR_DEL_WEB_COMMANDS,

    CHAR_REP_CLIENT_ACTION_COUNTER_DATA,
    CHAR_DEL_CLIENT_ACTION_COUNTER_DATA,
    CHAR_SEL_CLIENT_ACTION_COUNTER_DATA,

    CHAR_SEL_CHARACTER_AT_LOGIN_BY_ACC_ID,
    CHAR_SEL_CHARACTER_COUNT_WITH_LEVEL,
    CHAR_INS_LOG_ENCOUNTER,

    // Guardian spells
    CHAR_REP_GUARDIAN_SPELLS,
    CHAR_SEL_GUARDIAN_SPELLS,

    CHAR_INS_LOG_AUCTION_HOUSE,
    /** Mythic System **/
    CHAR_SEL_MYTHIC_STATE_VALUE,
    CHAR_REP_MYTHIC_STATE_VALUE,
    CHAR_SEL_MYTHIC_MAP_DATA,
    /** Mythic Player specific **/
    CHAR_SEL_MYTHIC_KEY_LEVEL,
    CHAR_REP_MYTHIC_KEY_LEVEL,
    CHAR_REP_MYTHIC_RECORD,
    CHAR_UPD_MYTHIC_SILVER_RECORD,
    CHAR_UPD_MYTHIC_BRONZE_RECORD,
    CHAR_SEL_MYTHIC_REWARDS,
    CHAR_REP_MYTHIC_REWARDS,
    CHAR_SEL_MYTHIC_TRANSMOGS,
    CHAR_INS_MYTHIC_TRANSMOGS,
    CHAR_DEL_MYTHIC_TRANSMOGS,

    /** Mythic companion **/
    CHAR_SEL_MYTHIC_COMPANION_DATA,
    CHAR_REP_MYTHIC_COMPANION_EXP_LEVEL,

    CHAR_INS_MYTHIC_KEY_USED,
    CHAR_INS_MYTHICPOWER_LOG,
    ...
    // Misc
    CHAR_SEL_MAXLVL_CHARACTER_COUNT,
    CHAR_SEL_NOT_RESTRICTED_WARPATH_CHARACTER_COUNT,
    CHAR_INS_SOLO_QUEUE_MATCHING_LOG,
    ...
    CHAR_DEL_PURCHASED_TRANSMOG_SETS,
    CHAR_SEL_PURCHASED_TRANSMOG_SETS,
    CHAR_REP_PURCHASED_TRANSMOG_SETS,
    CHAR_SEL_HIGHEST_PURCHASED_TRANSMOG_SET,
