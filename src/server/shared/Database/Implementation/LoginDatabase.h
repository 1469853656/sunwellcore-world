...
enum LoginDatabaseStatements
{
    ...
    */
    ...
    LOGIN_SEL_ACCOUNT_ACCESS_GMLEVEL,
    LOGIN_DEL_REALM_CHARACTERS_BY_REALM,
    LOGIN_INS_REALM_CHARACTERS,

    LOGIN_SEL_LAST_IP_BY_ACCOUNT,
    LOGIN_SEL_ACCOUNT_INFO_BY_ID,
    LOGIN_SEL_BANS,

    LOGIN_UPD_LOGON,
    LOGIN_SEL_ACCOUNT_BANNED,

    //LOGIN_REP_DB_UPDATES,

    LOGIN_SEL_REALM_NAME,

    // Premium Store
    LOGIN_SEL_UNPROCESSED_PREMIUM_STORE_REQUESTS,
    LOGIN_UPD_PREMIUM_STORE_REQUEST_TO_PROCESSED,

    // Premium Services
    LOGIN_SEL_PREMIUM_ACCOUNT,
    LOGIN_SEL_PREMIUM_ACCOUNT_BY_ID,
    LOGIN_REP_PREMIUM_ACCOUNT,
    LOGIN_SEL_PREMIUM_ACCOUNT_EXPIRED_SUBSCRIPTION,
    LOGIN_UPD_PREMIUM_ACCOUNT_EXPIRED_MESSAGE_DISPLAYED,
    LOGIN_SEL_PREMIUM_ACCOUNT_BOUGHT_SUBSCRIPTION,
    LOGIN_UPD_PREMIUM_ACCOUNT_BOUGHT_MESSAGE_DISPLAYED,

    // Northrend Transfers
    //LOGIN_SEL_NORTHREND_TRANSFER_STATUS,
    //LOGIN_UPD_NORTHREND_TRANSFER_STATUS,
