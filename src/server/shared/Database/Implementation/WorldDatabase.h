...
enum WorldDatabaseStatements
{
    ...
    */
    ...
    WORLD_SEL_WARDEN_LUA_CHECK_STATUS,
    WORLD_SEL_RELAY_ADDRESSES,
    WORLD_SEL_JSON_STRINGS,
    WORLD_SEL_CHAT_PROCESSOR_FILTERS,
    WORLD_SEL_BOOST_ITEMS,
    WORLD_SEL_CREATURE_MYTHIC_TEMPLATES,
    WORLD_SEL_MYTHIC_SPELL_DATA,
    WORLD_SEL_MYTHIC_SPELL_VALUES,
    WORLD_SEL_MYTHIC_AFFIX_DATA,
    WORLD_SEL_MYTHIC_PRESETS,
    WORLD_UPD_MYTHIC_TEMPLATE_LEVEL,
    WORLD_UPD_MYTHIC_TEMPLATE_HEALTH,
    WORLD_UPD_MYTHIC_TEMPLATE_POWER,
    WORLD_UPD_MYTHIC_TEMPLATE_MINMELEE,
    WORLD_UPD_MYTHIC_TEMPLATE_MAXMELEE,
    WORLD_UPD_MYTHIC_TEMPLATE_MELEEVAR,
    WORLD_UPD_MYTHIC_TEMPLATE_STATVAR,
