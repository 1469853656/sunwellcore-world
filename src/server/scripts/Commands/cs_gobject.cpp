...
public:
    ...
    std::vector<ChatCommand> GetCommands() const
    {
        ...
        static std::vector<ChatCommand> gobjectCommandTable = {
            ...
            { "add", SEC_GAMEMASTER, CMD_INGAME, nullptr, "", gobjectAddCommandTable },
            { "set", SEC_GAMEMASTER, CMD_INGAME, nullptr, "", gobjectSetCommandTable }
        };
        static std::vector<ChatCommand> commandTable = {
            { "gobject", SEC_GAMEMASTER, CMD_INGAME, nullptr, "", gobjectCommandTable }
        };
        return commandTable;
    }
