...
{
public:
    transfer_commandscript()
        : CommandScript("transfer_commandscript")
    {
    }
    ...
    std::vector<ChatCommand> GetCommands() const
    {
        ...
        static std::vector<ChatCommand> transferCommandTable = {
            { "character", SEC_ADMINISTRATOR, CMD_CLI, nullptr, "", transferCharacterCommandTable },
            { "item", SEC_ADMINISTRATOR, CMD_CLI, nullptr, "", transferItemCommandTable },
            { "pet", SEC_ADMINISTRATOR, CMD_CLI, nullptr, "", transferPetCommandTable }
        };

        static std::vector<ChatCommand> commandTable = {
            { "transfer", SEC_ADMINISTRATOR, CMD_CLI, nullptr, "", transferCommandTable },
        };
