...
public:
    misc_commandscript()
        : CommandScript("misc_commandscript")
    {
    }
    ...
    std::vector<ChatCommand> GetCommands() const
    {
        static std::vector<ChatCommand> groupCommandTable = {
            { "leader", SEC_ADMINISTRATOR, CMD_INGAME, &HandleGroupLeaderCommand, "" },
            { "disband", SEC_ADMINISTRATOR, CMD_INGAME, &HandleGroupDisbandCommand, "" },
            { "remove", SEC_ADMINISTRATOR, CMD_INGAME, &HandleGroupRemoveCommand, "" },
            { "join", SEC_ADMINISTRATOR, CMD_INGAME, &HandleGroupJoinCommand, "" },
            { "list", SEC_ADMINISTRATOR, CMD_INGAME, &HandleGroupListCommand, "" }
        };
        static std::vector<ChatCommand> petCommandTable = {
            { "create", SEC_GAMEMASTER, CMD_INGAME, &HandleCreatePetCommand, "" },
            { "learn", SEC_GAMEMASTER, CMD_INGAME, &HandlePetLearnCommand, "" },
            { "unlearn", SEC_GAMEMASTER, CMD_INGAME, &HandlePetUnlearnCommand, "" }
        };
        ...
        static std::vector<ChatCommand> copyCommandTable = {
            { "spawnid", SEC_ADMINISTRATOR, CMD_INGAME, &HandleCopySpawnIDCommand, "" },
            { "entry", SEC_GAMEMASTER, CMD_INGAME, &HandleCopyEntryCommand, "" },
            { "position", SEC_ADMINISTRATOR, CMD_INGAME, &HandleCopyPositionCommand, "" },
            { "dbposition", SEC_ADMINISTRATOR, CMD_INGAME, &HandleCopyDBPositionCommand, "" },
            { "codeposition", SEC_ADMINISTRATOR, CMD_INGAME, &HandleCopyCodePositionCommand, "" },
        };
        static std::vector<ChatCommand> commandTable = {
            { "dev", SEC_ADMINISTRATOR, CMD_INGAME, &HandleDevCommand, "" },
            { "gps", SEC_ADMINISTRATOR, CMD_INGAME, &HandleGPSCommand, "" },
            { "aura", SEC_ADMINISTRATOR, CMD_INGAME, &HandleAuraCommand, "" },
            { "unaura", SEC_ADMINISTRATOR, CMD_INGAME, &HandleUnAuraCommand, "" },
            { "appear", SEC_GAMEMASTER, CMD_INGAME, &HandleAppearCommand, "" },
            { "summon", SEC_GAMEMASTER, CMD_INGAME, &HandleSummonCommand, "" },
            { "groupsummon", SEC_GAMEMASTER, CMD_INGAME, &HandleGroupSummonCommand, "" },
            { "commands", SEC_PLAYER, CMD_CLI, &HandleCommandsCommand, "" },
            { "die", SEC_ADMINISTRATOR, CMD_INGAME, &HandleDieCommand, "" },
            { "revive", SEC_ADMINISTRATOR, CMD_CLI, &HandleReviveCommand, "" },
            { "dismount", SEC_PLAYER, CMD_INGAME, &HandleDismountCommand, "" },
            { "guid", SEC_GAMEMASTER, CMD_INGAME, &HandleGUIDCommand, "" },
            { "help", SEC_PLAYER, CMD_CLI, &HandleHelpCommand, "" },
            { "itemmove", SEC_GAMEMASTER, CMD_INGAME, &HandleItemMoveCommand, "" },
            { "cooldown", SEC_ADMINISTRATOR, CMD_INGAME, &HandleCooldownCommand, "" },
            { "distance", SEC_ADMINISTRATOR, CMD_INGAME, &HandleGetDistanceCommand, "" },
            { "recall", SEC_GAMEMASTER, CMD_INGAME, &HandleRecallCommand, "" },
            { "save", SEC_PLAYER, CMD_INGAME, &HandleSaveCommand, "" },
            { "saveall", SEC_GAMEMASTER, CMD_CLI, &HandleSaveAllCommand, "" },
            { "kick", SEC_GAMEMASTER, CMD_CLI, &HandleKickPlayerCommand, "" },
            { "gmunstuck", SEC_GAMEMASTER, CMD_CLI, &HandleGMUnstuckCommand, "" },
            { "taxicheat", SEC_GAMEMASTER, CMD_INGAME, &HandleTaxiCheatCommand, "" },
            { "linkgrave", SEC_ADMINISTRATOR, CMD_INGAME, &HandleLinkGraveCommand, "" },
            { "neargrave", SEC_ADMINISTRATOR, CMD_INGAME, &HandleNearGraveCommand, "" },
            { "explorecheat", SEC_ADMINISTRATOR, CMD_INGAME, &HandleExploreCheatCommand, "" },
            { "showarea", SEC_ADMINISTRATOR, CMD_INGAME, &HandleShowAreaCommand, "" },
            { "hidearea", SEC_ADMINISTRATOR, CMD_INGAME, &HandleHideAreaCommand, "" },
            { "additem", SEC_ADMINISTRATOR, CMD_INGAME, &HandleAddItemCommand, "" },
            { "additemset", SEC_ADMINISTRATOR, CMD_INGAME, &HandleAddItemSetCommand, "" },
            { "bank", SEC_ADMINISTRATOR, CMD_INGAME, &HandleBankCommand, "" },
            { "wchange", SEC_ADMINISTRATOR, CMD_INGAME, &HandleChangeWeather, "" },
            { "maxskill", SEC_ADMINISTRATOR, CMD_INGAME, &HandleMaxSkillCommand, "" },
            { "setskill", SEC_ADMINISTRATOR, CMD_INGAME, &HandleSetSkillCommand, "" },
            { "pinfo", SEC_GAMEMASTER, CMD_CLI, &HandlePInfoCommand, "" },
            { "respawn", SEC_ADMINISTRATOR, CMD_INGAME, &HandleRespawnCommand, "" },
            { "send", SEC_GAMEMASTER, CMD_CLI, nullptr, "", sendCommandTable },
            { "pet", SEC_GAMEMASTER, CMD_INGAME, nullptr, "", petCommandTable },
            { "mute", SEC_GAMEMASTER, CMD_CLI, &HandleMuteCommand, "" },
            { "unmute", SEC_GAMEMASTER, CMD_CLI, &HandleUnmuteCommand, "" },
            { "movegens", SEC_ADMINISTRATOR, CMD_INGAME, &HandleMovegensCommand, "" },
            { "cometome", SEC_ADMINISTRATOR, CMD_INGAME, &HandleComeToMeCommand, "" },
            { "damage", SEC_ADMINISTRATOR, CMD_INGAME, &HandleDamageCommand, "" },
            { "combatstop", SEC_GAMEMASTER, CMD_CLI, &HandleCombatStopCommand, "" },
            { "repairitems", SEC_GAMEMASTER, CMD_CLI, &HandleRepairitemsCommand, "" },
            { "waterwalk", SEC_GAMEMASTER, CMD_INGAME, &HandleWaterwalkCommand, "" },
            { "freeze", SEC_GAMEMASTER, CMD_INGAME, &HandleFreezeCommand, "" },
            { "unfreeze", SEC_GAMEMASTER, CMD_INGAME, &HandleUnFreezeCommand, "" },
            { "group", SEC_ADMINISTRATOR, CMD_INGAME, nullptr, "", groupCommandTable },
            { "possess", SEC_ADMINISTRATOR, CMD_INGAME, HandlePossessCommand, "" },
            { "unpossess", SEC_ADMINISTRATOR, CMD_INGAME, HandleUnPossessCommand, "" },
            { "bindsight", SEC_ADMINISTRATOR, CMD_INGAME, HandleBindSightCommand, "" },
            ...
            { "checkpoint", SEC_PLAYER, CMD_INGAME, &HandleCheckPointCommand, "" },
            { "buff", SEC_ADMINISTRATOR, CMD_INGAME, &HandleBuffCommand, "" },
            { "unbuff", SEC_ADMINISTRATOR, CMD_INGAME, &HandleUnbuffCommand, "" },
            ...
            { "bindfollow", SEC_MODERATOR, CMD_INGAME, &HandleBindFollowCommand, "" },
            { "unbindfollow", SEC_MODERATOR, CMD_INGAME, &HandleUnbindFollowCommand, "" },
            { "targetscript", SEC_GAMEMASTER, CMD_INGAME, &HandleTargetScript, "" },
            { "cfbg", SEC_PLAYER, CMD_INGAME, &HandleCfbgCommand, "" },
            { "copy", SEC_ADMINISTRATOR, CMD_INGAME, nullptr, "", copyCommandTable },
            { "flusharenapoints", SEC_ADMINISTRATOR, CMD_CLI, &HandleFlushArenaPointsCommand, "" },
            { "playersinzone", SEC_ADMINISTRATOR, CMD_INGAME, &HandlePlayersInZone, "" },
        };
        return commandTable;
    }
    ...
    static bool HandleSkirmishCommand(ChatHandler* handler, char const* args)
    {
        ...
        if (!*args || !tokens.size())
        {
            handler->SendSysMessage("Usage: .skirmish [arena] [XvX] [Nick1] [Nick2] ... [NickN]");
            handler->SendSysMessage("[arena] can be \"all\" or comma-separated list of possible arenas (NA,BE,RL,DS,RV).");
            handler->SendSysMessage("[XvX] can be 1v1, 2v2, 3v3, 5v5. After [XvX] specify enough nicknames for that mode.");
        ...
        for (Tokenizer::const_iterator itr = arenaTokens.begin(); itr != arenaTokens.end(); ++itr)
        {
            ...
            if (tmpStr == "all")
            {
                ...
                {
                    handler->SendSysMessage("Invalid [arena] specified.");
                    handler->SetSentErrorMessage(true);
                    return false;
                }
        ...
        if (!count)
        {
            handler->SendSysMessage("Invalid bracket. Can be 1v1, 2v2, 3v3, 5v5");
            handler->SetSentErrorMessage(true);
            return false;
        }
        ...
        {
            handler->SendSysMessage("Invalid number of nicknames for this bracket.");
            handler->SetSentErrorMessage(true);
            return false;
        }
        ...
        if (!bgt)
        {
            handler->SendSysMessage("Couldn't create arena map!");
            handler->SetSentErrorMessage(true);
            return false;
        }
        ...
        for (uint8 i = 0; i < cnt; ++i)
        {
            ...
            player->SetBattlegroundId(bg->GetInstanceID(), bgTypeId, queueSlot, true, false, teamId, bg->GetArenaType());
            sBattlegroundMgr->SendToBattleground(player, bg->GetInstanceID(), bgTypeId);
        }

        handler->SendSysMessage("Success! Players are now being teleported to the arena.");
        return true;
    }
    ...
    static bool HandleGPSCommand(ChatHandler* handler, char const* args)
    {
        ...
        if (haveVMap)
        {
            if (map->IsOutdoors(object->GetPhaseMask(), object->GetPositionX(), object->GetPositionY(), object->GetPositionZ()))
    ...
    static bool HandleAppearCommand(ChatHandler* handler, char const* args)
    {
        ...
        if (target)
        {
            ...
            if (map->IsBattlegroundOrArena())
            {
                ...
                _player->SetBattlegroundId(target->GetBattlegroundId(), target->GetBattlegroundTypeId(), PLAYER_MAX_BATTLEGROUND_QUEUES, false, false, TEAM_NEUTRAL, target->GetArenaType());
            }
    ...
    static bool HandleSummonCommand(ChatHandler* handler, char const* args)
    {
        ...
        if (target)
        {
            ...
            if (map->IsBattlegroundOrArena())
            {
                handler->SendSysMessage("Can't summon to a battleground!");
                handler->SetSentErrorMessage(true);
                return false;
            }
            else if (map->IsDungeon())
            {
                ...
                {
                    handler->SendSysMessage("Only GMs can be summoned to an instance!");
                    handler->SetSentErrorMessage(true);
                    return false;
                }
                ...
                if (!handler->GetSession()->GetPlayer()->GetGroup() || !target->GetGroup() || (target->GetGroup()->GetLeaderGUID() != handler->GetSession()->GetPlayer()->GetGUID()) || (handler->GetSession()->GetPlayer()->GetGroup()->GetLeaderGUID() != handler->GetSession()->GetPlayer()->GetGUID()))
    ...
    static bool HandleGroupSummonCommand(ChatHandler* handler, char const* args)
    {
        ...
        if (toInstance && (!handler->GetSession()->GetPlayer()->GetGroup() || (group->GetLeaderGUID() != handler->GetSession()->GetPlayer()->GetGUID()) || (handler->GetSession()->GetPlayer()->GetGroup()->GetLeaderGUID() != handler->GetSession()->GetPlayer()->GetGUID())))
        // the last check is a bit excessive, but let it be, just in case
        {
    ...
    static bool HandleGMUnstuckCommand(ChatHandler* handler, char const* args)
    {
    ...
    static bool HandleAddItemCommand(ChatHandler* handler, char const* args)
    {
        ...
        if (args[0] == '[') // [name] manual form
        {
            ...
            if (itemNameStr && itemNameStr[0])
            {
                ...
                auto stmt = WorldDatabase.GetPreparedStatement(WORLD_SEL_ITEM_TEMPLATE_BY_NAME);
        ...
        if (handler->GetSession()->GetSecurity() < AccountTypes(10))
        {
            handler->SendSysMessage("You may only remove items. Adding items is available for higher GMLevel.");
            return false;
        }
    ...
    static bool HandleSetSkillCommand(ChatHandler* handler, char const* args)
    {
        ...
        int32 level = uint32(std::atol(levelStr));
        ...
        uint16 max = maxPureSkill ? std::atol(maxPureSkill) : targetHasSkill ? target->GetPureMaxSkillValue(skill) : uint16(level);
    ...
    static bool HandlePInfoCommand(ChatHandler* handler, char const* args)
    {
        ...
        uint32 parseGUID = MAKE_NEW_GUID(std::atol((char*)args), 0, HIGHGUID_PLAYER);
        ...
        bool const canSeeRedacted  = handler->GetSession()->GetAccountId() == 1 || handler->GetSession()->GetSecurity() >= 4;
        ...
        {
            isHardcore = gpd->IsHardcore;
            isPathOfWar = gpd->IsPathOfWar;
            if (gpd->guildId)
        ...
        else
        {
            ...
            auto stmt = CharacterDatabase.GetPreparedStatement(CHAR_SEL_CHAR_PINFO);
        ...
        auto stmt = LoginDatabase.GetPreparedStatement(LOGIN_SEL_PINFO);
        ...
        if (result)
        {
            ...
            userName      = handler->GetSession()->GetSecurity() >= AccountTypes(security) ? fields[1].GetString() : "Protected.";
            eMail         = handler->GetSession()->GetSecurity() >= AccountTypes(security) ? fields[2].GetString() : "Protected.";
            lastIp        = handler->GetSession()->GetSecurity() >= AccountTypes(security) ? fields[3].GetString() : "Protected.";
            lastLogin     = fields[4].GetString();
            muteTime      = fields[5].GetUInt64();
            muteReason    = fields[6].GetString();
            muteBy        = fields[7].GetString();
            failedLogins  = fields[8].GetUInt32();
            locked        = fields[9].GetBool();
        ...
        handler->PSendSysMessage(LANG_PINFO_ACCOUNT, (target ? "" : handler->GetTrinityString(LANG_OFFLINE)), nameLink.c_str(), GUID_LOPART(targetGuid), canSeeRedacted ? userName.c_str() : "redacted for privacy", accId, canSeeRedacted ? eMail.c_str() : "redacted for privacy",
            security, canSeeRedacted ? lastIp.c_str() : "redacted for privacy", lastLogin.c_str(), latency, failedLogins, (locked ? "Yes" : "No"), os.c_str());
        ...
        if (!result2)
        {
            PreparedStatement<CharacterDatabaseConnection>* stmtChar = CharacterDatabase.GetPreparedStatement(CHAR_SEL_PINFO_BANS);
            stmtChar->setUInt32(0, GUID_LOPART(targetGuid));
            result2 = CharacterDatabase.Query(stmtChar);
        }
        ...
        if (target)
            handler->SendSysMessage(sCustomMgr->GetDetailedXPRateInfoForPlayer(target).c_str());

        time_t whitemaneSubscriptionExpirationTime = [target, accId]
        {
            if (target)
                return target->GetSession()->GetPremiumService(PremiumServices::WhitemanePlus);

            if (QueryResult const result = LoginDatabase.PQuery("SELECT UnsetDate FROM premium_account WHERE AccountID = '%u' AND `RealmID` = '%u' AND PremiumType = 5 AND UnsetDate > UNIX_TIMESTAMP()", accId, realmID))
            {
                Field const* fields = result->Fetch();
                auto const premiumExpiryTime = static_cast<time_t>(fields[0].GetUInt64());
        ...
        if (whitemaneSubscriptionExpirationTime == static_cast<time_t>(0))
            handler->SendSysMessage("Whitemane+ subscription is not active");
        else
            handler->SendFormattedSysMessage("Whitemane+ subscription is active and expires at {}", TimeToHumanReadable(whitemaneSubscriptionExpirationTime));

        handler->SendFormattedSysMessage("Path of War Player: {}", isPathOfWar ? "Yes." : "No.");
        handler->SendFormattedSysMessage("Hardcore Player: {}", isHardcore ? "Yes." : "No.");
        return true;
    }
    ...
    static bool HandleMuteCommand(ChatHandler* handler, char const* args)
    {
        ...
        if (sCustomMgr->GetBoolConfig(CONFIG_MUTE_HISTORY_ENABLED))
            DBLog::OutMute(accountId, targetName, muteReasonStr, muteBy, notSpeakTime);
    ...
    */
    ...
    static bool SendItemsHelper(ChatHandler* handler, char const* args, bool soulbound)
    {
        ...
        {
            if (Item* item = Item::CreateItem(itr->first, itr->second, handler->GetSession() ? handler->GetSession()->GetPlayer() : nullptr))
            {
                if (soulbound)
                {
    ...
    static bool HandlePetLearnCommand(ChatHandler* handler, char const* args)
    {
        ...
        if (!pet)
        {
            handler->SendSysMessage("You have no pet");
            handler->SetSentErrorMessage(true);
            return false;
        }
    ...
    static bool HandleUnFreezeCommand(ChatHandler* handler, char const* args)
    {
        ...
        else if (targetName)
        {
            ...
            {
                auto stmt = CharacterDatabase.GetPreparedStatement(CHAR_DEL_CHAR_AURA_FROZEN);
    ...
    static bool HandleGroupListCommand(ChatHandler* handler, char const* args)
    {
        ...
        if (groupTarget)
        {
            ...
            for (Group::MemberSlotList::const_iterator itr = members.begin(); itr != members.end(); ++itr)
            {
                ...
                if (groupTarget->IsLeader(slot.guid))
                {
                    if (!flags.empty())
                        flags.append(", ");
                    flags.append("Leader");
                ...
                handler->PSendSysMessage(LANG_GROUP_PLAYER_NAME_GUID, slot.name.c_str(), onlineState, GUID_LOPART(slot.guid), flags.c_str());
            }
        }
        else
    ...
    {
        Player* player         = handler->GetSession()->GetPlayer();
        uint32 unstuckCooldown = player->GetUnstuckCooldown();
        ...
        if (player->IsAlive() && unstuckCooldown > 100)
        {
            handler->PSendSysMessage("Cooldown remaining: %u seconds.", (unstuckCooldown / 1000));
            handler->SetSentErrorMessage(true);
            return false;
        }
        ...
        if (player->IsAlive())
        {
            ...
            if (!hearthStone || player->HasSpellCooldown(8690))
            {
                ...
                player->SetUnstuckCooldown(60000); // 60 seconds
                return true;
            }
    ...
    static bool HandleEventGoCommand(ChatHandler* handler, char const* args)
    {
        ...
        {
            handler->SendSysMessage("You can't do that while event is disabled.");
            handler->SetSentErrorMessage(true);
            return false;
        }
        ...
        if (player->GetMap()->IsBattlegroundOrArena())
        {
            handler->SendSysMessage("You can't do that while character is in battleground or arena.");
            handler->SetSentErrorMessage(true);
            return false;
        }
        ...
        if (player->IsAlive() && player->IsInCombat())
        {
            handler->SendSysMessage("You can't do that while character is in combat.");
            handler->SetSentErrorMessage(true);
            return false;
        }
        ...
        if (player->IsMounted())
        {
            handler->SendSysMessage("You can't do that while character is mounted.");
            handler->SetSentErrorMessage(true);
            return false;
        }
        ...
        if (player && pet)
        {
            handler->SendSysMessage("You can't do that while pet is summoned.");
            handler->SetSentErrorMessage(true);
            return false;
        }
        ...
        switch (atoi(loc))
        {
            ...
            case 2:
                ...
                {
                    handler->SendSysMessage("You don't have required entry ticket to enter this stage.");
                    handler->SetSentErrorMessage(true);
                }
                break;
            case 3:
                ...
                {
                    handler->SendSysMessage("You don't have required token to enter this stage.");
                    handler->SetSentErrorMessage(true);
                }
                break;
            case 4:
            ...
            case 5:
                ...
                break;
            default:
                handler->SendSysMessage("Wrong location. Write number from 1 to 5.");
                handler->SetSentErrorMessage(true);
                break;
        }
    ...
    static bool HandleSthHideCommand(ChatHandler* handler, char const* /*args*/)
    {
        ...
        if (player->hasSthHide())
        {
            ...
            handler->SendSysMessage("Players in Stairways to Heaven zones are now visible.");
        }
        else
        {
            player->SetSthHide(true);
            handler->SendSysMessage("Players in Stairways to Heaven zones are now hidden.");
        }
        return true;
    }
    ...
    static bool HandleCheckPointCommand(ChatHandler* handler, char const* args)
    {
        ...
        {
            handler->SendSysMessage("You don't have any check points.");
            handler->SetSentErrorMessage(true);
            return false;
        }
    ...
    static bool HandleBlockInviteCommand(ChatHandler* handler, char const* /*args*/)
    {
        ...
        if (player->HasBlockChannelInvite())
        {
            ...
            handler->SendSysMessage("You receive channel invites again.");
        }
        else
        {
            player->SetBlockChannelInvite(true);
            handler->SendSysMessage("You no longer receive channel invites.");
        }
        return true;
    }
    ...
    static bool HandlePvPstatsCommand(ChatHandler* handler, char const* /*args*/)
    {
        ...
        {
            auto stmt    = CharacterDatabase.GetPreparedStatement(CHAR_SEL_PVPSTATS_FACTIONS_OVERALL);
            PreparedQueryResult result = CharacterDatabase.Query(stmt);

            if (result)
            {
                Field* fields          = result->Fetch();
                uint32 horde_victories = uint32(fields[1].GetUInt64());

                if (!(result->NextRow()))
                    return false;

                fields                    = result->Fetch();
                uint32 alliance_victories = uint32(fields[1].GetUInt64());
    ...
    static bool HandleInterruptCommand(ChatHandler* handler, char const* args)
    {
        if (!*args)
        {
            handler->SendSysMessage("Available functions:\n1 - Interrupt drink/food\n2 - Interrupt cast \n3 - Dismount");
            handler->SetSentErrorMessage(true);
            return false;
        }
    ...
    static bool HandleBindFollowCommand(ChatHandler* handler, char const* args)
    {
        Player* pUnit = handler->getSelectedPlayer();
        if (!pUnit)
            return false;

        Player* gamemaster = handler->GetSession()->GetPlayer();

        gamemaster->SetFollowTarget(pUnit->GetGUID());
        pUnit->SetGMFollow(gamemaster->GetGUID());
        gamemaster->GetMotionMaster()->MoveFollow(pUnit, 1.0f, M_PI);
        return true;
    }

    static bool HandleUnbindFollowCommand(ChatHandler* handler, char const* args)
    {
        Player* gamemaster = handler->GetSession()->GetPlayer();
        if (gamemaster->GetFollowTarget() == 0)
            return false;

        Player* pTarget = ObjectAccessor::GetPlayer(*gamemaster, gamemaster->GetFollowTarget());
        if (pTarget)
    ...
    static bool HandleTargetScript(ChatHandler* handler, char const* args)
    {
        if (!*args)
            return false;
        ...
        char* scriptName;
        char* playerName;
        handler->extractOptFirstArg((char*)args, &scriptName, &playerName);
        if (!playerName)
            return false;

        Player* target;
        uint64 target_guid;
        if (!handler->extractPlayerTarget(playerName, &target, nullptr, nullptr))
            return false;
        ...
        if (!target->GetSession()->_warden)
            return false;

        target->GetSession()->_warden->LoadAndSendLuaCheck(std::string(scriptName));
        return true;
    }

    static bool HandleCfbgCommand(ChatHandler* handler, char const* args)
    {
        Player* player = handler->GetSession()->GetPlayer();
        if (!player)
            return false;
        ...
        {
            handler->SendSysMessage("Can't be used on battleground");
            handler->SetSentErrorMessage(true);
            return false;
        }
        ...
        {
            handler->SendSysMessage("Can't be used while being in a battleground queue");
            handler->SetSentErrorMessage(true);
            return false;
        }
        ...
        {
            player->SetCrossfactionBgAllowed(false);
            handler->SendSysMessage("Crossfaction Battleground mode is now |cff990000DISABLED|r for your character. You will only fight for your own faction.");
        }
        else
        {
            player->SetCrossfactionBgAllowed(true);
            handler->SendSysMessage("Crossfaction Battleground mode is now |cff009900ENABLED|r for your character. You will now fight either for the Alliance or the Horde.");
        }

        return true;
    }

    static bool HandleCopySpawnIDCommand(ChatHandler* handler, char const* /*args*/)
    {
        uint64 const guid = handler->GetSession()->GetPlayer()->GetTarget();
        if (guid == 0)
        {
            handler->SendSysMessage(LANG_NO_SELECTION);
            handler->SetSentErrorMessage(true);
        ...
        Creature const* target = ObjectAccessor::GetCreature(*handler->GetSession()->GetPlayer(), guid);
        if (!target)
        {
            handler->SendSysMessage(LANG_NO_SELECTION);
            handler->SetSentErrorMessage(true);
        ...
        handler->SendSysMessage(fmt::format("SpawnID: {}", target->GetDBTableGUIDLow()).c_str());
        Trinity::CopyTextToClipboard(std::to_string(target->GetDBTableGUIDLow()));
        return true;
    }

    static bool HandleCopyEntryCommand(ChatHandler* handler, char const* /*args*/)
    {
        uint64 const guid = handler->GetSession()->GetPlayer()->GetTarget();
        if (guid == 0)
        {
        ...
        Unit const* target = ObjectAccessor::GetUnit(*handler->GetSession()->GetPlayer(), guid);
        if (!target)
        {
            handler->SendSysMessage(LANG_NO_SELECTION);
            handler->SetSentErrorMessage(true);
        ...
        handler->SendSysMessage(fmt::format("Entry: {}", target->GetEntry()).c_str());
        Trinity::CopyTextToClipboard(std::to_string(target->GetEntry()));
        return true;
    }

    static bool HandleCopyPositionCommand(ChatHandler* handler, char const* /*args*/)
    {
        uint64 const guid = handler->GetSession()->GetPlayer()->GetTarget();
        if (guid == 0)
        {
        ...
        handler->SendSysMessage(fmt::format("Position: {}", target->GetPosition().ToString()).c_str());
        Trinity::CopyTextToClipboard(target->GetPosition().ToString());
        return true;
    }

    static bool HandleCopyDBPositionCommand(ChatHandler* handler, char const* /*args*/)
    {
        uint64 const guid = handler->GetSession()->GetPlayer()->GetTarget();
        if (guid == 0)
        {
        ...
        std::string const dbPositionData = fmt::format("`position_x`={}, `position_y`={}, `position_z`={}, `orientation`={}", target->GetPositionX(), target->GetPositionY(), target->GetPositionZ(), target->GetOrientation());
        handler->SendSysMessage(dbPositionData.c_str());
        Trinity::CopyTextToClipboard(dbPositionData);
        return true;
    }

    static bool HandleCopyCodePositionCommand(ChatHandler* handler, char const* /*args*/)
    {
        uint64 const guid = handler->GetSession()->GetPlayer()->GetTarget();
        if (guid == 0)
        {
        ...
        std::string const dbPositionData = fmt::format("{}f, {}f, {}f, {}f", target->GetPositionX(), target->GetPositionY(), target->GetPositionZ(), target->GetOrientation());
        handler->SendSysMessage(dbPositionData.c_str());
        Trinity::CopyTextToClipboard(dbPositionData);
        return true;
    }
    ...
    static bool HandlePlayersInZone(ChatHandler* handler, char const* /*args*/)
    {
        ...
        handler->SendFormattedSysMessage("There are currently {} players in zone {}", map->GetPlayerCountInZone(zoneId), zoneId);
        return true;
    }
};
