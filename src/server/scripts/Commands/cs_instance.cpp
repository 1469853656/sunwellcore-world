...
public:
    instance_commandscript()
        : CommandScript("instance_commandscript")
    {
    }
    ...
    std::vector<ChatCommand> GetCommands() const
    {
        ...
        static std::vector<ChatCommand> commandTable = {
            { "instance", SEC_ADMINISTRATOR, CMD_CLI, nullptr, "", instanceCommandTable }
        };
    ...
    static bool HandleInstanceUnbindMeCommand(ChatHandler* handler, char const* args)
    {
        if (!*args)
            return false;
