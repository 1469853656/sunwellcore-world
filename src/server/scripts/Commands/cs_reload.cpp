...
public:
    ...
    std::vector<ChatCommand> GetCommands() const
    {
        static std::vector<ChatCommand> reloadAllCommandTable = {
            { "achievement", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadAllAchievementCommand, "" },
            { "area", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadAllAreaCommand, "" },
            { "gossips", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadAllGossipsCommand, "" },
            { "item", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadAllItemCommand, "" },
            { "locales", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadAllLocalesCommand, "" },
            { "loot", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadAllLootCommand, "" },
            { "npc", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadAllNpcCommand, "" },
            { "quest", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadAllQuestCommand, "" },
            { "scripts", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadAllScriptsCommand, "" },
            { "spell", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadAllSpellCommand, "" },
            { "", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadAllCommand, "" }
        };
        static std::vector<ChatCommand> reloadCommandTable = {
            { "auctions", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadAuctionsCommand, "" },
            { "access_requirement", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadAccessRequirementCommand, "" },
            { "achievement_criteria_data", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadAchievementCriteriaDataCommand, "" },
            { "achievement_reward", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadAchievementRewardCommand, "" },
            { "all", SEC_ADMINISTRATOR, CMD_CLI, nullptr, "", reloadAllCommandTable },
            { "areatrigger_involvedrelation", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadQuestAreaTriggersCommand, "" },
            { "areatrigger_tavern", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadAreaTriggerTavernCommand, "" },
            { "areatrigger_teleport", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadAreaTriggerTeleportCommand, "" },
            { "autobroadcast", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadAutobroadcastCommand, "" },
            { "chat_processor_filters", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadChatProcessorFiltersCommand, "" },
            { "command", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadCommandCommand, "" },
            { "conditions", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadConditions, "" },
            { "config", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadConfigCommand, "" },
            { "creature_text", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadCreatureText, "" },
            { "creature_questender", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadCreatureQuestEnderCommand, "" },
            { "creature_linked_respawn", SEC_GAMEMASTER, CMD_CLI, &HandleReloadLinkedRespawnCommand, "" },
            { "creature_loot_template", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadLootTemplatesCreatureCommand, "" },
            { "creature_onkill_reputation", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadOnKillReputationCommand, "" },
            { "creature_queststarter", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadCreatureQuestStarterCommand, "" },
            { "creature_template", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadCreatureTemplateCommand, "" },
            { "creature_template_outfits", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadCreatureTemplateOutfitsCommand, "" },
            //{ "db_script_string",             SEC_ADMINISTRATOR, CMD_CLI,  &HandleReloadDbScriptStringCommand,            "" },
            { "disables", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadDisablesCommand, "" },
            { "disenchant_loot_template", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadLootTemplatesDisenchantCommand, "" },
            { "event_scripts", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadEventScriptsCommand, "" },
            { "fishing_loot_template", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadLootTemplatesFishingCommand, "" },
            { "game_graveyard_zone", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadGameGraveyardZoneCommand, "" },
            { "game_tele", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadGameTeleCommand, "" },
            { "gameobject_questender", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadGOQuestEnderCommand, "" },
            { "gameobject_loot_template", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadLootTemplatesGameobjectCommand, "" },
            { "gameobject_queststarter", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadGOQuestStarterCommand, "" },
            { "gm_tickets", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadGMTicketsCommand, "" },
            { "gossip_menu", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadGossipMenuCommand, "" },
            { "gossip_menu_option", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadGossipMenuOptionCommand, "" },
            { "item_enchantment_template", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadItemEnchantementsCommand, "" },
            { "item_loot_template", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadLootTemplatesItemCommand, "" },
            { "item_set_names", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadItemSetNamesCommand, "" },
            { "lfg_dungeon_rewards", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadLfgRewardsCommand, "" },
            { "locales_achievement_reward", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadLocalesAchievementRewardCommand, "" },
            { "locales_creature", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadLocalesCreatureCommand, "" },
            { "locales_creature_text", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadLocalesCreatureTextCommand, "" },
            { "locales_gameobject", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadLocalesGameobjectCommand, "" },
            { "locales_gossip_menu_option", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadLocalesGossipMenuOptionCommand, "" },
            { "locales_item", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadLocalesItemCommand, "" },
            { "locales_item_set_name", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadLocalesItemSetNameCommand, "" },
            { "locales_npc_text", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadLocalesNpcTextCommand, "" },
            { "locales_page_text", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadLocalesPageTextCommand, "" },
            { "locales_points_of_interest", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadLocalesPointsOfInterestCommand, "" },
            { "locales_quest", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadLocalesQuestCommand, "" },
            { "mail_level_reward", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadMailLevelRewardCommand, "" },
            { "mail_loot_template", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadLootTemplatesMailCommand, "" },
            { "milling_loot_template", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadLootTemplatesMillingCommand, "" },
            { "npc_spellclick_spells", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadSpellClickSpellsCommand, "" },
            { "npc_trainer", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadNpcTrainerCommand, "" },
            { "npc_vendor", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadNpcVendorCommand, "" },
            { "page_text", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadPageTextsCommand, "" },
            { "pickpocketing_loot_template", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadLootTemplatesPickpocketingCommand, "" },
            { "points_of_interest", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadPointsOfInterestCommand, "" },
            { "prospecting_loot_template", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadLootTemplatesProspectingCommand, "" },
            { "quest_poi", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadQuestPOICommand, "" },
            { "quest_template", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadQuestTemplateCommand, "" },
            { "reference_loot_template", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadLootTemplatesReferenceCommand, "" },
            { "reserved_name", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadReservedNameCommand, "" },
            { "reputation_reward_rate", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadReputationRewardRateCommand, "" },
            { "reputation_spillover_template", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadReputationRewardRateCommand, "" },
            { "skill_discovery_template", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadSkillDiscoveryTemplateCommand, "" },
            { "skill_extra_item_template", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadSkillExtraItemTemplateCommand, "" },
            { "skill_fishing_base_level", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadSkillFishingBaseLevelCommand, "" },
            { "skinning_loot_template", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadLootTemplatesSkinningCommand, "" },
            { "smart_scripts", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadSmartScripts, "" },
            { "spell_required", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadSpellRequiredCommand, "" },
            { "spell_area", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadSpellAreaCommand, "" },
            { "spell_bonus_data", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadSpellBonusesCommand, "" },
            { "spell_group", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadSpellGroupsCommand, "" },
            { "spell_loot_template", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadLootTemplatesSpellCommand, "" },
            { "spell_linked_spell", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadSpellLinkedSpellCommand, "" },
            { "spell_pet_auras", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadSpellPetAurasCommand, "" },
            { "spell_proc_event", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadSpellProcEventCommand, "" },
            { "spell_proc", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadSpellProcsCommand, "" },
            { "spell_scripts", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadSpellScriptsCommand, "" },
            { "spell_target_position", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadSpellTargetPositionCommand, "" },
            { "spell_threats", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadSpellThreatsCommand, "" },
            { "spell_group_stack_rules", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadSpellGroupStackRulesCommand, "" },
            { "trinity_string", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadTrinityStringCommand, "" },
            { "warden_action", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadWardenactionCommand, "" },
            { "waypoint_scripts", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadWpScriptsCommand, "" },
            ...
            { "lottery_rewards", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadLotteryRewardsCommand, "" },
            { "character_screen_script", SEC_ADMINISTRATOR, CMD_CLI, &HandleReloadCharacterScreenCommand, "" }
        };
        static std::vector<ChatCommand> commandTable = {
            { "reload", SEC_ADMINISTRATOR, CMD_CLI, nullptr, "", reloadCommandTable }
        };
        return commandTable;
    }
    ...
    static bool HandleReloadChatProcessorFiltersCommand(ChatHandler* handler, const char* /*args*/)
    {
        sLog->outString("Re-Loading `chat_processor_filters`...");
        GetChatProcessor().LoadChatProcessorFilters();
        handler->SendGlobalGMSysMessage("DB table `chat_processor_filters` reloaded.");
        return true;
    }
    ...
    static bool HandleReloadCreatureTemplateCommand(ChatHandler* handler, const char* args)
    {
        ...
        for (Tokenizer::const_iterator itr = entries.begin(); itr != entries.end(); ++itr)
        {
            ...
            auto stmt = WorldDatabase.GetPreparedStatement(WORLD_SEL_CREATURE_TEMPLATE);
    ...
    static bool HandleReloadLotteryRewardsCommand(ChatHandler* handler, const char* /*args*/)
    {
        sWorldCache.LoadLotteryRewards();
        handler->SendGlobalGMSysMessage("Lottery rewards reloaded");
        return true;
    }

    static bool HandleReloadCharacterScreenCommand(ChatHandler* handler, const char* /*args*/)
    {
        sWorld->LoadCharacterScreenScript();
        handler->SendGlobalGMSysMessage("Character screen script reloaded.");
        return true;
    }
};
