...
public:
    ...
    std::vector<ChatCommand> GetCommands() const
    {
        static std::vector<ChatCommand> wpCommandTable = {
            { "add", SEC_GAMEMASTER, CMD_INGAME, &HandleWpAddCommand, "" },
            { "event", SEC_GAMEMASTER, CMD_INGAME, &HandleWpEventCommand, "" },
            { "load", SEC_GAMEMASTER, CMD_INGAME, &HandleWpLoadCommand, "" },
            { "modify", SEC_GAMEMASTER, CMD_INGAME, &HandleWpModifyCommand, "" },
            { "unload", SEC_GAMEMASTER, CMD_INGAME, &HandleWpUnLoadCommand, "" },
            { "reload", SEC_ADMINISTRATOR, CMD_INGAME, &HandleWpReloadCommand, "" },
            { "show", SEC_GAMEMASTER, CMD_INGAME, &HandleWpShowCommand, "" }
        };
        static std::vector<ChatCommand> commandTable = {
            { "wp", SEC_GAMEMASTER, CMD_INGAME, nullptr, "", wpCommandTable }
        };
        return commandTable;
    }
    /**
    ...
    */
    static bool HandleWpAddCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (!path_number)
        {
            ...
            {
                auto stmt = WorldDatabase.GetPreparedStatement(WORLD_SEL_WAYPOINT_DATA_MAX_ID);
        ...
        auto stmt = WorldDatabase.GetPreparedStatement(WORLD_SEL_WAYPOINT_DATA_MAX_POINT);
    ...
    static bool HandleWpLoadCommand(ChatHandler* handler, const char* args)
    {
        ...
        auto stmt = WorldDatabase.GetPreparedStatement(WORLD_SEL_CREATURE_ADDON_BY_GUID);
    ...
    static bool HandleWpUnLoadCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        if (target->GetCreatureAddon())
        {
            ...
            {
                auto stmt = WorldDatabase.GetPreparedStatement(WORLD_DEL_CREATURE_ADDON);
    ...
    static bool HandleWpEventCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (show == "add")
        {
            ...
            if (id)
            {
                auto stmt = WorldDatabase.GetPreparedStatement(WORLD_SEL_WAYPOINT_SCRIPT_ID_BY_GUID);
                stmt->setUInt32(0, id);
                PreparedQueryResult result = WorldDatabase.Query(stmt);

                if (!result)
                {
                    auto stmt = WorldDatabase.GetPreparedStatement(WORLD_INS_WAYPOINT_SCRIPT);
            ...
            {
                auto stmt = WorldDatabase.GetPreparedStatement(WORLD_SEL_WAYPOINT_SCRIPTS_MAX_ID);
        ...
        if (show == "listid")
        {
            ...
            auto stmt = WorldDatabase.GetPreparedStatement(WORLD_SEL_WAYPOINT_SCRIPT_BY_ID);
            stmt->setUInt32(0, id);
            PreparedQueryResult result = WorldDatabase.Query(stmt);
        ...
        if (show == "del")
        {
            ...
            if (result)
            {
                auto stmt = WorldDatabase.GetPreparedStatement(WORLD_DEL_WAYPOINT_SCRIPT);
        ...
        if (show == "mod")
        {
            ...
            if (arg_str_2 == "setid")
            {
                ...
                auto stmt = WorldDatabase.GetPreparedStatement(WORLD_UPD_WAYPOINT_SCRIPT_ID);
            ...
            else
            {
                ...
                if (arg_str_2 == "posx")
                {
                    auto stmt = WorldDatabase.GetPreparedStatement(WORLD_UPD_WAYPOINT_SCRIPT_X);
                ...
                {
                    auto stmt = WorldDatabase.GetPreparedStatement(WORLD_UPD_WAYPOINT_SCRIPT_Y);
                ...
                {
                    auto stmt = WorldDatabase.GetPreparedStatement(WORLD_UPD_WAYPOINT_SCRIPT_Z);
                ...
                {
                    auto stmt = WorldDatabase.GetPreparedStatement(WORLD_UPD_WAYPOINT_SCRIPT_O);
    ...
    static bool HandleWpModifyCommand(ChatHandler* handler, const char* args)
    {
        ...
        // Check the creature
        auto stmt = WorldDatabase.GetPreparedStatement(WORLD_SEL_WAYPOINT_DATA_BY_WPGUID);
        ...
        if (!result)
        {
            ...
            auto stmt = WorldDatabase.GetPreparedStatement(WORLD_SEL_WAYPOINT_DATA_BY_POS);
        ...
        if (show == "del")
        {
            ...
            auto stmt = WorldDatabase.GetPreparedStatement(WORLD_DEL_WAYPOINT_DATA);
        ...
        if (show == "move")
        {
            ...
            Map* map    = chr->GetMap();
            {
                ...
                auto stmt = WorldDatabase.GetPreparedStatement(WORLD_UPD_WAYPOINT_DATA_POSITION);
    ...
    static bool HandleWpShowCommand(ChatHandler* handler, const char* args)
    {
        ...
        if (show == "info")
        {
            ...
            auto stmt = WorldDatabase.GetPreparedStatement(WORLD_SEL_WAYPOINT_DATA_ALL_BY_WPGUID);
        ...
        if (show == "on")
        {
            auto stmt = WorldDatabase.GetPreparedStatement(WORLD_SEL_WAYPOINT_DATA_POS_BY_ID);
            ...
            do
            {
                ...
                auto stmt = WorldDatabase.GetPreparedStatement(WORLD_UPD_WAYPOINT_DATA_WPGUID);
        ...
        if (show == "first")
        {
            ...
            auto stmt = WorldDatabase.GetPreparedStatement(WORLD_SEL_WAYPOINT_DATA_POS_FIRST_BY_ID);
            stmt->setUInt32(0, pathid);
            PreparedQueryResult result = WorldDatabase.Query(stmt);
        ...
        if (show == "last")
        {
            ...
            auto stmt = WorldDatabase.GetPreparedStatement(WORLD_SEL_WAYPOINT_DATA_POS_LAST_BY_ID);
            stmt->setUInt32(0, pathid);
            PreparedQueryResult result = WorldDatabase.Query(stmt);
        ...
        if (show == "off")
        {
            auto stmt = WorldDatabase.GetPreparedStatement(WORLD_SEL_CREATURE_BY_ID);
            stmt->setUInt32(0, 1);
            PreparedQueryResult result = WorldDatabase.Query(stmt);
