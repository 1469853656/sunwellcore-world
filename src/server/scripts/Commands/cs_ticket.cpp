...
public:
    ticket_commandscript()
        : CommandScript("ticket_commandscript")
    {
    }
    ...
    std::vector<ChatCommand> GetCommands() const
    {
        static std::vector<ChatCommand> ticketResponseCommandTable = {
            { "append", SEC_GAMEMASTER, CMD_CLI, &HandleGMTicketResponseAppendCommand, "" },
            { "appendln", SEC_GAMEMASTER, CMD_CLI, &HandleGMTicketResponseAppendLnCommand, "" }
        };
        static std::vector<ChatCommand> ticketCommandTable = {
            { "assign", SEC_GAMEMASTER, CMD_CLI, &HandleGMTicketAssignToCommand, "" },
            { "close", SEC_GAMEMASTER, CMD_CLI, &HandleGMTicketCloseByIdCommand, "" },
            { "closedlist", SEC_GAMEMASTER, CMD_CLI, &HandleGMTicketListClosedCommand, "" },
            { "comment", SEC_GAMEMASTER, CMD_CLI, &HandleGMTicketCommentCommand, "" },
            { "complete", SEC_GAMEMASTER, CMD_CLI, &HandleGMTicketCompleteCommand, "" },
            { "delete", SEC_ADMINISTRATOR, CMD_CLI, &HandleGMTicketDeleteByIdCommand, "" },
            { "escalate", SEC_GAMEMASTER, CMD_CLI, &HandleGMTicketEscalateCommand, "" },
            { "escalatedlist", SEC_GAMEMASTER, CMD_CLI, &HandleGMTicketListEscalatedCommand, "" },
            { "list", SEC_GAMEMASTER, CMD_CLI, &HandleGMTicketListCommand, "" },
            { "onlinelist", SEC_GAMEMASTER, CMD_CLI, &HandleGMTicketListOnlineCommand, "" },
            { "reset", SEC_ADMINISTRATOR, CMD_CLI, &HandleGMTicketResetCommand, "" },
            { "response", SEC_GAMEMASTER, CMD_CLI, nullptr, "", ticketResponseCommandTable },
            { "togglesystem", SEC_ADMINISTRATOR, CMD_CLI, &HandleToggleGMTicketSystem, "" },
            { "unassign", SEC_GAMEMASTER, CMD_CLI, &HandleGMTicketUnAssignCommand, "" },
            { "viewid", SEC_GAMEMASTER, CMD_CLI, &HandleGMTicketGetByIdCommand, "" },
            { "viewname", SEC_GAMEMASTER, CMD_CLI, &HandleGMTicketGetByNameCommand, "" }
        };
        static std::vector<ChatCommand> commandTable = {
            { "ticket", SEC_GAMEMASTER, CMD_INGAME, nullptr, "", ticketCommandTable }
        };
        return commandTable;
    }
    ...
    static bool HandleGMTicketCommentCommand(ChatHandler* handler, char const* args)
    {
        ...
        auto trans = CharacterDatabaseTransaction(nullptr);
