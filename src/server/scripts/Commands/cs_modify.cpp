...
public:
    ...
    std::vector<ChatCommand> GetCommands() const
    {
        ...
        static std::vector<ChatCommand> modifyCommandTable = {
            ...
            { "speed", SEC_GAMEMASTER, CMD_INGAME, nullptr, "", modifyspeedCommandTable }
        };
        static std::vector<ChatCommand> commandTable = {
            { "morph", SEC_GAMEMASTER, CMD_INGAME, &HandleModifyMorphCommand, "" },
            { "demorph", SEC_GAMEMASTER, CMD_INGAME, &HandleDeMorphCommand, "" },
            { "modify", SEC_GAMEMASTER, CMD_INGAME, nullptr, "", modifyCommandTable }
        };
        return commandTable;
    }
    ...
    static bool HandleModifyMorphCommand(ChatHandler* handler, const char* args)
    {
        ...
        //! volatile, check this before going live
        uint16 display_id = (uint32)atoi((char*)args);
