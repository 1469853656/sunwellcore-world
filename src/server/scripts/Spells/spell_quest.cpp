...
public:
    spell_q11065_wrangle_some_aether_rays()
        : SpellScriptLoader("spell_q11065_wrangle_some_aether_rays")
    {
    }
    ...
    {
        PrepareAuraScript(spell_q11065_wrangle_some_aether_rays_AuraScript) void HandleEffectRemove(AuraEffect const* /*aurEff*/, AuraEffectHandleModes /*mode*/)
        {
            Unit* ar = GetTarget();
            if (ar && ar->ToCreature())
            {
...
{
public:
    spell_aura_wrangling_rope_channel_despawner()
        : SpellScriptLoader("spell_aura_wrangling_rope_channel_despawner")
    {
    }
...
{
public:
    spell_q12014_steady_as_a_rock()
        : SpellScriptLoader("spell_q12014_steady_as_a_rock")
    {
    }
...
{
public:
    spell_q11026_a11051_banish_the_demons()
        : SpellScriptLoader("spell_q11026_a11051_banish_the_demons")
    {
    }
...
public:
    spell_q11322_q11317_the_cleansing()
        : SpellScriptLoader("spell_q11322_q11317_the_cleansing")
    {
    }
...
{
public:
    spell_q10714_on_spirits_wings()
        : SpellScriptLoader("spell_q10714_on_spirits_wings")
    {
    }
...
{
public:
    spell_q10720_the_smallest_creature()
        : SpellScriptLoader("spell_q10720_the_smallest_creature")
    {
    }
...
public:
    spell_q13086_last_line_of_defence()
        : SpellScriptLoader("spell_q13086_last_line_of_defence")
    {
    }
...
{
public:
    spell_q12943_shadow_vault_decree()
        : SpellScriptLoader("spell_q12943_shadow_vault_decree")
    {
    }
...
public:
    spell_q10769_dissension_amongst_the_ranks()
        : SpellScriptLoader("spell_q10769_dissension_amongst_the_ranks")
    {
    }
...
public:
    spell_q11520_discovering_your_roots()
        : SpellScriptLoader("spell_q11520_discovering_your_roots")
    {
    }
...
public:
    spell_quest_dragonmaw_race_generic()
        : SpellScriptLoader("spell_quest_dragonmaw_race_generic")
    {
    }
...
{
public:
    spell_q11670_it_was_the_orcs_honest()
        : SpellScriptLoader("spell_q11670_it_was_the_orcs_honest")
    {
    }
...
{
public:
    spell_quest_test_flight_charging()
        : SpellScriptLoader("spell_quest_test_flight_charging")
    {
    }
...
public:
    spell_q12274_a_fall_from_grace_costume()
        : SpellScriptLoader("spell_q12274_a_fall_from_grace_costume")
    {
    }
...
{
public:
    spell_q13369_fate_up_against_your_will()
        : SpellScriptLoader("spell_q13369_fate_up_against_your_will")
    {
    }
...
public:
    spell_q11198_take_down_tethyr()
        : SpellScriptLoader("spell_q11198_take_down_tethyr")
    {
    }
...
public:
    spell_q11653_youre_not_so_big_now()
        : SpellScriptLoader("spell_q11653_youre_not_so_big_now")
    {
    }
...
public:
    spell_q10985_light_of_the_naaru()
        : SpellScriptLoader("spell_q10985_light_of_the_naaru")
    {
    }
...
public:
    spell_q2203_thaumaturgy_channel()
        : SpellScriptLoader("spell_q2203_thaumaturgy_channel")
    {
    }
    ...
    class spell_q9452_cast_net_SpellScript : public SpellScript
    {
        ...
        void HandleDummy(SpellEffIndex /*effIndex*/)
        {
            ...
            else
            {
                ...
                _z = caster->GetPositionZ();

                if (Creature* Murloc = caster->SummonCreature(CREATURE_ANGRY_MURLOC, _x, _y, _z, 0.0f, TEMPSUMMON_CORPSE_TIMED_DESPAWN, 60000))
...
public:
    spell_q12987_read_pronouncement()
        : SpellScriptLoader("spell_q12987_read_pronouncement")
    {
    }
...
public:
    spell_q12277_wintergarde_mine_explosion()
        : SpellScriptLoader("spell_q12277_wintergarde_mine_explosion")
    {
    }
...
public:
    spell_q12066_bunny_kill_credit()
        : SpellScriptLoader("spell_q12066_bunny_kill_credit")
    {
    }
...
public:
    spell_q12735_song_of_cleansing()
        : SpellScriptLoader("spell_q12735_song_of_cleansing")
    {
    }
...
public:
    spell_q11010_q11102_q11023_aggro_check_aura()
        : SpellScriptLoader("spell_q11010_q11102_q11023_aggro_check_aura")
    {
    }
...
public:
    spell_q11010_q11102_q11023_aggro_check()
        : SpellScriptLoader("spell_q11010_q11102_q11023_aggro_check")
    {
    }
...
public:
    spell_q11010_q11102_q11023_aggro_burst()
        : SpellScriptLoader("spell_q11010_q11102_q11023_aggro_burst")
    {
    }
...
public:
    spell_q11010_q11102_q11023_choose_loc()
        : SpellScriptLoader("spell_q11010_q11102_q11023_choose_loc")
    {
    }
...
public:
    spell_q11010_q11102_q11023_q11008_check_fly_mount()
        : SpellScriptLoader("spell_q11010_q11102_q11023_q11008_check_fly_mount")
    {
    }
...
public:
    spell_q12661_q12669_q12676_q12677_q12713_summon_stefan()
        : SpellScriptLoader("spell_q12661_q12669_q12676_q12677_q12713_summon_stefan")
    {
    }
...
public:
    spell_q12730_quenching_mist()
        : SpellScriptLoader("spell_q12730_quenching_mist")
    {
    }
...
public:
    spell_q13291_q13292_q13239_q13261_frostbrood_skytalon_grab_decoy()
        : SpellScriptLoader("spell_q13291_q13292_q13239_q13261_frostbrood_skytalon_grab_decoy")
    {
    }
...
public:
    spell_q13011_bear_flank_master()
        : SpellScriptLoader("spell_q13011_bear_flank_master")
    {
    }
...
public:
    spell_q12690_burst_at_the_seams()
        : SpellScriptLoader("spell_q12690_burst_at_the_seams")
    {
    }
...
public:
    spell_q12308_escape_from_silverbrook()
        : SpellScriptLoader("spell_q12308_escape_from_silverbrook")
    {
    }
...
public:
    spell_q12308_escape_from_silverbrook_summon_worgen()
        : SpellScriptLoader("spell_q12308_escape_from_silverbrook_summon_worgen")
    {
    }
...
public:
    spell_q12641_death_comes_from_on_high()
        : SpellScriptLoader("spell_q12641_death_comes_from_on_high")
    {
    }
    ...
    class spell_q12641_death_comes_from_on_high_SpellScript : public SpellScript
    {
        ...
        bool Validate(SpellInfo const* /*spellInfo*/) override
        {
            if (!sSpellMgr->GetSpellInfo(SPELL_FORGE_CREDIT) || !sSpellMgr->GetSpellInfo(SPELL_TOWN_HALL_CREDIT) || !sSpellMgr->GetSpellInfo(SPELL_SCARLET_HOLD_CREDIT) || !sSpellMgr->GetSpellInfo(SPELL_CHAPEL_CREDIT))
                return false;
            return true;
        }
...
public:
    spell_q12619_emblazon_runeblade()
        : SpellScriptLoader("spell_q12619_emblazon_runeblade")
    {
    }
...
public:
    spell_q12619_emblazon_runeblade_effect()
        : SpellScriptLoader("spell_q12619_emblazon_runeblade_effect")
    {
    }
...
public:
    spell_q12919_gymers_grab()
        : SpellScriptLoader("spell_q12919_gymers_grab")
    {
    }
...
public:
    spell_q12919_gymers_throw()
        : SpellScriptLoader("spell_q12919_gymers_throw")
    {
    }
...
{
public:
    spell_q9718_crow_transform()
        : SpellScriptLoader("spell_q9718_crow_transform")
    {
    }
    ...
    class spell_q9718_crow_transform_AuraScript : public AuraScript
    {
        ...
        void Register() override
        {
            OnEffectApply += AuraEffectApplyFn(spell_q9718_crow_transform_AuraScript::HandleEffectApply, EFFECT_0, SPELL_AURA_TRANSFORM, AURA_EFFECT_HANDLE_REAL_OR_REAPPLY_MASK);
...
class spell_q11140_salvage_wreckage : public SpellScriptLoader
{
public:
    spell_q11140_salvage_wreckage()
        : SpellScriptLoader("spell_q11140_salvage_wreckage")
    {
    }

    class spell_q11140_salvage_wreckage_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_q11140_salvage_wreckage_SpellScript);
        ...
        SpellCastResult CheckCast()
        {
            GameObject* go = GetCaster()->FindNearestGameObject(GO_BURNING_WRECKAGE, 5.0f);
            if (!go || go->GetRespawnTime())
                return SPELL_FAILED_REQUIRES_SPELL_FOCUS;
        ...
        {
            PreventHitDefaultEffect(effIndex);
            GetHitGObj()->SetRespawnTime(5 * MINUTE);
            GetHitGObj()->Use(GetCaster());
            GetHitGObj()->SetLootState(GO_JUST_DEACTIVATED);
        }
        ...
        void Register() override
        {
            OnCheckCast += SpellCheckCastFn(spell_q11140_salvage_wreckage_SpellScript::CheckCast);
            OnEffectHit += SpellEffectFn(spell_q11140_salvage_wreckage_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
            OnEffectHitTarget += SpellEffectFn(spell_q11140_salvage_wreckage_SpellScript::HandleActiveObject, EFFECT_1, SPELL_EFFECT_ACTIVATE_OBJECT);
        }
    ...
    SpellScript* GetSpellScript() const override
    {
        return new spell_q11140_salvage_wreckage_SpellScript();
    }
};
...
{
public:
    spell_q12279_cast_net()
        : SpellScriptLoader("spell_q12279_cast_net")
    {
    }
...
class spell_q11472_anuniaq_net : public SpellScriptLoader
{
public:
    spell_q11472_anuniaq_net()
        : SpellScriptLoader("spell_q11472_anuniaq_net")
    {
    }

    class spell_q11472_anuniaq_net_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_q11472_anuniaq_net_SpellScript);
        ...
        void Register() override
        {
            OnEffectHitTarget += SpellEffectFn(spell_q11472_anuniaq_net_SpellScript::HandleActiveObject, EFFECT_1, SPELL_EFFECT_ACTIVATE_OBJECT);
        }
    };

    SpellScript* GetSpellScript() const override
    {
        return new spell_q11472_anuniaq_net_SpellScript();
    }
};
...
{
public:
    spell_q13681_throw_stone_chunk()
        : SpellScriptLoader("spell_q13681_throw_stone_chunk")
    {
    }
...
{
public:
    spell_q21884_collect_orange_crystal_liquid()
        : SpellScriptLoader("spell_q21884_collect_orange_crystal_liquid")
    {
    }
