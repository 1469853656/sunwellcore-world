...
{
public:
    spell_sha_totem_of_wrath()
        : SpellScriptLoader("spell_sha_totem_of_wrath")
    {
    }
...
{
public:
    spell_shaman_t8_elemental_4p_bonus()
        : SpellScriptLoader("spell_shaman_t8_elemental_4p_bonus")
    {
    }
...
{
public:
    spell_sha_spirit_walk()
        : SpellScriptLoader("spell_sha_spirit_walk")
    {
    }
...
public:
    spell_sha_t10_restoration_4p_bonus()
        : SpellScriptLoader("spell_sha_t10_restoration_4p_bonus")
    {
    }
...
{
public:
    spell_sha_totemic_mastery()
        : SpellScriptLoader("spell_sha_totemic_mastery")
    {
    }
...
public:
    spell_sha_feral_spirit_scaling()
        : SpellScriptLoader("spell_sha_feral_spirit_scaling")
    {
    }
...
public:
    spell_sha_fire_elemental_scaling()
        : SpellScriptLoader("spell_sha_fire_elemental_scaling")
    {
    }
...
{
public:
    spell_sha_ancestral_awakening_proc()
        : SpellScriptLoader("spell_sha_ancestral_awakening_proc")
    {
    }
...
public:
    spell_sha_bloodlust()
        : SpellScriptLoader("spell_sha_bloodlust")
    {
    }
...
public:
    spell_sha_chain_heal()
        : SpellScriptLoader("spell_sha_chain_heal")
    {
    }
...
public:
    spell_sha_cleansing_totem_pulse()
        : SpellScriptLoader("spell_sha_cleansing_totem_pulse")
    {
    }
...
public:
    spell_sha_earth_shield()
        : SpellScriptLoader("spell_sha_earth_shield")
    {
    }
...
{
public:
    spell_sha_earthen_power()
        : SpellScriptLoader("spell_sha_earthen_power")
    {
    }
...
public:
    spell_sha_flame_shock()
        : SpellScriptLoader("spell_sha_flame_shock")
    {
    }
        ...
        void HandleDummy(SpellEffIndex /*effIndex*/)
        {
            ...
            if (Unit* target = GetHitUnit())
                if (Unit* caster = GetCaster())
                {
                    ...
                    caster->CastCustomSpell(target, SPELL_SHAMAN_TOTEM_HEALING_STREAM_HEAL, &damage, nullptr, nullptr, true, nullptr, nullptr, GetOriginalCaster()->GetGUID());
                }
        }
...
public:
    spell_sha_heroism()
        : SpellScriptLoader("spell_sha_heroism")
    {
    }
...
public:
    spell_sha_item_lightning_shield()
        : SpellScriptLoader("spell_sha_item_lightning_shield")
    {
    }
...
public:
    spell_sha_item_lightning_shield_trigger()
        : SpellScriptLoader("spell_sha_item_lightning_shield_trigger")
    {
    }
...
public:
    spell_sha_item_mana_surge()
        : SpellScriptLoader("spell_sha_item_mana_surge")
    {
    }
...
public:
    spell_sha_item_t10_elemental_2p_bonus()
        : SpellScriptLoader("spell_sha_item_t10_elemental_2p_bonus")
    {
    }
...
public:
    spell_sha_mana_spring_totem()
        : SpellScriptLoader("spell_sha_mana_spring_totem")
    {
    }
...
public:
    spell_sha_mana_tide_totem()
        : SpellScriptLoader("spell_sha_mana_tide_totem")
    {
    }
...
{
public:
    spell_sha_sentry_totem()
        : SpellScriptLoader("spell_sha_sentry_totem")
    {
    }
...
public:
    spell_sha_thunderstorm()
        : SpellScriptLoader("spell_sha_thunderstorm")
    {
    }
...
{
public:
    spell_sha_earthliving_weapon()
        : SpellScriptLoader("spell_sha_earthliving_weapon")
    {
    }
