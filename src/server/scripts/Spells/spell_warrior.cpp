...
{
public:
    spell_warr_mocking_blow()
        : SpellScriptLoader("spell_warr_mocking_blow")
    {
    }
...
public:
    spell_warr_intervene()
        : SpellScriptLoader("spell_warr_intervene")
    {
    }
...
public:
    spell_warr_improved_spell_reflection_trigger()
        : SpellScriptLoader("spell_warr_improved_spell_reflection_trigger")
    {
    }
...
{
public:
    spell_warr_charge_stun()
        : SpellScriptLoader("spell_warr_charge_stun")
    {
    }
...
public:
    spell_warr_slam()
        : SpellScriptLoader("spell_warr_slam")
    {
    }
...
public:
    spell_warr_damage_shield()
        : SpellScriptLoader("spell_warr_damage_shield")
    {
    }
...
public:
    spell_warr_execute()
        : SpellScriptLoader("spell_warr_execute")
    {
    }
...
public:
    spell_warr_concussion_blow()
        : SpellScriptLoader("spell_warr_concussion_blow")
    {
    }
...
public:
    spell_warr_bloodthirst()
        : SpellScriptLoader("spell_warr_bloodthirst")
    {
    }
...
public:
    spell_warr_bloodthirst_heal()
        : SpellScriptLoader("spell_warr_bloodthirst_heal")
    {
    }
...
public:
    spell_warr_overpower()
        : SpellScriptLoader("spell_warr_overpower")
    {
    }
...
public:
    spell_warr_intimidating_shout()
        : SpellScriptLoader("spell_warr_intimidating_shout")
    {
    }
...
public:
    spell_warr_rend()
        : SpellScriptLoader("spell_warr_rend")
    {
    }
...
public:
    spell_warr_shattering_throw()
        : SpellScriptLoader("spell_warr_shattering_throw")
    {
    }
    ...
    class spell_warr_shattering_throw_SpellScript : public SpellScript
    {
        ...
        void HandleScript(SpellEffIndex effIndex)
        {
            ...
            GetCaster()->ResetAttackTimers(true);
...
public:
    spell_warr_vigilance()
        : SpellScriptLoader("spell_warr_vigilance")
    {
    }
    ...
    class spell_warr_vigilance_AuraScript : public AuraScript
    {
        ...
        {
            Unit* target = GetTarget();
            if (target->HasAura(SPELL_GEN_DAMAGE_REDUCTION_AURA) && !(target->HasAura(SPELL_PALADIN_BLESSING_OF_SANCTUARY) || target->HasAura(SPELL_PALADIN_GREATER_BLESSING_OF_SANCTUARY) || target->HasAura(SPELL_PRIEST_RENEWED_HOPE)))
            {
...
public:
    spell_warr_vigilance_trigger()
        : SpellScriptLoader("spell_warr_vigilance_trigger")
    {
    }
...
public:
    spell_warr_glyph_of_sunder_armor()
        : SpellScriptLoader("spell_warr_glyph_of_sunder_armor")
    {
    }
...
public:
    spell_warr_retaliation()
        : SpellScriptLoader("spell_warr_retaliation")
    {
    }
...
class spell_warr_sword_specialization : public AuraScript
{
    PrepareAuraScript(spell_warr_sword_specialization);

    bool CheckProc(ProcEventInfo& eventInfo)
    {
        if (eventInfo.GetDamageInfo() && eventInfo.GetDamageInfo()->GetVictim())
            GetAura()->ExtraAttackTargetGUID = eventInfo.GetDamageInfo()->GetVictim()->GetGUID();
    ...
    void Register() override
    {
        DoCheckProc += AuraCheckProcFn(spell_warr_sword_specialization::CheckProc);
    }
};
...
class spell_warr_heroic_throw : public SpellScript
{
    ...
    void Register() override
    {
        OnEffectHitTarget += SpellEffectFn(spell_warr_heroic_throw::HandleScript, EFFECT_0, SPELL_EFFECT_SCHOOL_DAMAGE);
    }
};
...
void AddSC_warrior_spell_scripts()
{
    ...
    RegisterAuraScript(spell_warr_sword_specialization);
    RegisterAuraScript(spell_warr_taste_for_blood);
