...
{
public:
    spell_gen_model_visible()
        : SpellScriptLoader("spell_gen_model_visible")
    {
    }
...
{
public:
    spell_the_flag_of_ownership()
        : SpellScriptLoader("spell_the_flag_of_ownership")
    {
    }
...
{
public:
    spell_gen_have_item_auras()
        : SpellScriptLoader("spell_gen_have_item_auras")
    {
    }
...
{
public:
    spell_gen_mine_sweeper()
        : SpellScriptLoader("spell_gen_mine_sweeper")
    {
    }
...
{
public:
    spell_gen_reduced_above_60()
        : SpellScriptLoader("spell_gen_reduced_above_60")
    {
    }
...
{
public:
    spell_gen_relocaste_dest(const char* name, float x, float y, float z, float o)
    ...
    public:
        spell_gen_relocaste_dest_SpellScript(float x, float y, float z, float o)
            : _x(x)
            , _y(y)
            , _z(z)
            , _o(o)
...
public:
    spell_gen_allow_proc_from_spells_with_cost()
        : SpellScriptLoader("spell_gen_allow_proc_from_spells_with_cost")
    {
    }
...
public:
    spell_gen_bg_preparation()
        : SpellScriptLoader("spell_gen_bg_preparation")
    {
    }
...
{
public:
    spell_gen_disabled_above_level(char const* name, uint8 level)
        : SpellScriptLoader(name)
        , _level(level)
    {
    }
    ...
    class spell_gen_disabled_above_level_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_gen_disabled_above_level_SpellScript)
            ...
            public : spell_gen_disabled_above_level_SpellScript(uint8 level)
            : SpellScript()
            , _level(level)
        {
        }
...
public:
    spell_pet_hit_expertise_scalling()
        : SpellScriptLoader("spell_pet_hit_expertise_scalling")
    {
    }
    ...
    class spell_pet_hit_expertise_scalling_AuraScript : public AuraScript
    {
        ...
        void CalculateHitAmount(AuraEffect const* aurEff, int32& amount, bool& /*canBeRecalculated*/)
        {
            if (Player* modOwner = GetUnitOwner()->GetSpellModOwner())
            {
                ...
                else if (GetUnitOwner()->GetEntry() == NPC_FERAL_SPIRIT || GetUnitOwner()->GetEntry() == NPC_FIRE_ELEMENTAL)
...
public:
    spell_gen_grow_flower_patch()
        : SpellScriptLoader("spell_gen_grow_flower_patch")
    {
    }
...
{
public:
    spell_gen_rallying_cry_of_the_dragonslayer()
        : SpellScriptLoader("spell_gen_rallying_cry_of_the_dragonslayer")
    {
    }
...
{
public:
    spell_gen_adals_song_of_battle()
        : SpellScriptLoader("spell_gen_adals_song_of_battle")
    {
    }
...
public:
    spell_gen_disabled_above_63()
        : SpellScriptLoader("spell_gen_disabled_above_63")
    {
    }
...
{
public:
    spell_gen_black_magic_enchant()
        : SpellScriptLoader("spell_gen_black_magic_enchant")
    {
    }
...
public:
    spell_gen_area_aura_select_players()
        : SpellScriptLoader("spell_gen_area_aura_select_players")
    {
    }
...
{
public:
    spell_gen_select_target_count(const char* name, Targets effTarget, uint8 count)
        : SpellScriptLoader(name)
        , _effTarget(effTarget)
        , _count(count)
    {
    }
    ...
    public:
        spell_gen_select_target_count_SpellScript(Targets effTarget, uint8 count)
            : _effTarget(effTarget)
            , _count(count)
        {
        }
...
public:
    spell_gen_use_spell_base_level_check()
        : SpellScriptLoader("spell_gen_use_spell_base_level_check")
    {
    }
...
{
public:
    spell_gen_proc_from_direct_damage()
        : SpellScriptLoader("spell_gen_proc_from_direct_damage")
    {
    }
...
public:
    spell_gen_no_offhand_proc()
        : SpellScriptLoader("spell_gen_no_offhand_proc")
    {
    }
    ...
    class spell_gen_no_offhand_proc_AuraScript : public AuraScript
    {
        ...
        bool CheckProc(ProcEventInfo& eventInfo)
        {
            if (Player const* player = eventInfo.GetActor()->ToPlayer())
                return player->GetWeaponForAttack(BASE_ATTACK, true) && !(eventInfo.GetTypeMask() & PROC_FLAG_DONE_OFFHAND_ATTACK);
...
{
public:
    spell_gen_proc_once_per_cast()
        : SpellScriptLoader("spell_gen_proc_once_per_cast")
    {
    }
...
public:
    spell_gen_proc_on_self()
        : SpellScriptLoader("spell_gen_proc_on_self")
    {
    }
...
public:
    spell_gen_proc_not_self()
        : SpellScriptLoader("spell_gen_proc_not_self")
    {
    }
...
public:
    spell_gen_baby_murloc_passive()
        : SpellScriptLoader("spell_gen_baby_murloc_passive")
    {
    }
...
{
public:
    spell_gen_baby_murloc()
        : SpellScriptLoader("spell_gen_baby_murloc")
    {
    }
...
public:
    spell_gen_fixate()
        : SpellScriptLoader("spell_gen_fixate")
    {
    }
...
public:
    spell_gen_proc_above_75()
        : SpellScriptLoader("spell_gen_proc_above_75")
    {
    }
...
{
public:
    spell_gen_periodic_knock_away()
        : SpellScriptLoader("spell_gen_periodic_knock_away")
    {
    }
...
{
public:
    spell_gen_knock_away()
        : SpellScriptLoader("spell_gen_knock_away")
    {
    }
...
{
public:
    spell_gen_mod_radius_by_caster_scale()
        : SpellScriptLoader("spell_gen_mod_radius_by_caster_scale")
    {
    }
...
{
public:
    spell_gen_proc_reduced_above_60()
        : SpellScriptLoader("spell_gen_proc_reduced_above_60")
    {
    }
...
{
public:
    spell_gen_visual_dummy_stun()
        : SpellScriptLoader("spell_gen_visual_dummy_stun")
    {
    }
...
{
public:
    spell_gen_random_target32()
        : SpellScriptLoader("spell_gen_random_target32")
    {
    }
...
public:
    spell_gen_hate_to_zero()
        : SpellScriptLoader("spell_gen_hate_to_zero")
    {
    }
...
{
public:
    spell_gen_focused_bursts()
        : SpellScriptLoader("spell_gen_focused_bursts")
    {
    }
...
{
public:
    spell_gen_flurry_of_claws()
        : SpellScriptLoader("spell_gen_flurry_of_claws")
    {
    }
...
public:
    spell_gen_throw_back()
        : SpellScriptLoader("spell_gen_throw_back")
    {
    }
...
public:
    spell_gen_adaptive_warding()
        : SpellScriptLoader("spell_gen_adaptive_warding")
    {
    }
    ...
    class spell_gen_adaptive_warding_AuraScript : public AuraScript
    {
        ...
        {
            if (!sSpellMgr->GetSpellInfo(SPELL_GEN_ADAPTIVE_WARDING_FIRE) || !sSpellMgr->GetSpellInfo(SPELL_GEN_ADAPTIVE_WARDING_NATURE) || !sSpellMgr->GetSpellInfo(SPELL_GEN_ADAPTIVE_WARDING_FROST) || !sSpellMgr->GetSpellInfo(SPELL_GEN_ADAPTIVE_WARDING_SHADOW) || !sSpellMgr->GetSpellInfo(SPELL_GEN_ADAPTIVE_WARDING_ARCANE))
                return false;
            return true;
        }
...
public:
    spell_gen_av_drekthar_presence()
        : SpellScriptLoader("spell_gen_av_drekthar_presence")
    {
    }
...
public:
    spell_gen_cannibalize()
        : SpellScriptLoader("spell_gen_cannibalize")
    {
    }
...
public:
    spell_gen_create_lance()
        : SpellScriptLoader("spell_gen_create_lance")
    {
    }
...
public:
    spell_gen_netherbloom()
        : SpellScriptLoader("spell_gen_netherbloom")
    {
    }
...
public:
    spell_gen_nightmare_vine()
        : SpellScriptLoader("spell_gen_nightmare_vine")
    {
    }
...
public:
    ...
    class spell_gen_obsidian_armor_AuraScript : public AuraScript
    {
        ...
        bool Validate(SpellInfo const* /*spellInfo*/) override
        {
            if (!sSpellMgr->GetSpellInfo(SPELL_GEN_OBSIDIAN_ARMOR_HOLY) || !sSpellMgr->GetSpellInfo(SPELL_GEN_OBSIDIAN_ARMOR_FIRE) || !sSpellMgr->GetSpellInfo(SPELL_GEN_OBSIDIAN_ARMOR_NATURE) || !sSpellMgr->GetSpellInfo(SPELL_GEN_OBSIDIAN_ARMOR_FROST) || !sSpellMgr->GetSpellInfo(SPELL_GEN_OBSIDIAN_ARMOR_SHADOW) || !sSpellMgr->GetSpellInfo(SPELL_GEN_OBSIDIAN_ARMOR_ARCANE))
                return false;
            return true;
        }
...
{
public:
    spell_gen_elune_candle()
        : SpellScriptLoader("spell_gen_elune_candle")
    {
    }
    ...
    class spell_gen_elune_candle_SpellScript : public SpellScript
    {
        ...
        bool Validate(SpellInfo const* /*spellInfo*/) override
        {
            if (!sSpellMgr->GetSpellInfo(SPELL_ELUNE_CANDLE_OMEN_HEAD) || !sSpellMgr->GetSpellInfo(SPELL_ELUNE_CANDLE_OMEN_CHEST) || !sSpellMgr->GetSpellInfo(SPELL_ELUNE_CANDLE_OMEN_HAND_R) || !sSpellMgr->GetSpellInfo(SPELL_ELUNE_CANDLE_OMEN_HAND_L) || !sSpellMgr->GetSpellInfo(SPELL_ELUNE_CANDLE_NORMAL))
                return false;
            return true;
        }
...
public:
    spell_gen_clone()
        : SpellScriptLoader("spell_gen_clone")
    {
    }
...
{
public:
    spell_gen_clone_weapon()
        : SpellScriptLoader("spell_gen_clone_weapon")
    {
    }
...
public:
    spell_gen_clone_weapon_aura()
        : SpellScriptLoader("spell_gen_clone_weapon_aura")
    {
    }
...
{
public:
    spell_gen_seaforium_blast()
        : SpellScriptLoader("spell_gen_seaforium_blast")
    {
    }
...
public:
    spell_gen_turkey_marker()
        : SpellScriptLoader("spell_gen_turkey_marker")
    {
    }
...
public:
    spell_gen_magic_rooster()
        : SpellScriptLoader("spell_gen_magic_rooster")
    {
    }
...
public:
    spell_gen_allow_cast_from_item_only()
        : SpellScriptLoader("spell_gen_allow_cast_from_item_only")
    {
    }
...
public:
    spell_gen_vehicle_scaling()
        : SpellScriptLoader("spell_gen_vehicle_scaling")
    {
    }
...
public:
    spell_gen_oracle_wolvar_reputation()
        : SpellScriptLoader("spell_gen_oracle_wolvar_reputation")
    {
    }
...
public:
    spell_gen_damage_reduction_aura()
        : SpellScriptLoader("spell_gen_damage_reduction_aura")
    {
    }
    ...
    class spell_gen_damage_reduction_AuraScript : public AuraScript
    {
        ...
        {
            Unit* target = GetTarget();
            if (target->HasAura(SPELL_DAMAGE_REDUCTION_AURA) && !(target->HasAura(SPELL_BLESSING_OF_SANCTUARY) || target->HasAura(SPELL_GREATER_BLESSING_OF_SANCTUARY) || target->HasAura(SPELL_RENEWED_HOPE) || target->HasAura(SPELL_VIGILANCE)))
            {
...
public:
    spell_gen_dummy_trigger()
        : SpellScriptLoader("spell_gen_dummy_trigger")
    {
    }
...
public:
    spell_gen_spirit_healer_res()
        : SpellScriptLoader("spell_gen_spirit_healer_res")
    {
    }
...
public:
    spell_gen_gadgetzan_transporter_backfire()
        : SpellScriptLoader("spell_gen_gadgetzan_transporter_backfire")
    {
    }
...
public:
    spell_gen_gnomish_transporter()
        : SpellScriptLoader("spell_gen_gnomish_transporter")
    {
    }
...
public:
    spell_gen_mounted_charge()
        : SpellScriptLoader("spell_gen_mounted_charge")
    {
    }
...
public:
    spell_gen_defend()
        : SpellScriptLoader("spell_gen_defend")
    {
    }
...
public:
    spell_gen_throw_shield()
        : SpellScriptLoader("spell_gen_throw_shield")
    {
    }
...
public:
    spell_gen_tournament_duel()
        : SpellScriptLoader("spell_gen_tournament_duel")
    {
    }
    ...
    class spell_gen_tournament_duel_SpellScript : public SpellScript
    {
        ...
        bool Validate(SpellInfo const* /*spellInfo*/) override
        {
            if (!sSpellMgr->GetSpellInfo(SPELL_ON_TOURNAMENT_MOUNT) || !sSpellMgr->GetSpellInfo(SPELL_MOUNTED_DUEL))
                return false;
            return true;
        }
...
public:
    spell_gen_summon_tournament_mount()
        : SpellScriptLoader("spell_gen_summon_tournament_mount")
    {
    }
...
public:
    spell_gen_on_tournament_mount()
        : SpellScriptLoader("spell_gen_on_tournament_mount")
    {
    }
...
public:
    spell_gen_tournament_pennant()
        : SpellScriptLoader("spell_gen_tournament_pennant")
    {
    }
...
public:
    spell_gen_ds_flush_knockback()
        : SpellScriptLoader("spell_gen_ds_flush_knockback")
    {
    }
...
public:
    ...
    class spell_gen_count_pct_from_max_hp_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_gen_count_pct_from_max_hp_SpellScript)
            ...
            public : spell_gen_count_pct_from_max_hp_SpellScript(int32 damagePct)
            : SpellScript()
            , _damagePct(damagePct)
        {
        }
...
{
public:
    spell_gen_despawn_self()
        : SpellScriptLoader("spell_gen_despawn_self")
    {
    }
...
public:
    spell_gen_bandage()
        : SpellScriptLoader("spell_gen_bandage")
    {
    }
...
{
public:
    spell_gen_mount(const char* name, uint32 mount0 = 0, uint32 mount60 = 0, uint32 mount100 = 0, uint32 mount150 = 0, uint32 mount280 = 0, uint32 mount310 = 0)
        : SpellScriptLoader(name)
        , _mount0(mount0)
        , _mount60(mount60)
        , _mount100(mount100)
    ...
    public:
        spell_gen_mount_SpellScript(uint32 mount0, uint32 mount60, uint32 mount100, uint32 mount150, uint32 mount280, uint32 mount310)
            : SpellScript()
            , _mount0(mount0)
            , _mount60(mount60)
            , _mount100(mount100)
...
public:
    spell_gen_upper_deck_create_foam_sword()
        : SpellScriptLoader("spell_gen_upper_deck_create_foam_sword")
    {
    }
...
public:
    spell_gen_bonked()
        : SpellScriptLoader("spell_gen_bonked")
    {
    }
...
public:
    spell_gen_gift_of_naaru()
        : SpellScriptLoader("spell_gen_gift_of_naaru")
    {
    }
...
public:
    spell_gen_replenishment()
        : SpellScriptLoader("spell_gen_replenishment")
    {
    }
...
public:
    spell_gen_spectator_cheer_trigger()
        : SpellScriptLoader("spell_gen_spectator_cheer_trigger")
    {
    }
...
public:
    spell_gen_vendor_bark_trigger()
        : SpellScriptLoader("spell_gen_vendor_bark_trigger")
    {
    }
...
public:
    spell_gen_whisper_gulch_yogg_saron_whisper()
        : SpellScriptLoader("spell_gen_whisper_gulch_yogg_saron_whisper")
    {
    }
...
public:
    spell_gen_eject_all_passengers()
        : SpellScriptLoader("spell_gen_eject_all_passengers")
    {
    }
...
public:
    spell_gen_eject_passenger()
        : SpellScriptLoader("spell_gen_eject_passenger")
    {
    }
...
class spell_sleep_magic_dust : public SpellScriptLoader
{
public:
    spell_sleep_magic_dust()
        : SpellScriptLoader("spell_sleep_magic_dust")
    {
    }

    class spell_sleep_magic_dust_AuraScript : public AuraScript
    {
        PrepareAuraScript(spell_sleep_magic_dust_AuraScript);
        ...
        void Register() override
        {
            OnEffectApply += AuraEffectApplyFn(spell_sleep_magic_dust_AuraScript::HandleEffectApply, EFFECT_0, SPELL_AURA_MOD_STUN, AURA_EFFECT_HANDLE_REAL);
            OnEffectRemove += AuraEffectRemoveFn(spell_sleep_magic_dust_AuraScript::HandleEffectRemove, EFFECT_0, SPELL_AURA_MOD_STUN, AURA_EFFECT_HANDLE_REAL);
        }
    };

    AuraScript* GetAuraScript() const override
    {
        return new spell_sleep_magic_dust_AuraScript();
    }
};

class spell_gen_cleansing_vial : public SpellScriptLoader
{
public:
    spell_gen_cleansing_vial()
        : SpellScriptLoader("spell_gen_cleansing_vial")
    {
    }

    class spell_gen_cleansing_vial_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_gen_cleansing_vial_SpellScript);
        ...
        void HandleSendEvent(SpellEffIndex effIndex)
        {
            if (Unit* caster = GetCaster())
            {
                ...
                if (Creature* Agonis = caster->SummonCreature(17000, x, y, z, o, TEMPSUMMON_CORPSE_DESPAWN))
                {
                    Agonis->SetFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_NOT_SELECTABLE);
                    Agonis->CastSpell(Agonis, 24240, false);
                }
            }
        }
        ...
        void Register() override
        {
            OnEffectLaunch += SpellEffectFn(spell_gen_cleansing_vial_SpellScript::HandleSendEvent, EFFECT_0, SPELL_EFFECT_SEND_EVENT);
        }
    };

    SpellScript* GetSpellScript() const override
    {
        return new spell_gen_cleansing_vial_SpellScript();
    }
};
...
{
public:
    spell_opening_battleground_nodes()
        : SpellScriptLoader("spell_opening_battleground_nodes")
    {
    }
...
{
public:
    spell_undigestible_immune()
        : SpellScriptLoader("spell_undigestible_immune")
    {
    }
...
// 51673 - Rocket Blast
class spell_sota_rocket_blast : public SpellScript
{
    PrepareSpellScript(spell_sota_rocket_blast);

    void HandleDamageCalc(SpellEffIndex /*effIndex*/)
    {
        uint32 newDamage = GetHitDamage();
        if (Unit* target = GetHitUnit())
        {
            newDamage                = std::min(target->IsVehicle() ? 6000U : 4000U, newDamage);
            WorldLocation const* loc = GetExplTargetDest();
            float diff               = std::min(8.0f, target->GetDistance(*loc));
            if (diff > 3.0f)
                newDamage = newDamage * (3 / diff);
        }
    ...
    void Register() override
    {
        OnEffectHitTarget += SpellEffectFn(spell_sota_rocket_blast::HandleDamageCalc, EFFECT_0, SPELL_EFFECT_SCHOOL_DAMAGE);
    }
};

// 48776 - Mount Speed
class spell_riding_crop : public AuraScript
{
    PrepareAuraScript(spell_riding_crop);

    void CalculateAmount(AuraEffect const* /*aurEff*/, int32& amount, bool& canBeRecalculated)
    {
        canBeRecalculated = false;
        if (Unit* caster = GetCaster())
            if (caster->getLevel() > 70)
                amount = 0;
    }

    void Register() override
    {
        DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_riding_crop::CalculateAmount, EFFECT_0, SPELL_AURA_MOD_MOUNTED_SPEED_ALWAYS);
        DoEffectCalcAmount += AuraEffectCalcAmountFn(spell_riding_crop::CalculateAmount, EFFECT_1, SPELL_AURA_MOD_MOUNTED_FLIGHT_SPEED_ALWAYS);
    }
};

class spell_gen_player_flurry : public AuraScript
{
    PrepareAuraScript(spell_gen_player_flurry);

    void OnProc(AuraEffect const* aurEff, ProcEventInfo& /*eventInfo*/)
    {
        PreventDefaultAction();
        // Delay trigger to apply all charges correctly
        if (Unit* caster = GetCaster())
        {
            caster->m_Events.AddEventAsync([caster, spellID = aurEff->GetSpellInfo()->Effects[aurEff->GetEffIndex()].TriggerSpell, aurEffID = aurEff->GetId(), aurEffIndex = aurEff->GetEffIndex(), casterGUID = aurEff->GetCasterGUID()] 
            {
                AuraEffect const* triggeredByAura = caster->GetAuraEffect(aurEffID, aurEffIndex, casterGUID);
                if (!triggeredByAura)
                    return;

                caster->CastSpell(caster, spellID, TRIGGERED_FULL_MASK, nullptr, triggeredByAura);
            });
        }
    }
    ...
    void Register() override
    {
        OnEffectProc += AuraEffectProcFn(spell_gen_player_flurry::OnProc, EFFECT_0, SPELL_AURA_PROC_TRIGGER_SPELL);
    }
};

class spell_gen_player_flurry_effect : public AuraScript
{
    PrepareAuraScript(spell_gen_player_flurry_effect)

    bool CheckProc(ProcEventInfo& /*procInfo*/)
    {
        return _lastProcMSTime + _procCooldownMS < getMSTime();
    }

    void OnProc(AuraEffect const* /*aurEff*/, ProcEventInfo& /*eventInfo*/)
    {
        _lastProcMSTime = getMSTime();
    }

    uint32 _lastProcMSTime = 0;
    uint32 const _procCooldownMS = 500;

    void Register() override
    {
        DoCheckProc += AuraCheckProcFn(spell_gen_player_flurry_effect::CheckProc);
        OnEffectProc += AuraEffectProcFn(spell_gen_player_flurry_effect::OnProc, EFFECT_0, SPELL_AURA_MOD_MELEE_HASTE);
    }
};

// 57339 - Tank Class Passive Threat
class spell_tank_class_passive_threat : public AuraScript
{
    PrepareAuraScript(spell_tank_class_passive_threat);
    ...
    void AfterApply(AuraEffect const* /*aurEff*/, AuraEffectHandleModes /*mode*/)
    {
        ...
        ShapeshiftForm const form = GetTarget()->GetShapeshiftForm();
    ...
    void Register() override
    {
        AfterEffectApply += AuraEffectApplyFn(spell_tank_class_passive_threat::AfterApply, EFFECT_0, SPELL_AURA_MOD_THREAT, AURA_EFFECT_HANDLE_REAL_OR_REAPPLY_MASK);
    }
};
...
void AddSC_generic_spell_scripts()
{
    ...
    new spell_gen_mount("spell_big_blizzard_bear", 0, SPELL_BIG_BLIZZARD_BEAR_60, SPELL_BIG_BLIZZARD_BEAR_100, SPELL_BIG_BLIZZARD_BEAR_100, SPELL_BIG_BLIZZARD_BEAR_100);
    ...
    RegisterSpellScript(spell_sota_rocket_blast);
    RegisterAuraScript(spell_riding_crop);
    RegisterAuraScript(spell_gen_player_flurry);
    RegisterAuraScript(spell_gen_player_flurry_effect);
    RegisterAuraScript(spell_tank_class_passive_threat);
