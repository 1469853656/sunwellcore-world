...
{
public:
    spell_item_massive_seaforium_charge()
        : SpellScriptLoader("spell_item_massive_seaforium_charge")
    {
    }
...
{
public:
    spell_item_titanium_seal_of_dalaran()
        : SpellScriptLoader("spell_item_titanium_seal_of_dalaran")
    {
    }
...
public:
    spell_item_runescroll_of_fortitude()
        : SpellScriptLoader("spell_item_runescroll_of_fortitude")
    {
    }
...
{
public:
    spell_item_branns_communicator()
        : SpellScriptLoader("spell_item_branns_communicator")
    {
    }
...
public:
    spell_item_goblin_gumbo_kettle()
        : SpellScriptLoader("spell_item_goblin_gumbo_kettle")
    {
    }
...
{
public:
    spell_item_mithril_spurs()
        : SpellScriptLoader("spell_item_mithril_spurs")
    {
    }
...
public:
    spell_item_magic_dust()
        : SpellScriptLoader("spell_item_magic_dust")
    {
    }
...
{
public:
    spell_item_toy_train_set()
        : SpellScriptLoader("spell_item_toy_train_set")
    {
    }
...
{
public:
    spell_item_rocket_chicken()
        : SpellScriptLoader("spell_item_rocket_chicken")
    {
    }
...
public:
    spell_item_lil_phylactery()
        : SpellScriptLoader("spell_item_lil_phylactery")
    {
    }
...
{
public:
    spell_item_shifting_naaru_silver()
        : SpellScriptLoader("spell_item_shifting_naaru_silver")
    {
    }
...
public:
    spell_item_toxic_wasteling()
        : SpellScriptLoader("spell_item_toxic_wasteling")
    {
    }
...
public:
    spell_item_lil_xt()
        : SpellScriptLoader("spell_item_lil_xt")
    {
    }
    ...
    class spell_item_lil_xt_SpellScript : public SpellScript
    {
        ...
        void HandleDummy(SpellEffIndex effIndex)
        {
            ...
            if (!target)
                return;
            if (GetCaster()->GetTypeId() == TYPEID_UNIT && GetCaster()->ToCreature()->AI() && roll_chance_i(10))
            {
...
{
public:
    spell_item_essence_of_life()
        : SpellScriptLoader("spell_item_essence_of_life")
    {
    }
...
public:
    spell_item_crazy_alchemists_potion()
        : SpellScriptLoader("spell_item_crazy_alchemists_potion")
    {
    }
...
{
public:
    spell_item_skull_of_impeding_doom()
        : SpellScriptLoader("spell_item_skull_of_impeding_doom")
    {
    }
...
{
public:
    spell_item_carrot_on_a_stick()
        : SpellScriptLoader("spell_item_carrot_on_a_stick")
    {
    }
...
public:
    spell_item_fish_feast()
        : SpellScriptLoader("spell_item_fish_feast")
    {
    }
...
{
public:
    spell_item_strong_anti_venom()
        : SpellScriptLoader("spell_item_strong_anti_venom")
    {
    }
...
{
public:
    spell_item_gnomish_shrink_ray()
        : SpellScriptLoader("spell_item_gnomish_shrink_ray")
    {
    }
...
{
public:
    spell_item_goblin_weather_machine()
        : SpellScriptLoader("spell_item_goblin_weather_machine")
    {
    }
...
{
public:
    spell_item_light_lamp()
        : SpellScriptLoader("spell_item_light_lamp")
    {
    }
...
{
public:
    spell_item_fetch_ball()
        : SpellScriptLoader("spell_item_fetch_ball")
    {
    }
    ...
    class spell_item_fetch_ball_SpellScript : public SpellScript
    {
        ...
        void SelectTarget(std::list<WorldObject*>& targets)
        {
            ...
            for (std::list<WorldObject*>::const_iterator itr = targets.begin(); itr != targets.end(); ++itr)
                if (Creature* creature = (*itr)->ToCreature())
                {
                    if (creature->GetOwnerGUID() == GetCaster()->GetOwnerGUID() && !creature->IsNonMeleeSpellCast(false) && creature->GetMotionMaster()->GetCurrentMovementGeneratorType() != POINT_MOTION_TYPE)
                    {
                        target = creature;
                        break;
                    }
...
public:
    spell_item_oracle_ablutions()
        : SpellScriptLoader("spell_item_oracle_ablutions")
    {
    }
...
public:
    spell_item_trauma()
        : SpellScriptLoader("spell_item_trauma")
    {
    }
...
public:
    spell_item_blade_ward_enchant()
        : SpellScriptLoader("spell_item_blade_ward_enchant")
    {
    }
...
{
public:
    spell_item_blood_draining_enchant()
        : SpellScriptLoader("spell_item_blood_draining_enchant")
    {
    }
    ...
    class spell_item_blood_draining_enchant_AuraScript : public AuraScript
    {
        ...
        void HandleProc(AuraEffect const* aurEff, ProcEventInfo& eventInfo)
        {
            ...
            caster->CastCustomSpell(SPELL_GEN_BLOOD_RESERVE_HEAL, SPELLVALUE_BASE_POINT0, aurEff->GetAmount(), caster, TRIGGERED_FULL_MASK);
            caster->RemoveAura(SPELL_GEN_BLOOD_RESERVE_AURA);
        }

        void Register() override
        {
            DoCheckProc += AuraCheckProcFn(spell_item_blood_draining_enchant_AuraScript::CheckProc);
...
{
public:
    spell_item_dragon_kite_summon_lightning_bunny()
        : SpellScriptLoader("spell_item_dragon_kite_summon_lightning_bunny")
    {
    }
...
{
public:
    spell_item_enchanted_broom_periodic()
        : SpellScriptLoader("spell_item_enchanted_broom_periodic")
    {
    }
...
{
public:
    spell_item_summon_or_dismiss()
        : SpellScriptLoader("spell_item_summon_or_dismiss")
    {
    }
...
{
public:
    spell_item_draenic_pale_ale()
        : SpellScriptLoader("spell_item_draenic_pale_ale")
    {
    }
...
{
public:
    spell_item_direbrew_remote()
        : SpellScriptLoader("spell_item_direbrew_remote")
    {
    }
...
public:
    spell_item_aegis_of_preservation()
        : SpellScriptLoader("spell_item_aegis_of_preservation")
    {
    }
...
public:
    spell_item_arcane_shroud()
        : SpellScriptLoader("spell_item_arcane_shroud")
    {
    }
...
public:
    spell_item_blessing_of_ancient_kings()
        : SpellScriptLoader("spell_item_blessing_of_ancient_kings")
    {
    }
...
public:
    spell_item_desperate_defense()
        : SpellScriptLoader("spell_item_desperate_defense")
    {
    }
...
public:
    spell_item_echoes_of_light()
        : SpellScriptLoader("spell_item_echoes_of_light")
    {
    }
...
public:
    spell_item_fate_rune_of_unsurpassed_vigor()
        : SpellScriptLoader("spell_item_fate_rune_of_unsurpassed_vigor")
    {
    }
    ...
    class spell_item_gnomish_death_ray_SpellScript : public SpellScript
    {
        ...
        void HandleDummy(SpellEffIndex /*effIndex*/)
        {
            ...
            if (Unit* target = GetHitUnit())
            {
                ...
                {
                    int32 dmg = caster->getLevel() * urand(600, 1200) / 60;
                    caster->CastCustomSpell(target, SPELL_GNOMISH_DEATH_RAY_TARGET, &dmg, nullptr, nullptr, true);
                }
            }
        }
...
public:
    spell_item_necrotic_touch()
        : SpellScriptLoader("spell_item_necrotic_touch")
    {
    }
...
public:
    spell_item_piccolo_of_the_flaming_fire()
        : SpellScriptLoader("spell_item_piccolo_of_the_flaming_fire")
    {
    }
...
public:
    spell_item_scroll_of_recall()
        : SpellScriptLoader("spell_item_scroll_of_recall")
    {
    }
    ...
    class spell_item_scroll_of_recall_SpellScript : public SpellScript
    {
        ...
        void HandleScript(SpellEffIndex effIndex)
        {
            ...
            if (caster->getLevel() > maxSafeLevel)
            {
                ...
                if (GetCaster()->ToPlayer()->GetTeam(CF_DENY) == TEAM_HORDE)
...
public:
    spell_item_unsated_craving()
        : SpellScriptLoader("spell_item_unsated_craving")
    {
    }
...
public:
    spell_item_shadows_fate()
        : SpellScriptLoader("spell_item_shadows_fate")
    {
    }
    ...
    class spell_item_shadows_fate_AuraScript : public AuraScript
    {
        ...
        void HandleProc(AuraEffect const* aurEff, ProcEventInfo& eventInfo)
        {
            ...
            if (caster->IsCreature() && !caster->ToCreature()->IsDamageEnoughForLootingAndReward())
                return;
...
public:
    ...
    class spell_item_shadowmourne_AuraScript : public AuraScript
    {
        ...
        bool CheckProc(ProcEventInfo& eventInfo)
        {
            ...
            if (sWorld->getIntConfig(CONFIG_SHADOWMOURNE_DISABLE_MASK) & 0x01 && GetTarget()->FindMap()->IsBattleArena())
                return false;
            if (sWorld->getIntConfig(CONFIG_SHADOWMOURNE_DISABLE_MASK) & 0x02 && GetTarget()->FindMap()->IsBattleground())
                return false;
...
public:
    spell_item_shadowmourne_soul_fragment()
        : SpellScriptLoader("spell_item_shadowmourne_soul_fragment")
    {
    }
...
public:
    spell_item_the_eye_of_diminution()
        : SpellScriptLoader("spell_item_the_eye_of_diminution")
    {
    }
...
public:
    spell_item_map_of_the_geyser_fields()
        : SpellScriptLoader("spell_item_map_of_the_geyser_fields")
    {
    }
    ...
    class spell_item_map_of_the_geyser_fields_SpellScript : public SpellScript
    {
        ...
        {
            Unit* caster = GetCaster();
            if (caster->FindNearestCreature(NPC_SOUTH_SINKHOLE, 30.0f, true) || caster->FindNearestCreature(NPC_NORTHEAST_SINKHOLE, 30.0f, true) || caster->FindNearestCreature(NPC_NORTHWEST_SINKHOLE, 30.0f, true))
                return SPELL_CAST_OK;
...
public:
    spell_item_vanquished_clutches()
        : SpellScriptLoader("spell_item_vanquished_clutches")
    {
    }
...
public:
    spell_item_ashbringer()
        : SpellScriptLoader("spell_item_ashbringer")
    {
    }
...
{
public:
    spell_magic_eater_food()
        : SpellScriptLoader("spell_magic_eater_food")
    {
    }
...
public:
    spell_item_shimmering_vessel()
        : SpellScriptLoader("spell_item_shimmering_vessel")
    {
    }
...
public:
    spell_item_purify_helboar_meat()
        : SpellScriptLoader("spell_item_purify_helboar_meat")
    {
    }
...
public:
    spell_item_crystal_prison_dummy_dnd()
        : SpellScriptLoader("spell_item_crystal_prison_dummy_dnd")
    {
    }
...
{
public:
    spell_item_reindeer_transformation()
        : SpellScriptLoader("spell_item_reindeer_transformation")
    {
    }
...
public:
    spell_item_nigh_invulnerability()
        : SpellScriptLoader("spell_item_nigh_invulnerability")
    {
    }
...
public:
    spell_item_poultryizer()
        : SpellScriptLoader("spell_item_poultryizer")
    {
    }
...
public:
    spell_item_socrethars_stone()
        : SpellScriptLoader("spell_item_socrethars_stone")
    {
    }
...
public:
    spell_item_demon_broiled_surprise()
        : SpellScriptLoader("spell_item_demon_broiled_surprise")
    {
    }
...
public:
    spell_item_complete_raptor_capture()
        : SpellScriptLoader("spell_item_complete_raptor_capture")
    {
    }
...
public:
    spell_item_impale_leviroth()
        : SpellScriptLoader("spell_item_impale_leviroth")
    {
    }
...
{
public:
    spell_item_brewfest_mount_transformation()
        : SpellScriptLoader("spell_item_brewfest_mount_transformation")
    {
    }
                ...
                switch (GetSpellInfo()->Id)
                {
                    case SPELL_BREWFEST_MOUNT_TRANSFORM:
                        if (caster->GetSpeedRate(MOVE_RUN) >= 2.0f)
                            spell_id = caster->GetTeam(CF_DENY) == TEAM_ALLIANCE ? SPELL_MOUNT_RAM_100 : SPELL_MOUNT_KODO_100;
                        else
                            spell_id = caster->GetTeam(CF_DENY) == TEAM_ALLIANCE ? SPELL_MOUNT_RAM_60 : SPELL_MOUNT_KODO_60;
                        break;
                    case SPELL_BREWFEST_MOUNT_TRANSFORM_REVERSE:
                        if (caster->GetSpeedRate(MOVE_RUN) >= 2.0f)
                            spell_id = caster->GetTeam(CF_DENY) == TEAM_HORDE ? SPELL_MOUNT_RAM_100 : SPELL_MOUNT_KODO_100;
                        else
                            spell_id = caster->GetTeam(CF_DENY) == TEAM_HORDE ? SPELL_MOUNT_RAM_60 : SPELL_MOUNT_KODO_60;
                        break;
                    default:
                        return;
                }
...
{
public:
    spell_item_nitro_boots()
        : SpellScriptLoader("spell_item_nitro_boots")
    {
    }
...
{
public:
    spell_item_goblin_rocket_boots()
        : SpellScriptLoader("spell_item_goblin_rocket_boots")
    {
    }
...
public:
    spell_item_teach_language()
        : SpellScriptLoader("spell_item_teach_language")
    {
    }
    ...
    class spell_item_teach_language_SpellScript : public SpellScript
    {
        ...
        void HandleDummy(SpellEffIndex /* effIndex */)
        {
            ...
            if (roll_chance_i(34))
                caster->CastSpell(caster, caster->GetTeam(CF_DENY) == TEAM_ALLIANCE ? SPELL_LEARN_GNOMISH_BINARY : SPELL_LEARN_GOBLIN_BINARY, true);
        }
...
public:
    spell_item_rocket_boots()
        : SpellScriptLoader("spell_item_rocket_boots")
    {
    }
...
public:
    spell_item_pygmy_oil()
        : SpellScriptLoader("spell_item_pygmy_oil")
    {
    }
...
public:
    spell_item_unusual_compass()
        : SpellScriptLoader("spell_item_unusual_compass")
    {
    }
...
public:
    spell_item_chicken_cover()
        : SpellScriptLoader("spell_item_chicken_cover")
    {
    }
...
public:
    spell_item_refocus()
        : SpellScriptLoader("spell_item_refocus")
    {
    }
...
public:
    spell_item_muisek_vessel()
        : SpellScriptLoader("spell_item_muisek_vessel")
    {
    }
...
public:
    spell_item_greatmothers_soulcatcher()
        : SpellScriptLoader("spell_item_greatmothers_soulcatcher")
    {
    }
...
{
public:
    spell_item_meteorite_crystal()
        : SpellScriptLoader("spell_item_meteorite_crystal")
    {
    }
...
{
public:
    spell_item_tiki_hex_remover()
        : SpellScriptLoader("spell_item_tiki_hex_remover")
    {
    }
...
public:
    spell_item_mind_control_cap()
        : SpellScriptLoader("spell_item_mind_control_cap")
    {
    }
...
{
public:
    spell_item_universal_remote()
        : SpellScriptLoader("spell_item_universal_remote")
    {
    }
...
class spell_item_sundial_of_the_exiled : public AuraScript
{
    PrepareAuraScript(spell_item_sundial_of_the_exiled);
    ...
    bool CheckProc(ProcEventInfo& eventInfo)
    {
        switch (eventInfo.GetTypeMask())
        {
            case PROC_FLAG_DONE_SPELL_MAGIC_DMG_CLASS_NEG:
                return true;
            case PROC_FLAG_DONE_SPELL_MAGIC_DMG_CLASS_POS:
                // Allow to proc with Penance (heal) and Power Word: Shield
                if (SpellInfo const* spellInfo = eventInfo.GetSpellInfo())
                    return spellInfo->SpellFamilyName == SPELLFAMILY_PRIEST && (spellInfo->SpellFamilyFlags == flag96(0x0, 0x00010000, 0x0) || spellInfo->SpellFamilyFlags == flag96(0x00000001, 0x0, 0x00000400));
                // fallthrough
            default:
                return false;
        }
    ...
    void Register() override
    {
        DoCheckProc += AuraCheckProcFn(spell_item_sundial_of_the_exiled::CheckProc);
    }
};

// 57351 - Berserker!
class spell_item_dmc_berserker : public AuraScript
{
    PrepareAuraScript(spell_item_dmc_berserker);

    bool CheckProc(ProcEventInfo& eventInfo)
    {
        // Exclude mount spells
        if (SpellInfo const* spellInfo = eventInfo.GetSpellInfo())
            return !spellInfo->HasAttribute(SPELL_ATTR6_UNK17);
    ...
    void Register() override
    {
        DoCheckProc += AuraCheckProcFn(spell_item_dmc_berserker::CheckProc);
    }
};

// 9512 - Restore Energy
class spell_thistle_tea : public SpellScript
{
    PrepareSpellScript(spell_thistle_tea)

    void HandleEnergize(SpellEffIndex /*effIndex*/)
    {
        if (Unit* target = GetHitUnit())
            SetEffectValue(100 - 2 * (std::max(0, target->getLevel() - 40)));
    }

    void Register() override
    {
        OnEffectHitTarget += SpellEffectFn(spell_thistle_tea::HandleEnergize, EFFECT_0, SPELL_EFFECT_ENERGIZE);
    }
};

enum HyperspeedAccelaratosEnum
{
    SPELL_COOLDOWN_CATEGORY         = 1141,
    SPELL_HYPERSPEED_ACCELARATOR    = 54758
};

class spell_item_hyperspeed_accelarators : public SpellScript
{
    PrepareSpellScript(spell_item_hyperspeed_accelarators);

    void RemoveCooldown()
    {
        if (Player* player = GetCaster()->ToPlayer())
        {
            if (ItemRef item = GetSpell()->m_CastItem)
            {
                SpellCategoryStore::const_iterator i_scstore = sSpellsByCategoryStore.find(SPELL_COOLDOWN_CATEGORY);
                if (i_scstore != sSpellsByCategoryStore.end())
                    for (uint32 categorySpellID : i_scstore->second)
                        if (categorySpellID == m_scriptSpellId || !player->HasSpellCooldown(categorySpellID))
                            player->SendClearCooldown(categorySpellID, player);
    ...
    void Register() override
    {
        AfterCast += SpellCastFn(spell_item_hyperspeed_accelarators::RemoveCooldown);
    }
};
...
void AddSC_item_spell_scripts()
{
    ...
    RegisterAuraScript(spell_item_sundial_of_the_exiled);
    RegisterAuraScript(spell_item_dmc_berserker);
    RegisterSpellScript(spell_thistle_tea);
    ...
    RegisterSpellScript(spell_item_hyperspeed_accelarators);
}
