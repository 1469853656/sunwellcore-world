...
public:
    npcs_dithers_and_arbington()
        : CreatureScript("npcs_dithers_and_arbington")
    {
    }
...
public:
    npc_myranda_the_hag()
        : CreatureScript("npc_myranda_the_hag")
    {
    }
    ...
    bool OnGossipHello(Player* player, Creature* creature) override
    {
        ...
        if (player->GetQuestRewardStatus(QUEST_FIND_MYRANDA) && !player->GetQuestRewardStatus(QUEST_IN_DREAMS) && !player->HasAura(SPELL_SCARLET_ILLUSION))
        {
...
public:
    npc_the_scourge_cauldron()
        : CreatureScript("npc_the_scourge_cauldron")
    {
    }
    ...
    {
        npc_the_scourge_cauldronAI(Creature* creature)
            : ScriptedAI(creature)
        {
        }
...
public:
    npc_andorhal_tower()
        : CreatureScript("npc_andorhal_tower")
    {
    }
    ...
    {
        npc_andorhal_towerAI(Creature* creature)
            : ScriptedAI(creature)
        {
...
public:
    npc_ghost_of_uther()
        : CreatureScript("npc_ghost_of_uther")
    {
    }

    struct npc_ghost_of_utherAI : public ScriptedAI
    {
        npc_ghost_of_utherAI(Creature* creature)
            : ScriptedAI(creature)
        {
        }
