...
public:
    npc_kiljaeden_controller()
        : CreatureScript("npc_kiljaeden_controller")
    {
    }
...
public:
    npc_kalecgos_kj()
        : CreatureScript("npc_kalecgos_kj")
    {
    }
...
public:
    spell_kiljaeden_darkness()
        : SpellScriptLoader("spell_kiljaeden_darkness")
    {
    }
