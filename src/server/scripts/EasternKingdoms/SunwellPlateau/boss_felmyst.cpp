...
public:
    npc_demonic_vapor()
        : CreatureScript("npc_demonic_vapor")
    {
    }
    ...
    {
        npc_demonic_vaporAI(Creature* creature)
...
public:
    npc_demonic_vapor_trail()
        : CreatureScript("npc_demonic_vapor_trail")
    {
    }
    ...
    {
        npc_demonic_vapor_trailAI(Creature* creature)
            : NullCreatureAI(creature)
        {
            timer = 1;
        }
