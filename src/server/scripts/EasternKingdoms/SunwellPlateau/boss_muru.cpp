...
public:
    npc_singularity()
        : CreatureScript("npc_singularity")
    {
    }
    ...
    {
        npc_singularityAI(Creature* creature)
...
public:
    spell_muru_darkness()
        : SpellScriptLoader("spell_muru_darkness")
    {
    }
