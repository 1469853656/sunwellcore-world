...
{
    npc_thrall_pre_battle_undercityAI(Creature* creature)
        : ScriptedAI(creature)
    {
...
{
    npc_runthak_pre_battle_undercityAI(Creature* creature)
        : ScriptedAI(creature)
    {
        MerchantList.clear();
    }
...
{
public:
    go_battle_for_undercity_portals()
        : GameObjectScript("go_battle_for_undercity_portals")
    {
    }

    struct go_battle_for_undercity_portalsAI : public GameObjectAI
    {
        go_battle_for_undercity_portalsAI(GameObject* go)
            : GameObjectAI(go)
        {
...
{
public:
    AreaTrigger_at_orgrimmar()
        : AreaTriggerScript("AreaTrigger_at_orgrimmar")
    {
    }
...
{
    npc_wave_trigger_battle_undercityAI(Creature* creature)
        : ScriptedAI(creature)
        , _summons(me)
    {
        IsPermament  = true;
