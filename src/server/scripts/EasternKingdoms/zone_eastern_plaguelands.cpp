...
public:
    npc_eris_hevenfire()
        : CreatureScript("npc_eris_hevenfire")
    {
    }
    ...
    {
        npc_eris_hevenfireAI(Creature* c)
            : ScriptedAI(c)
            , summons(me)
        {
        }
...
public:
    npc_ghoul_flayer()
        : CreatureScript("npc_ghoul_flayer")
    {
    }
...
public:
    npc_augustus_the_touched()
        : CreatureScript("npc_augustus_the_touched")
    {
    }
...
public:
    npc_darrowshire_spirit()
        : CreatureScript("npc_darrowshire_spirit")
    {
    }
...
public:
    npc_tirion_fordring()
        : CreatureScript("npc_tirion_fordring")
    {
    }
...
{
public:
    spell_haunted_darrowshire()
        : SpellScriptLoader("spell_haunted_darrowshire")
    {
    }
