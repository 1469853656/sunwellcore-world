...
public:
    ...
    struct boss_nalorakkAI : public ScriptedAI
    {
                    ...
                    if (!inMove)
                    {
                        switch (MovePhase)
                        {
                            case 0:
                                ...
                                {
                                    me->MonsterYell(YELL_NALORAKK_WAVE1, LANG_UNIVERSAL, nullptr);
                            ...
                            case 2:
                                ...
                                {
                                    me->MonsterYell(YELL_NALORAKK_WAVE2, LANG_UNIVERSAL, nullptr);
                            ...
                            case 5:
                                if (me->IsWithinDistInMap(who, 40))
                                {
                                    me->MonsterYell(YELL_NALORAKK_WAVE3, LANG_UNIVERSAL, nullptr);
                            ...
                            case 7:
                                if (me->IsWithinDistInMap(who, 50))
                                {
                                    ...
                                    me->MonsterYell(YELL_NALORAKK_WAVE4, LANG_UNIVERSAL, nullptr);
        ...
        void EnterCombat(Unit* /*who*/) override
        {
            ...
            me->MonsterYell(YELL_AGGRO, LANG_UNIVERSAL, nullptr);
        ...
        void JustDied(Unit* /*killer*/) override
        {
            ...
            me->MonsterYell(YELL_DEATH, LANG_UNIVERSAL, nullptr);
        ...
        void KilledUnit(Unit* /*victim*/) override
        {
            ...
            {
                case 0:
                    me->MonsterYell(YELL_KILL_ONE, LANG_UNIVERSAL, nullptr);
                    DoPlaySoundToSet(me, SOUND_YELL_KILL_ONE);
                    break;
                case 1:
                    me->MonsterYell(YELL_KILL_TWO, LANG_UNIVERSAL, nullptr);
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            if (Berserk_Timer <= diff)
            {
                ...
                me->MonsterYell(YELL_BERSERK, LANG_UNIVERSAL, nullptr);
            ...
            if (ShapeShift_Timer <= diff)
            {
                if (inBearForm)
                {
                    ...
                    me->MonsterYell(YELL_SHIFTEDTOTROLL, LANG_UNIVERSAL, nullptr);
                ...
                else
                {
                    ...
                    me->MonsterYell(YELL_SHIFTEDTOBEAR, LANG_UNIVERSAL, nullptr);
            ...
            if (!inBearForm)
            {
                ...
                if (Surge_Timer <= diff)
                {
                    me->MonsterYell(YELL_SURGE, LANG_UNIVERSAL, nullptr);
