...
{
public:
    worldzone_searing_gorge()
        : WorldMapZoneScript("worldzone_searing_gorge")
    {
    }

    struct worldzone_searing_gorge_WorldMapZoneScript : public WorldZoneScript
    {
        worldzone_searing_gorge_WorldMapZoneScript()
            : WorldZoneScript()
        {
        }
...
struct npc_hellforge_portal_event_AI : public ScriptedAI
{
    ...
    npc_hellforge_portal_event_AI(Creature* creature)
        : ScriptedAI(creature)
        , _summons(creature)
    {
    }
    ...
    void TeleportToDiablo(Unit* who)
    {
        ...
        {
            ChatHandler(player->GetSession()).SendSysMessage("Wrong difficulty setting, please set 25 man heroic in order to enter Hellforge.");
            return;
        }
...
struct npc_hellforge_portal_defender_AI : public ScriptedAI
{
    ...
    npc_hellforge_portal_defender_AI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
...
struct npc_hellforge_portal_attacker_AI : public ScriptedAI
{
    ...
    npc_hellforge_portal_attacker_AI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
...
struct npc_hellforge_portal_attacker_leader_AI : public ScriptedAI
{
    ...
    npc_hellforge_portal_attacker_leader_AI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
