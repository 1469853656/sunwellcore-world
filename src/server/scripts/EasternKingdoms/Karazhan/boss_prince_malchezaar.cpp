...
struct boss_malchezaarAI : public BossAI
{
    boss_malchezaarAI(Creature* creature)
        : BossAI(creature, BOSS_MALCHEZZAR)
    {
    }
...
{
    npc_malchezaar_addAI(Creature* creature)
        : ScriptedAI(creature)
    {
...
{
    npc_flying_axeAI(Creature* creature)
        : npc_malchezaar_addAI(creature)
    {
    }
...
{
    npc_infernal_targetAI(Creature* creature)
        : ScriptedAI(creature)
    {
        _instance = me->GetInstanceScript();
    }
