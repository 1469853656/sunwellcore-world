...
public:
    npc_image_of_medivh()
        : CreatureScript("npc_image_of_medivh")
    {
    }
...
{
    npc_servant_quartersAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
...
{
    npc_coldmist_stalkerAI(Creature* creature)
        : npc_servant_quartersAI(creature)
    {
    }
...
{
    npc_coldmist_widowAI(Creature* creature)
        : npc_servant_quartersAI(creature)
    {
    }
...
{
    npc_shadowbatAI(Creature* creature)
        : npc_servant_quartersAI(creature)
    {
    }
...
{
    npc_greater_shadowbatAI(Creature* creature)
        : npc_servant_quartersAI(creature)
    {
    }
...
{
    npc_vampiric_shadowbatAI(Creature* creature)
        : npc_servant_quartersAI(creature)
    {
    }
...
{
    npc_shadowbeastAI(Creature* creature)
        : npc_servant_quartersAI(creature)
    {
    }
...
{
    npc_dreadbeastAI(Creature* creature)
        : npc_servant_quartersAI(creature)
    {
    }
...
{
    npc_phase_houndAI(Creature* creature)
        : npc_servant_quartersAI(creature)
    {
    }
