...
{
    boss_big_bad_wolfAI(Creature* creature)
        : ScriptedAI(creature)
    {
        _instance = me->GetInstanceScript();
    }
...
{
    npc_oz_eventAI(Creature* creature)
        : ScriptedAI(creature)
    {
...
{
    npc_dorotheeAI(Creature* creature)
        : npc_oz_eventAI(creature)
    {
    }
...
{
    npc_strawmanAI(Creature* creature)
        : npc_oz_eventAI(creature)
    {
    }
...
{
    npc_tinheadAI(Creature* creature)
        : npc_oz_eventAI(creature)
    {
    }
