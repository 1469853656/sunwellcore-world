...
public:
    boss_priestess_delrissa()
        : CreatureScript("boss_priestess_delrissa")
    {
    }
    ...
    struct boss_priestess_delrissaAI : public ScriptedAI
    {
        ...
        void InitializeAI() override
        {
            ...
            Trinity::Containers::RandomResize(helpersList, MAX_ACTIVE_HELPERS);
...
public:
    boss_kagani_nightstrike()
        : CreatureScript("boss_kagani_nightstrike")
    {
    }
...
public:
    boss_ellris_duskhallow()
        : CreatureScript("boss_ellris_duskhallow")
    {
    }
...
public:
    boss_eramas_brightblaze()
        : CreatureScript("boss_eramas_brightblaze")
    {
    }
...
public:
    boss_warlord_salaris()
        : CreatureScript("boss_warlord_salaris")
    {
    }
