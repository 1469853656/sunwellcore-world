...
public:
    boss_felblood_kaelthas()
        : CreatureScript("boss_felblood_kaelthas")
    {
    }
    ...
    struct boss_felblood_kaelthasAI : public ScriptedAI
    {
        ...
        void EnterCombat(Unit* /*who*/) override
        {
            ...
            events.ScheduleEvent(EVENT_SPELL_PHOENIX, urand(15000, 20000));
            events.ScheduleEvent(EVENT_SPELL_FLAMESTRIKE, urand(25000, 35000));
            events.ScheduleEvent(EVENT_CHECK_HEALTH, 1000);

            if (IsHeroic())
                events.ScheduleEvent(EVENT_SPELL_SHOCK_BARRIER, 60000);
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            switch (uint32 eventId = events.ExecuteEvent())
            {
                case EVENT_SPELL_FIREBALL:
                    ...
                    events.ScheduleEvent(EVENT_SPELL_FIREBALL, urand(2500, 6000));
                    break;
                ...
                case EVENT_SPELL_PHOENIX:
                    ...
                    events.ScheduleEvent(EVENT_SPELL_PHOENIX, urand(45000, 55000));
                    break;
...
{
public:
    spell_mt_phoenix_burn()
        : SpellScriptLoader("spell_mt_phoenix_burn")
    {
    }
