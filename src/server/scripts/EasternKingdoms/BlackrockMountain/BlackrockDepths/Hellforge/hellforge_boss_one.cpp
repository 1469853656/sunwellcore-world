...
{
    boss_hellforge_one_AI(Creature* creature)
        : BossAI(creature, DATA_BOSS_ONE)
        , _myLittleWormsPositions(_littleWormsPositions)
    {
    }
...
{
    npc_little_worm_boss_one_AI(Creature* creature)
        : ScriptedAI(creature)
    {
...
{
    npc_exploding_worm_AI(Creature* creature)
        : ScriptedAI(creature)
    {
