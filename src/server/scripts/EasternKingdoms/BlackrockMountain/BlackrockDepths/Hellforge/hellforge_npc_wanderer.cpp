...
{
public:
    npc_hellforge_wanderer()
        : CreatureScript("npc_hellforge_wanderer")
    {
    }
    ...
    {
        npc_hellforge_wandererAI(Creature* creature)
            : ScriptedAI(creature)
            , _state(STATE_RAID_ENTRANCE)
            , _simonDoorOpened(false)
        {
...
{
    npc_hellforge_wanderer_champion_cocoonAI(Creature* creature)
        : ScriptedAI(creature)
    {
        _instance = me->GetInstanceScript();
...
{
public:
    npc_hellforge_wanderer_champion()
        : CreatureScript("npc_hellforge_wanderer_champion")
    {
    }
    ...
    {
        npc_hellforge_wanderer_championAI(Creature* creature)
            : ScriptedAI(creature)
            , _state(STATE_TRAPPED)
        {
            _instance = me->GetInstanceScript();
...
{
    npc_hellforge_tyraelAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
