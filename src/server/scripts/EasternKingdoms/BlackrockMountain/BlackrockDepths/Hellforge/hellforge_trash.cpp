...
const std::array<Position, GARGOYLE_MOVE_POS_SIZE> _gargoyleMovePosition{ { { 1085.441040f, -202.515045f, -53.996468f, 2.250942f },
...
{
    npc_gauntlet_controller_hellforge_AI(Creature* creature)
        : ScriptedAI(creature)
        , _eventRunning(false)
        , _eventDone(false)
...
{
    npc_bloody_gargoyle_hellforge(Creature* creature)
        : ScriptedAI(creature)
    {
    }
...
{
    hellforge_trash_AI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
...
{
    npc_hellforge_championAI(Creature* creature)
        : hellforge_trash_AI(creature)
    {
    }
...
{
    npc_hellforge_adherentAI(Creature* creature)
        : hellforge_trash_AI(creature)
        , summons(me)
    {
    }
...
{
    npc_demonic_impAI(Creature* creature)
        : hellforge_trash_AI(creature)
    {
    }
...
{
    npc_hellforge_priestAI(Creature* creature)
        : hellforge_trash_AI(creature)
    {
    }
...
{
    npc_hellforge_fallen_fanaticAI(Creature* creature)
        : hellforge_trash_AI(creature)
    {
    }
...
{
    npc_hellforge_witch_doctorAI(Creature* creature)
        : hellforge_trash_AI(creature)
    {
    }
...
{
    npc_unliving_druidAI(Creature* creature)
        : hellforge_trash_AI(creature)
    {
    }
...
{
    npc_hellforge_defenderAI(Creature* creature)
        : hellforge_trash_AI(creature)
    {
        if (InstanceScript* instance = me->GetInstanceScript())
...
{
    npc_hellforge_knightAI(Creature* creature)
        : hellforge_trash_AI(creature)
    {
    }
...
{
    npc_hellforge_spyAI(Creature* creature)
        : hellforge_trash_AI(creature)
    {
    }
...
{
    npc_hellforge_berserkerAI(Creature* creature)
        : hellforge_trash_AI(creature)
    {
    }
...
{
    npc_hellforge_houndAI(Creature* creature)
        : hellforge_trash_AI(creature)
    {
    }
...
{
    npc_hellforge_teleporter(Creature* creature)
        : ScriptedAI(creature)
    {
    ...
    void MoveInLineOfSight(Unit* who) override
    {
        ...
        if (!_canEnter)
        {
            ChatHandler(player->GetSession()).SendSysMessage("You must be in a raid group to enter this instance.");
            return;
        }

        if (player->GetDifficulty(false) != DUNGEON_DIFFICULTY_HEROIC)
        {
            ChatHandler(player->GetSession()).SendSysMessage("Wrong difficulty setting, please set 5 man heroic in order to enter Hellforge.");
            return;
        }
