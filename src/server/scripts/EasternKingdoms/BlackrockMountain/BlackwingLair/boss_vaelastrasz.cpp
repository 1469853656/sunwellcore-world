...
struct boss_vaelAI : public BossAI
{
    boss_vaelAI(Creature* creature)
        : BossAI(creature, BOSS_VAELASTRAZ)
    {
...
{
    new CreatureAILoader<boss_vaelAI>("boss_vaelastrasz");
    new AuraScriptLoaderEx<spell_vael_burning_adrenaline_AuraScript>("spell_vael_burning_adrenaline");
}
