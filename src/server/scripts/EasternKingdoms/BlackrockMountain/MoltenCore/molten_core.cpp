...
{
    npc_core_houndAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
    ...
    bool checkRemainingHounds()
    {
        ...
        if (!houndList.empty())
        {
            ...
            {
                if (!itr->GetHealth() && itr->IsInCombat())
                {
                    check = true;
                    break;
                }
...
{
    npc_ancient_core_houndAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
...
{
    npc_firelordAI(Creature* creature)
        : ScriptedAI(creature)
        , summons(me)
    {
    }
...
{
    npc_majordomo_summonerAI(Creature* creature)
        : ScriptedAI(creature)
    {
