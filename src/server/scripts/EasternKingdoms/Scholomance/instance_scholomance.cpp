...
{
public:
    spell_scholomance_fixate()
        : SpellScriptLoader("spell_scholomance_fixate")
    {
    }
...
public:
    spell_kormok_summon_bone_mages()
        : SpellScriptLoader("spell_kormok_summon_bone_mages")
    {
    }
...
public:
    spell_kormok_summon_bone_minions()
        : SpellScriptLoader("spell_kormok_summon_bone_minions")
    {
    }
...
{
public:
    spell_scholomance_shadow_portal()
        : SpellScriptLoader("spell_scholomance_shadow_portal")
    {
    }
...
{
public:
    spell_scholomance_shadow_portal_rooms()
        : SpellScriptLoader("spell_scholomance_shadow_portal_rooms")
    {
    }
