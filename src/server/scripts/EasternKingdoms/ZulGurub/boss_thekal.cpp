...
{
    boss_thekal_baseAI(Creature* creature, uint32 bossId)
        : BossAI(creature, bossId)
    {
    }
...
struct boss_thekalAI : public boss_thekal_baseAI
{
    boss_thekalAI(Creature* creature)
        : boss_thekal_baseAI(creature, DATA_THEKAL)
    {
    }
...
struct npc_zealot_lorkhanAI : public boss_thekal_baseAI
{
    npc_zealot_lorkhanAI(Creature* creature)
        : boss_thekal_baseAI(creature, DATA_LORKHAN)
    {
    }
...
{
    npc_zealot_zathAI(Creature* creature)
        : boss_thekal_baseAI(creature, DATA_ZATH)
    {
    }
