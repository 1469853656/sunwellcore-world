...
public:
    boss_eye_of_cthun()
        : CreatureScript("boss_eye_of_cthun")
    {
    }
...
public:
    npc_eye_tentacle()
        : CreatureScript("npc_eye_tentacle")
    {
    }
...
public:
    npc_claw_tentacle()
        : CreatureScript("npc_claw_tentacle")
    {
    }
...
public:
    npc_giant_claw_tentacle()
        : CreatureScript("npc_giant_claw_tentacle")
    {
    }
...
public:
    npc_giant_eye_tentacle()
        : CreatureScript("npc_giant_eye_tentacle")
    {
    }
...
public:
    npc_giant_flesh_tentacle()
        : CreatureScript("npc_giant_flesh_tentacle")
    {
    }
