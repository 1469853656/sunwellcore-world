...
public:
    npc_cork_gizelton()
        : CreatureScript("npc_cork_gizelton")
    {
    }
    ...
    {
        npc_cork_gizeltonAI(Creature* creature)
            ...
            switch (waypointId)
            {
                ...
                case 100:
                {
                    ...
                    for (uint8 i = 0; i < 4; ++i)
                    {
                        ...
                        cr = me->SummonCreature((i % 2 == 0 ? NPC_KOLKAR_WAYLAYER : NPC_KOLKAR_AMBUSHER),
                ...
                case 233:
                {
                    ...
                    for (uint8 i = 0; i < 3; ++i)
                    {
                        ...
                        cr = me->SummonCreature(entry, x, y, me->GetMap()->GetHeight(x, y, MAX_HEIGHT), 0.0f, TEMPSUMMON_TIMED_DESPAWN_OUT_OF_COMBAT, 30000);
                        if (cr)
                            cr->AI()->AttackStart(me);
                    }
                    if (cr)
        ...
        void UpdateEscortAI(uint32 diff) override
        {
            ...
            switch (events.ExecuteEvent())
            {
                ...
                case EVENT_RESTART_ESCORT:
                    ...
                    Start(true, true, 0, nullptr, false, false, true);
                    break;
            }
...
public:
    ...
    {
        npc_dalindaAI(Creature* creature)
            : npc_escortAI(creature)
        {
        }
