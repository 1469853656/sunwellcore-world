...
public:
    ...
    {
        npc_kanatiAI(Creature* creature)
...
public:
    ...
    {
        npc_lakota_windsongAI(Creature* creature)
            : npc_escortAI(creature)
        {
        }
...
public:
    ...
    {
        npc_paoka_swiftmountainAI(Creature* creature)
            : npc_escortAI(creature)
        {
        }
...
public:
    ...
    {
        npc_pluckyAI(Creature* creature)
            : ScriptedAI(creature)
        {
...
public:
    go_panther_cage()
        : GameObjectScript("go_panther_cage")
    {
    }
...
public:
    npc_enraged_panther()
        : CreatureScript("npc_enraged_panther")
    {
    }
    ...
    {
        npc_enraged_pantherAI(Creature* creature)
            : ScriptedAI(creature)
        {
        }
...
struct npc_galak_messenger final : ScriptedAI
{
    npc_galak_messenger(Creature* creature) : ScriptedAI(creature) { me->setActive(true); }
};
...
void AddSC_thousand_needles()
{
    ...
    new go_panther_cage();
    RegisterCreatureAI(npc_galak_messenger);
}
