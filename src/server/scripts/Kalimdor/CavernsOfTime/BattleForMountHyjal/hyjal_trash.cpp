...
hyjal_trashAI::hyjal_trashAI(Creature* creature)
...
public:
    npc_giant_infernal()
        : CreatureScript("npc_giant_infernal")
    {
    }
...
public:
    npc_abomination()
        : CreatureScript("npc_abomination")
    {
    }
...
public:
    npc_necromancer()
        : CreatureScript("npc_necromancer")
    {
    }
...
public:
    npc_fel_stalker()
        : CreatureScript("npc_fel_stalker")
    {
    }
...
public:
    alliance_rifleman()
        : CreatureScript("alliance_rifleman")
    {
    }
