...
{
    explicit boss_onyxiaAI(Creature* creature)
        : BossAI(creature, DATA_ONYXIA)
        , _deepBreath(true)
        , _phase(0)
        , _currentWP(0)
        , _whelpSpam(false)
...
{
    explicit npc_onyxian_lair_guardAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
...
{
    explicit npc_onyxia_whelpAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
...
{
    explicit npc_onyxia_triggerAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
...
{
public:
    achievement_onyxia_deep_breath()
        : AchievementCriteriaScript("achievement_onyxia_deep_breath")
    {
    }
...
{
public:
    achievement_onyxia_many_whelps()
        : AchievementCriteriaScript("achievement_onyxia_many_whelps")
    {
    }
