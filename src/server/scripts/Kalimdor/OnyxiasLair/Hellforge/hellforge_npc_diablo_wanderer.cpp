...
{
public:
    npc_hellforge_diablo_wandererAI(Creature* creature)
        : ScriptedAI(creature)
        , _summons(me)
        , _eventStarted(false)
        , _soulstoneGUID(0)
...
{
    npc_hellforge_diablo_wanderer_soulstoneAI(Creature* creature)
...
{
    npc_dalaran_tyrael()
        : CreatureScript("npc_dalaran_tyrael")
    {
    }
    ...
    {
        npc_dalaran_tyraelAI(Creature* creature)
            : ScriptedAI(creature)
        {
        }
