...
{
public:
    npc_hellforge_diablo_lichkingAI(Creature* creature)
        : ScriptedAI(creature)
        , _summons(creature)
        , _secondPhase(false)
    {
...
{
    npc_hellforge_diablo_valkyr_shadowguardAI(Creature* creature)
        : ScriptedAI(creature)
    ...
    void MovementInform(uint32 type, uint32 id) override
    {
        ...
        switch (id)
        {
            ...
            case POINT_DROP_PLAYER:
            {
                ...
                me->MonsterSay("Order completed my king.", LANG_UNIVERSAL, nullptr);
                me->DespawnOrUnsummon(1000);
                break;
            }
        }
...
{
public:
    npc_hellforge_diablo_frostmourneAI(Creature* creature)
        : ScriptedAI(creature)
        , _summons(me)
    {
    }
...
{
    boss_hellforge_diablo_lk_coldflame_summonerAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
...
{
    boss_hellforge_diablo_lk_coldflameAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
    void Reset() override
...
{
    boss_hellforge_diablo_lk_defileAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
