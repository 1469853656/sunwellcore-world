...
{
public:
    npc_hellforge_diablo_kelthuzadAI(Creature* creature)
        : ScriptedAI(creature)
        , _summons(creature)
...
{
    boss_hellforge_diablo_kelthuzad_minionAI(Creature* c)
        : ScriptedAI(c)
    {
    }
...
{
    boss_hellforge_diablo_kelthuzad_fissureAI(Creature* creature)
        : NullCreatureAI(creature)
    {
    }
