...
{
public:
    boss_hellforge_diablo_anubarakAI(Creature* creature)
        : ScriptedAI(creature)
        , _summons(creature)
...
{
    boss_hellforge_diablo_anubarak_permafrostAI(Creature* creature)
        : ScriptedAI(creature)
        , _anubGuid(0)
    {
        me->SetCanMissSpells(false);
...
{
public:
    boss_hellforge_diablo_anubarak_impale_targetAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
