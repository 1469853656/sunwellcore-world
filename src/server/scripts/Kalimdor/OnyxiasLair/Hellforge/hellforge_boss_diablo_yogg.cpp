...
{
public:
    npc_hellforge_diablo_yoggAI(Creature* creature)
        : ScriptedAI(creature)
        , _summons(creature)
...
{
    boss_hellforge_diablo_yogg_constrictor_tentacleAI(Creature* pCreature)
...
{
public:
    boss_hellforge_diablo_yogg_shadowcrash_casterAI(Creature* creature)
        : ScriptedAI(creature)
        , _shadowCrashCount(0)
    {
    }
...
{
public:
    boss_hellforge_diablo_yogg_shadowcrash_targetAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
...
{
    boss_hellforge_diablo_yogg_childrenAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
...
{
    boss_hellforge_diablo_yogg_crusher_tentacleAI(Creature* pCreature)
        : ScriptedAI(pCreature)
    {
        SetCombatMovement(false);
...
{
    boss_hellforge_diablo_yogg_corruptor_tentacleAI(Creature* pCreature)
        : ScriptedAI(pCreature)
    {
    }
...
{
    boss_hellforge_diablo_yogg_brainAI(Creature* creature)
        : ScriptedAI(creature)
        , _did50pctYell(false)
    {
    }
...
{
    boss_hellforge_diablo_yogg_brain_cellAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
