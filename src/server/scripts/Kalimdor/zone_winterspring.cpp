...
{
public:
    npc_stave_of_the_ancients()
        : CreatureScript("npc_stave_of_the_ancients")
    {
    }
    ...
    {
        npc_stave_of_the_ancientsAI(Creature* creature)
            : ScriptedAI(creature)
        {
...
public:
    go_elune_fire()
        : GameObjectScript("go_elune_fire")
    {
    }
