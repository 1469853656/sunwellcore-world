...
public:
    npc_spirit_shade()
        : CreatureScript("npc_spirit_shade")
    {
    }
...
public:
    spell_dream_fog_sleep()
        : SpellScriptLoader("spell_dream_fog_sleep")
    {
    }
...
public:
    spell_mark_of_nature()
        : SpellScriptLoader("spell_mark_of_nature")
    {
    }
