...
public:
    go_seer_of_zebhalak()
        : GameObjectScript("go_seer_of_zebhalak")
    {
    }
...
{
public:
    go_mistwhisper_treasure()
        : GameObjectScript("go_mistwhisper_treasure")
    {
    }
    ...
    bool OnGossipHello(Player* pPlayer, GameObject* pGo) override
    {
        if (!pGo->FindNearestCreature(28105, 30.0f)) // Tartek
        {
            ...
            {
                cr->MonsterYell("My treasure! You no steal from Tartek, dumb big-tongue traitor thing. Tartek and nasty dragon going to kill you! You so dumb.", LANG_UNIVERSAL, nullptr);
...
{
public:
    go_huge_seaforium_bombs()
        : GameObjectScript("go_huge_seaforium_bombs")
    {
    }

    struct go_huge_seaforium_bombsAI : public GameObjectAI
    {
        go_huge_seaforium_bombsAI(GameObject* gameObject)
            : GameObjectAI(gameObject)
        {
            _timer  = 1;
            isTimed = false;
...
{
public:
    go_arena_ready_marker()
        : GameObjectScript("go_arena_ready_marker")
    {
    }
...
public:
    go_ethereum_prison()
        : GameObjectScript("go_ethereum_prison")
    {
    }
...
public:
    go_stasis_chamber_bashir()
        : GameObjectScript("go_stasis_chamber_bashir")
    {
    }
...
public:
    go_ethereum_stasis()
        : GameObjectScript("go_ethereum_stasis")
    {
    }
...
public:
    go_resonite_cask()
        : GameObjectScript("go_resonite_cask")
    {
    }
...
public:
    go_tadpole_cage()
        : GameObjectScript("go_tadpole_cage")
    {
    }
...
public:
    go_cat_figurine()
        : GameObjectScript("go_cat_figurine")
    {
    }
...
public:
    go_gilded_brazier()
        : GameObjectScript("go_gilded_brazier")
    {
    }
...
public:
    go_tablet_of_madness()
        : GameObjectScript("go_tablet_of_madness")
    {
    }
...
public:
    go_tablet_of_the_seven()
        : GameObjectScript("go_tablet_of_the_seven")
    {
    }
...
public:
    go_jump_a_tron()
        : GameObjectScript("go_jump_a_tron")
    {
    }
...
public:
    go_shrine_of_the_birds()
        : GameObjectScript("go_shrine_of_the_birds")
    {
    }
...
public:
    go_southfury_moonstone()
        : GameObjectScript("go_southfury_moonstone")
    {
    }
...
public:
    go_tele_to_violet_stand()
        : GameObjectScript("go_tele_to_violet_stand")
    {
    }
...
public:
    go_fel_crystalforge()
        : GameObjectScript("go_fel_crystalforge")
    {
    }
...
public:
    go_bashir_crystalforge()
        : GameObjectScript("go_bashir_crystalforge")
    {
    }
...
public:
    go_scourge_cage()
        : GameObjectScript("go_scourge_cage")
    {
    }
...
public:
    go_arcane_prison()
        : GameObjectScript("go_arcane_prison")
    {
    }
...
public:
    go_jotunheim_cage()
        : GameObjectScript("go_jotunheim_cage")
    {
    }
...
public:
    go_table_theka()
        : GameObjectScript("go_table_theka")
    {
    }
...
public:
    go_inconspicuous_landmark()
        : GameObjectScript("go_inconspicuous_landmark")
    {
...
public:
    go_dragonflayer_cage()
        : GameObjectScript("go_dragonflayer_cage")
    {
    }
...
public:
    go_amberpine_outhouse()
        : GameObjectScript("go_amberpine_outhouse")
    {
    }
...
public:
    go_veil_skith_cage()
        : GameObjectScript("go_veil_skith_cage")
    {
    }
...
public:
    go_lard_picnic_basket()
        : GameObjectScript("go_lard_picnic_basket")
    {
    }
...
public:
    go_war_horn_of_jotunheim()
        : GameObjectScript("go_war_horn_of_jotunheim")
    {
    }
...
public:
    go_dirt_mound()
        : GameObjectScript("go_dirt_mound")
    {
    }
...
public:
    go_dead_rise_clue()
        : GameObjectScript("go_dead_rise_clue")
    {
    }
...
public:
    go_the_scarab_gong()
        : GameObjectScript("go_the_scarab_gong")
    {
    }
    ...
    {
        go_the_scarab_gongAI(GameObject* gameObject)
            : GameObjectAI(gameObject)
        {
        }
...
{
    npc_jonathan_the_revelator_AI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
