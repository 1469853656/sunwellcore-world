...
private:
    ...
    {
        uint32 timer = GetTimer();
        return timer >= zeppelinStopKeyFrame.ArriveTime && timer <= zeppelinStopKeyFrame.DepartureTime + 10 * IN_MILLISECONDS;
    }
...
{
public:
    npc_zapettaAI(Creature* creature)
        : ScriptedAI(creature)
...
{
public:
    npc_frezzaAI(Creature* creature)
        : ScriptedAI(creature)
...
{
public:
    npc_squibby_overspeckAI(Creature* creature)
        : ScriptedAI(creature)
        , m_zeppelinLocationHelper(
...
{
public:
    npc_hin_denburgAI(Creature* creature)
        : ScriptedAI(creature)
        , m_zeppelinLocationHelper(
              ZEPPELIN_THE_PURPLE_PRINCESS_ENTRY,
...
{
public:
    npc_snurk_bucksquickAI(Creature* creature)
        : ScriptedAI(creature)
        , m_zeppelinLocationHelper(
              ZEPPELIN_THE_IRON_EAGLE_ENTRY,
              OG_STV_STRANGLETHORN_VALE_STOP_KEYFRAME_INDEX, // first stop
