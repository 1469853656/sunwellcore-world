...
public:
    boss_highlord_kruul()
        : CreatureScript("boss_highlord_kruul")
    {
    }
    ...
    {
        boss_highlord_kruulAI(Creature* c)
            : npc_escortAI(c)
        {
            // Waypoints
        ...
        void KilledUnit(Unit* who) override
        {
            ...
            if (who->GetTypeId() == TYPEID_PLAYER)
            {
                ...
                {
                    int32 heal = 1000000;
                    me->CastCustomSpell(me, SPELL_CAPTURE_SOUL, &heal, nullptr, nullptr, false);
                }
                ...
                if (roll == 0)
                    ...
                    me->MonsterYell("Your fate is sealed, Azeroth! I will find the Aspect Shards, and then you will not stand against our might!", LANG_UNIVERSAL, nullptr);
            }
        }

        void JustDied(Unit* /*Killer*/) override { me->MonsterYell("Ha! This place is not yet worthy of my infliction.", LANG_UNIVERSAL, nullptr); }
            ...
            while (uint32 eventId = events.ExecuteEvent())
            {
                switch (eventId)
                {
                    ...
                    case EVENT_SPELL_THUNDER_CLAP:
                    {
                        ...
                        me->CastCustomSpell(me, SPELL_THUNDER_CLAP, &dmg, nullptr, nullptr, false);
                    ...
                    case EVENT_SPELL_VOID_BOLT:
                    {
                        ...
                        me->CastCustomSpell(me->GetVictim(), SPELL_VOID_BOLT, &dmg, nullptr, nullptr, false);
