...
public:
    ...
    bool OnUse(Player* player, ItemRef const& item, const SpellCastTargets& /*targets*/)
    {
...
{
public:
    item_portable_guildbank()
        : ItemScript("item_portable_guildbank")
    {
    }
