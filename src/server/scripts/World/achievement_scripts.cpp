...
public:
    achievement_tilted()
        : AchievementCriteriaScript("achievement_tilted")
    {
    }
    ...
    bool OnCheck(Player* player, Unit* /*target*/)
    {
        ...
        bool checkArea = areaid == AREA_ARGENT_TOURNAMENT_FIELDS || areaid == AREA_RING_OF_ASPIRANTS || areaid == AREA_RING_OF_ARGENT_VALIANTS || areaid == AREA_RING_OF_ALLIANCE_VALIANTS || areaid == AREA_RING_OF_HORDE_VALIANTS || areaid == AREA_RING_OF_CHAMPIONS;
...
{
public:
    achievement_flirt_with_disaster_check()
        : AchievementCriteriaScript("achievement_flirt_with_disaster_check")
    {
    }
    bool OnCheck(Player* player, Unit* /*target*/)
    {
...
enum TBCAchievesEnum
{
    ACHIEVEMENT_LOREAMSTER_OF_OUTLAND_ALLIANCE  = 1262,
    ACHIEVEMENT_LOREAMSTER_OF_OUTLAND_HORDE     = 1274
};

class achievement_champion_of_the_naaru : public AchievementCriteriaScript
{
public:
    achievement_champion_of_the_naaru() : AchievementCriteriaScript("achievement_champion_of_the_naaru")
    {
    }
    ...
    bool OnCheck(Player* player, Unit* /*target*/)
    {
        if (player->GetTeam(CF_DENY) == TEAM_ALLIANCE)
            return player->HasAchieved(ACHIEVEMENT_LOREAMSTER_OF_OUTLAND_ALLIANCE);

        return player->HasAchieved(ACHIEVEMENT_LOREAMSTER_OF_OUTLAND_HORDE);
    }
};

class achievement_hand_of_adal : public AchievementCriteriaScript
{
public:
    achievement_hand_of_adal() : AchievementCriteriaScript("achievement_hand_of_adal")
    {
    }
...
void AddSC_achievement_scripts()
{
    ...
    new achievement_arena_kills("achievement_arena_5v5_kills", ARENA_TYPE_SOLO_QUEUE);
    ...
    new achievement_champion_of_the_naaru();
    new achievement_hand_of_adal();
}
