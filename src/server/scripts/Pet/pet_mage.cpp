...
public:
    npc_pet_mage_mirror_image()
        : CreatureScript("npc_pet_mage_mirror_image")
    {
    }
    ...
    struct npc_pet_mage_mirror_imageAI : CasterAI
    {
        ...
        bool MySelectNextTarget()
        {
            ...
            {
                if (Unit* gargoyle = ObjectAccessor::GetUnit(*me, _ebonGargoyleGUID))
            ...
            if (Unit* owner = me->GetOwner())
            {
                ...
                if (owner->IsPlayer())
                    ...
                    selection = ObjectAccessor::GetUnit(*owner, owner->GetTarget());
...
{
    npc_pet_mage_water_elementalAI(Creature* creature)
        : PetAI(creature)
    {
    }
