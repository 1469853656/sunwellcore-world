...
{
    boss_krystallusAI(Creature* creature)
        : BossAI(creature, BOSS_KRYSTALLUS)
    {
    }
...
class spell_krystallus_shatter_SpellScript : public SpellScript
{
        ...
        void HandleScript(SpellEffIndex /*effIndex*/)
    {
        if (Unit* target = GetHitUnit())
        {
            ...
            target->CastSpell((Unit*)nullptr, SPELL_SHATTER_EFFECT, true, NullItemRef, nullptr, GetCaster()->GetGUID());
        }
    }
