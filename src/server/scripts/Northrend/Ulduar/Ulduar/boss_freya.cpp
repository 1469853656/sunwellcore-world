...
struct boss_freya : public ScriptedAI
{
    ...
    void KilledUnit(Unit* victim) override
    {
        ...
        if (urand(0, 1))
        {
            me->MonsterYell("Forgive me.", LANG_UNIVERSAL, nullptr);
            me->PlayDirectSound(SOUND_SLAY1);
        }
        else
        {
            me->MonsterYell("From your death springs life anew!", LANG_UNIVERSAL, nullptr);
    ...
    void DamageTaken(Unit* attacker, uint32& damage, DamageEffectType, SpellSchoolMask) override
    {
        ...
        if (damage >= me->GetHealth())
        {
            ...
            me->MonsterYell("His hold on me dissipates. I can see clearly once more. Thank you, heroes.", LANG_UNIVERSAL, nullptr);
    ...
    void SpawnWave()
    {
        ...
        if (_waveNumber == 1)
        {
            me->MonsterYell("Children, assist me!", LANG_UNIVERSAL, nullptr);
        ...
        {
            me->MonsterYell("Eonar, your servant requires aid!", LANG_UNIVERSAL, nullptr);
        ...
        {
            me->MonsterYell("The swarm of the elements shall overtake you!", LANG_UNIVERSAL, nullptr);
    ...
    void EnterCombat(Unit* who) override
    {
        ...
        {
            me->MonsterYell("Elders, grant me your strength!", LANG_UNIVERSAL, nullptr);
            me->PlayDirectSound(SOUND_ELDERS);
        }
        else
        {
            me->MonsterYell("The Conservatory must be protected!", LANG_UNIVERSAL, nullptr);
    ...
    void UpdateAI(uint32 diff) override
    {
        ...
        switch (events.GetEvent())
        {
            ...
            case EVENT_FREYA_BERSERK:
                me->MonsterYell("You have strayed too far, wasted too much time!", LANG_UNIVERSAL, nullptr);
...
{
public:
    boss_freya_elder_stonebark()
        : CreatureScript("boss_freya_elder_stonebark")
    {
    }
    ...
    struct boss_freya_elder_stonebarkAI : public ScriptedAI
    {
        ...
        void KilledUnit(Unit*) override
        {
            ...
            if (urand(0, 1))
            {
                me->MonsterTextEmote("Angry roar", nullptr);
                me->PlayDirectSound(SOUND_STONEBARK_SLAY1);
            }
            else
            {
                me->MonsterYell("Such a waste.", LANG_UNIVERSAL, nullptr);
        ...
        void JustDied(Unit* killer) override
        {
            if (me->GetEntry() == killer->GetEntry())
                return;
            me->MonsterYell("Matron, flee! They are ruthless....", LANG_UNIVERSAL, nullptr);
        ...
        void EnterCombat(Unit*) override
        {
            ...
            me->MonsterYell("This place will serve as your graveyard.", LANG_UNIVERSAL, nullptr);
...
public:
    ...
    struct boss_freya_elder_brightleafAI : public ScriptedAI
    {
        ...
        void KilledUnit(Unit*) override
        {
            ...
            if (urand(0, 1))
            {
                me->MonsterYell("Fertilizer.", LANG_UNIVERSAL, nullptr);
                me->PlayDirectSound(SOUND_BRIGHTLEAF_SLAY1);
            }
            else
            {
                me->MonsterYell("Your corpse will nourish the soil!", LANG_UNIVERSAL, nullptr);
        ...
        void JustDied(Unit* killer) override
        {
            ...
            if (me->GetEntry() == killer->GetEntry())
                return;
            me->MonsterYell("Matron, one has fallen!", LANG_UNIVERSAL, nullptr);
        ...
        void EnterCombat(Unit*) override
        {
            ...
            me->MonsterYell("Matron, the Conservatory has been breached!", LANG_UNIVERSAL, nullptr);
...
public:
    ...
    struct boss_freya_elder_ironbranchAI : public ScriptedAI
    {
        ...
        void KilledUnit(Unit*) override
        {
            ...
            if (urand(0, 1))
            {
                me->MonsterYell("I return you whence you came!", LANG_UNIVERSAL, nullptr);
                me->PlayDirectSound(SOUND_IRONBRANCH_SLAY1);
            }
            else
            {
                me->MonsterYell("BEGONE!", LANG_UNIVERSAL, nullptr);
        ...
        void JustDied(Unit* killer) override
        {
            ...
            DespawnRoots();
            me->MonsterYell("Freya! They come for you.", LANG_UNIVERSAL, nullptr);
        ...
        void EnterCombat(Unit*) override
        {
            ...
            me->MonsterYell("Mortals have no place here!", LANG_UNIVERSAL, nullptr);
...
{
public:
    boss_freya_iron_root()
        : CreatureScript("boss_freya_iron_root")
    {
    }
    ...
    {
        boss_freya_iron_rootAI(Creature* pCreature)
...
{
public:
    boss_freya_lifebinder()
        : CreatureScript("boss_freya_lifebinder")
    {
    }
    ...
    {
        boss_freya_lifebinderAI(Creature* pCreature)
            : NullCreatureAI(pCreature)
        {
        }
...
public:
    boss_freya_healthy_spore()
        : CreatureScript("boss_freya_healthy_spore")
    {
    }
...
{
    boss_freya_summons(Creature* creature)
        : ScriptedAI(creature)
    {
...
{
public:
    boss_freya_nature_bomb()
        : CreatureScript("boss_freya_nature_bomb")
    {
    }
