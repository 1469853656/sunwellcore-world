...
public:
    ...
    struct boss_steelbreakerAI : public ScriptedAI
    {
            ...
            if (Creature* boss = ObjectAccessor::GetCreature(*me, pInstance->GetData64(DATA_STEELBREAKER + urand(0, 2))))
            {
                switch (boss->GetEntry())
                {
                    case NPC_STEELBREAKER:
                        boss->MonsterYell("You will not defeat the Assembly of Iron so easily, invaders!", LANG_UNIVERSAL, nullptr);
                        boss->PlayDirectSound(SOUND_SB_AGGRO);
                        break;
                    case NPC_MOLGEIM:
                        boss->MonsterYell("Nothing short of total decimation will suffice.", LANG_UNIVERSAL, nullptr);
                        boss->PlayDirectSound(SOUND_MOLGEIM_AGGRO);
                        break;
                    case NPC_BRUNDIR:
                        boss->MonsterYell("Whether the world's greatest gnats or the world's greatest heroes, you're still only mortal!", LANG_UNIVERSAL, nullptr);
        ...
        void JustDied(Unit* killer) override
        {
            ...
            if (urand(0, 1))
            {
                me->MonsterYell("My death only serves to hasten your demise.", LANG_UNIVERSAL, nullptr);
                me->PlayDirectSound(SOUND_SB_DEATH1);
            }
            else
            {
                me->MonsterYell("Impossible!", LANG_UNIVERSAL, nullptr);
        ...
        void KilledUnit(Unit* who) override
        {
            ...
            */
            ...
            if (urand(0, 1))
            {
                me->MonsterYell("So fragile and weak!", LANG_UNIVERSAL, nullptr);
                me->PlayDirectSound(SOUND_SB_SLAY1);
            }
            else
            {
                me->MonsterYell("Flesh... such a hindrance.", LANG_UNIVERSAL, nullptr);
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            switch (events.GetEvent())
            {
                ...
                case EVENT_OVERWHELMING_POWER:
                    me->MonsterYell("You seek the secrets of Ulduar? Then take them!", LANG_UNIVERSAL, nullptr);
                    ...
                    break;
                case EVENT_ENRAGE:
                    me->MonsterYell("This meeting of the Assembly of Iron is adjourned!", LANG_UNIVERSAL, nullptr);
...
public:
    boss_runemaster_molgeim()
        : CreatureScript("boss_runemaster_molgeim")
    {
    }
    ...
    struct boss_runemaster_molgeimAI : public ScriptedAI
    {
        ...
        void JustDied(Unit* killer) override
        {
            ...
            if (urand(0, 1))
            {
                me->MonsterYell("The legacy of storms shall not be undone.", LANG_UNIVERSAL, nullptr);
                me->PlayDirectSound(SOUND_MOLGEIM_DEATH1);
            }
            else
            {
                me->MonsterYell("What have you gained from my defeat? You are no less doomed, mortals!", LANG_UNIVERSAL, nullptr);
        ...
        void KilledUnit(Unit* who) override
        {
            ...
            if (urand(0, 1))
            {
                me->MonsterYell("The world suffers yet another insignificant loss.", LANG_UNIVERSAL, nullptr);
                me->PlayDirectSound(SOUND_MOLGEIM_SLAY1);
            }
            else
            {
                me->MonsterYell("Death is the price of your arrogance.", LANG_UNIVERSAL, nullptr);
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            switch (events.GetEvent())
            {
                ...
                case EVENT_RUNE_OF_DEATH:
                {
                    ...
                    me->MonsterYell("Decipher this!", LANG_UNIVERSAL, nullptr);
                ...
                case EVENT_RUNE_OF_SUMMONING:
                    ...
                    me->MonsterYell("Face the lightning surge!", LANG_UNIVERSAL, nullptr);
...
{
    npc_assembly_lightningAI(Creature* creature)
        : ScriptedAI(creature)
    {
        _boomed = false;
...
public:
    boss_stormcaller_brundir()
        : CreatureScript("boss_stormcaller_brundir")
    {
    }
    ...
    struct boss_stormcaller_brundirAI : public ScriptedAI
    {
        ...
        void JustDied(Unit* killer) override
        {
            ...
            if (urand(0, 1))
            {
                me->MonsterYell("The power of the storm lives on...", LANG_UNIVERSAL, nullptr);
                me->PlayDirectSound(SOUND_BRUNDIR_DEATH1);
            }
            else
            {
                me->MonsterYell("You rush headlong into the maw of madness!", LANG_UNIVERSAL, nullptr);
        ...
        void KilledUnit(Unit* who) override
        {
            ...
            if (urand(0, 1))
            {
                me->MonsterYell("A merciful kill!", LANG_UNIVERSAL, nullptr);
                me->PlayDirectSound(SOUND_BRUNDIR_SLAY1);
            }
            else
            {
                me->MonsterYell("HAH!", LANG_UNIVERSAL, nullptr);
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            switch (events.GetEvent())
            {
                ...
                case EVENT_LIGHTNING_WHIRL:
                    me->ApplySpellImmune(1, IMMUNITY_EFFECT, SPELL_EFFECT_INTERRUPT_CAST, false);
                    me->MonsterYell("Stand still and stare into the light!", LANG_UNIVERSAL, nullptr);
                ...
                case EVENT_LIGHTNING_TENDRILS:
                {
                    ...
                    me->MonsterYell("Let the storm clouds rise and rain down death from above!", LANG_UNIVERSAL, nullptr);
...
{
    npc_overload_ball_assembly_AI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
...
public:
    spell_shield_of_runes()
        : SpellScriptLoader("spell_shield_of_runes")
    {
    }
