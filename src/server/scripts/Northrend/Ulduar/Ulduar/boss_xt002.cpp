...
{
    boss_xt002AI(Creature* creature)
        : BossAI(creature, TYPE_XT002)
        , _healthCheck(75)
        , _hardMode(false)
...
{
    npc_xt002_scrapbotAI(Creature* creature)
        : PassiveAI(creature)
        , _locked(true)
    {
        instance = me->GetInstanceScript();
...
{
    npc_xt002_pummellerAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
...
{
public:
    explicit BoomEvent(Creature* me)
        : _me(me)
    {
    }
...
{
    npc_xt002_boombotAI(Creature* creature)
        : PassiveAI(creature)
        , _locked(true)
        , _boomed(false)
    {
...
{
    explicit npc_xt002_life_sparkAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
