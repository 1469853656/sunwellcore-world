...
struct boss_razorscaleAI : public BossAI
{
    boss_razorscaleAI(Creature* creature)
        : BossAI(creature, TYPE_RAZORSCALE)
    {
        Initialize();
    }
...
{
    npc_expedition_defenderAI(Creature* creature)
        : ScriptedAI(creature)
        , _myPositionNumber(0)
        , _instance(creature->GetInstanceScript())
    {
...
{
    npc_expedition_trapperAI(Creature* creature)
        : ScriptedAI(creature)
        , _myPositionNumber(0)
        , _instance(creature->GetInstanceScript())
    {
...
{
    npc_expedition_engineerAI(Creature* creature)
        : ScriptedAI(creature)
        , _instance(creature->GetInstanceScript())
        , _myPositionNumber(0)
        , _canUpdateAI(false)
...
{
    npc_razorscale_spawnerAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
...
{
    npc_razorscale_harpoon_fire_stateAI(Creature* creature)
        : ScriptedAI(creature)
        , _instance(creature->GetInstanceScript())
    {
    }
...
{
    npc_razorscale_devouring_flameAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
...
public:
    go_razorscale_harpoon()
        : GameObjectScript("go_razorscale_harpoon")
    {
    }
...
public:
    go_razorscale_mole_machine()
        : GameObjectScript("go_razorscale_mole_machine")
    {
    }
