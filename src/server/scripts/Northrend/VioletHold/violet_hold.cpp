...
{
    npc_violet_hold_teleportation_portalAI(Creature* creature)
        : npc_violet_hold_teleportation_portal_commonAI(creature)
    {
    }
...
{
    npc_violet_hold_teleportation_portal_eliteAI(Creature* creature)
        : npc_violet_hold_teleportation_portal_commonAI(creature)
    {
    }
...
{
    npc_violet_hold_teleportation_portal_introAI(Creature* creature)
        : npc_violet_hold_teleportation_portal_commonAI(creature)
    {
    }
...
{
    npc_violet_hold_defense_systemAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
...
public:
    go_activation_crystal()
        : GameObjectScript("go_activation_crystal")
    {
    }
