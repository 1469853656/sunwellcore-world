...
struct boss_devourer_of_soulsAI : public BossAI
{
    ...
    void EnterCombat(Unit* /*who*/) override
    {
        ...
        for (auto itr = players.begin(); itr != players.end(); ++itr)
        {
            ...
            if ((player->GetTeam() == TEAM_ALLIANCE && player->GetQuestStatus(QUEST_TEMPERING_THE_BLADE_A) == QUEST_STATUS_INCOMPLETE) || (player->GetTeam() == TEAM_HORDE && player->GetQuestStatus(QUEST_TEMPERING_THE_BLADE_H) == QUEST_STATUS_INCOMPLETE))
            {
...
public:
    achievement_three_faced()
        : AchievementCriteriaScript("achievement_three_faced")
    {
    }
