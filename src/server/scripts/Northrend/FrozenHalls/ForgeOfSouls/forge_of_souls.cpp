...
public:
    npc_fos_leader()
        : CreatureScript("npc_fos_leader")
    {
    }

    struct npc_fos_leaderAI : public ScriptedAI
    {
        npc_fos_leaderAI(Creature* creature)
            : ScriptedAI(creature)
        {
        }
...
{
    npc_fos_leader_secondAI(Creature* creature)
        : ScriptedAI(creature)
    {
...
{
    npc_spitefula_apparition_kamikazeAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
