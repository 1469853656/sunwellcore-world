...
{
    npc_hor_waves_trashAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
...
struct npc_ghostly_priestAI : public npc_hor_waves_trashAI
{
    npc_ghostly_priestAI(Creature* creature)
        : npc_hor_waves_trashAI(creature)
    {
    }
...
{
    npc_spectral_footmanAI(Creature* creature)
        : npc_hor_waves_trashAI(creature)
    {
    }
...
{
    boss_frostsworn_generalAI(Creature* creature)
        : ScriptedAI(creature)
    {
...
public:
    at_hor_shadow_throne()
        : AreaTriggerScript("at_hor_shadow_throne")
    {
    }
...
public:
    npc_hor_leader_second()
        : CreatureScript("npc_hor_leader_second")
    {
    }
...
{
    npc_hor_lk_trash_templateAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
...
{
    npc_hor_raging_ghoulAI(Creature* creature)
        : npc_hor_lk_trash_templateAI(creature)
    {
    }
...
{
    npc_hor_risen_witch_doctorAI(Creature* creature)
        : npc_hor_lk_trash_templateAI(creature)
    {
    }
