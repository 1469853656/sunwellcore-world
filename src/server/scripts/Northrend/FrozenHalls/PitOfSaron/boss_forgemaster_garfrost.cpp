...
public:
    go_saronite_rock()
        : GameObjectScript("go_saronite_rock")
    {
    }

    struct go_saronite_rockAI : public GameObjectAI
    {
        go_saronite_rockAI(GameObject* go)
            : GameObjectAI(go)
        {
...
{
public:
    achievement_garfrost_doesnt_go_to_eleven()
        : AchievementCriteriaScript("achievement_garfrost_doesnt_go_to_eleven")
    {
    }
