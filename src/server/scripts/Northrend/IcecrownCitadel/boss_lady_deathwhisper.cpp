...
public:
    boss_lady_deathwhisper()
        : CreatureScript("boss_lady_deathwhisper")
    {
    }
    ...
    struct boss_lady_deathwhisperAI : public BossAI
    {
        boss_lady_deathwhisperAI(Creature* creature)
            : BossAI(creature, DATA_LADY_DEATHWHISPER)
            , _darnavanGUID(0)
            , _introDone(false)
        {
...
public:
    npc_cult_fanatic()
        : CreatureScript("npc_cult_fanatic")
    {
    }
...
public:
    npc_cult_adherent()
        : CreatureScript("npc_cult_adherent")
    {
    }
...
public:
    npc_vengeful_shade()
        : CreatureScript("npc_vengeful_shade")
    {
    }
...
public:
    spell_cultist_dark_martyrdom()
        : SpellScriptLoader("spell_cultist_dark_martyrdom")
    {
    }
...
{
public:
    at_icc_lady_deathwhisper_entrance()
        : AreaTriggerScript("at_icc_lady_deathwhisper_entrance")
    {
    }
...
{
public:
    spell_deathwhisper_summon_spirit()
        : SpellScriptLoader("spell_deathwhisper_summon_spirit")
    {
    }
    ...
    class spell_deathwhisper_summon_spirit_SpellScript : public SpellScript
    {
        ...
        void HandleSummon(SpellEffIndex effIndex)
        {
            ...
            caster->CastSpell(summonPos->GetPositionX(), summonPos->GetPositionY(), summonPos->GetPositionZ(), triggerSpellId, true, nullptr, nullptr, target->GetGUID());
        }
