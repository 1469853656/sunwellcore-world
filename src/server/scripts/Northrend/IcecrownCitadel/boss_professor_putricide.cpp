...
{
public:
    explicit AbominationDespawner(Unit* owner)
        : _owner(owner)
    {
    }
...
public:
    boss_professor_putricide()
        : CreatureScript("boss_professor_putricide")
    {
    }
        ...
        void JustSummoned(Creature* summon) override
        {
            ...
            switch (summon->GetEntry())
            {
                ...
                case NPC_VOLATILE_OOZE:
                    summon->ApplySpellImmune(0, IMMUNITY_STATE, SPELL_AURA_HASTE_SPELLS, true);
                    // no possible aura seen in sniff adding the aurastate
...
public:
    npc_volatile_ooze()
        : CreatureScript("npc_volatile_ooze")
    {
    }
...
public:
    spell_putricide_eat_ooze()
        : SpellScriptLoader("spell_putricide_eat_ooze")
    {
    }
