...
{
public:
    ShockVortexExplodeEvent(Creature& owner)
        : BasicEvent()
        , _owner(owner)
    {
    }
...
public:
    boss_prince_keleseth_icc()
        : CreatureScript("boss_prince_keleseth_icc")
    {
    }
    ...
    struct boss_prince_kelesethAI : public ScriptedAI
    {
        ...
        void Reset() override
        {
            ...
            {
                me->SetMaxHealth(_originalMaxHP * 1.3f);
                me->SetHealth(me->GetMaxHealth());
                instance->IncreaseMeleeDmgPct(me, 0.2f);
            }
        }
...
public:
    boss_prince_taldaram_icc()
        : CreatureScript("boss_prince_taldaram_icc")
    {
    }
    ...
    struct boss_prince_taldaramAI : public ScriptedAI
    {
            ...
            , instance(creature->GetInstanceScript())
        {
            ...
            if (instance->IsBoostEnabled() == RAID_DIFFICULTY_25MAN_HEROIC)
            {
                me->SetMaxHealth(me->GetMaxHealth() * 1.3f);
                me->SetHealth(me->GetMaxHealth());
                instance->IncreaseMeleeDmgPct(me, 0.2f);
            }
        }
...
public:
    boss_prince_valanar_icc()
        : CreatureScript("boss_prince_valanar_icc")
    {
    }
    ...
    struct boss_prince_valanarAI : public BossAI
    {
        ...
        void EnterEvadeMode() override
        {
            ...
            _evading = true;
            if (Creature* keleseth = ObjectAccessor::GetCreature(*me, instance->GetData64(DATA_PRINCE_KELESETH_GUID)))
                _DespawnAtEvade(30U, keleseth);
            if (Creature* taldaram = ObjectAccessor::GetCreature(*me, instance->GetData64(DATA_PRINCE_TALDARAM_GUID)))
                _DespawnAtEvade(30U, taldaram);
            _DespawnAtEvade();
...
public:
    npc_blood_queen_lana_thel()
        : CreatureScript("npc_blood_queen_lana_thel")
    {
    }
...
public:
    npc_dark_nucleus()
        : CreatureScript("npc_dark_nucleus")
    {
    }
...
public:
    npc_ball_of_flame()
        : CreatureScript("npc_ball_of_flame")
    {
    }
...
public:
    npc_kinetic_bomb()
        : CreatureScript("npc_kinetic_bomb")
    {
    }
