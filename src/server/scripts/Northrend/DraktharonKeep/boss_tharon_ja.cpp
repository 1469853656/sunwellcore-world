...
public:
    ...
    {
        boss_tharon_jaAI(Creature* creature)
            : BossAI(creature, DATA_THARON_JA)
        {
        }
...
{
public:
    spell_tharon_ja_dummy()
        : SpellScriptLoader("spell_tharon_ja_dummy")
    {
    }
