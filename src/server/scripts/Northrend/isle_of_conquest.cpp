...
public:
    npc_ioc_gunship_captain()
        : CreatureScript("npc_ioc_gunship_captain")
    {
    }

    struct npc_ioc_gunship_captainAI : public ScriptedAI
    {
        npc_ioc_gunship_captainAI(Creature* creature)
            : ScriptedAI(creature)
        {
        }
...
{
public:
    boss_isle_of_conquest()
        : CreatureScript("boss_isle_of_conquest")
    {
    }

    struct boss_isle_of_conquestAI : public ScriptedAI
    {
        boss_isle_of_conquestAI(Creature* creature)
            : ScriptedAI(creature)
        {
        }
...
{
public:
    spell_ioc_repair_turret()
        : SpellScriptLoader("spell_ioc_repair_turret")
    {
    }
...
public:
    spell_ioc_gunship_portal()
        : SpellScriptLoader("spell_ioc_gunship_portal")
    {
    }
...
{
public:
    spell_ioc_parachute_ic()
        : SpellScriptLoader("spell_ioc_parachute_ic")
    {
    }
...
public:
    spell_ioc_launch()
        : SpellScriptLoader("spell_ioc_launch")
    {
    }
