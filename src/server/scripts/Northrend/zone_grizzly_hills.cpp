...
{
public:
    npc_riding_the_red_rocket()
        : CreatureScript("npc_riding_the_red_rocket")
    {
    }

    struct npc_riding_the_red_rocketAI : public VehicleAI
    {
        npc_riding_the_red_rocketAI(Creature* creature)
            : VehicleAI(creature)
        {
        }
...
public:
    npc_mrfloppy()
        : CreatureScript("npc_mrfloppy")
    {
    }

    struct npc_mrfloppyAI : public ScriptedAI
    {
        npc_mrfloppyAI(Creature* creature)
            : ScriptedAI(creature)
        {
        }
...
public:
    npc_outhouse_bunny()
        : CreatureScript("npc_outhouse_bunny")
    {
    }

    struct npc_outhouse_bunnyAI : public ScriptedAI
    {
        npc_outhouse_bunnyAI(Creature* creature)
            : ScriptedAI(creature)
        {
        }
...
public:
    npc_tallhorn_stag()
        : CreatureScript("npc_tallhorn_stag")
    {
    }

    struct npc_tallhorn_stagAI : public ScriptedAI
    {
        npc_tallhorn_stagAI(Creature* creature)
            : ScriptedAI(creature)
        {
        }
...
public:
    npc_amberpine_woodsman()
        : CreatureScript("npc_amberpine_woodsman")
    {
    }

    struct npc_amberpine_woodsmanAI : public ScriptedAI
    {
        npc_amberpine_woodsmanAI(Creature* creature)
            : ScriptedAI(creature)
        {
        }
...
public:
    npc_wounded_skirmisher()
        : CreatureScript("npc_wounded_skirmisher")
    {
    }

    struct npc_wounded_skirmisherAI : public ScriptedAI
    {
        npc_wounded_skirmisherAI(Creature* creature)
            : ScriptedAI(creature)
        {
        }
...
public:
    npc_venture_co_straggler()
        : CreatureScript("npc_venture_co_straggler")
    {
    }

    struct npc_venture_co_stragglerAI : public ScriptedAI
    {
        npc_venture_co_stragglerAI(Creature* creature)
            : ScriptedAI(creature)
        {
        }
...
public:
    npc_lake_frog()
        : CreatureScript("npc_lake_frog")
    {
    }

    struct npc_lake_frogAI : public ScriptedAI
    {
        npc_lake_frogAI(Creature* creature)
            : ScriptedAI(creature)
        {
        }
            ...
            while (uint32 eventId = _events.ExecuteEvent())
            {
                switch (eventId)
                {
                    case EVENT_LAKEFROG_1:
                        ...
                        me->SetName("Maiden of Ashwood Lake");
...
public:
    spell_shredder_delivery()
        : SpellScriptLoader("spell_shredder_delivery")
    {
    }
...
{
public:
    npc_highland_mustangAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
...
enum Flamebringer
{
    SPELL_FLAMEBRINGER_SUMMON    = 48606,
    SPELL_RIDE_FLAMEBRINGER      = 48600,
    NPC_FLAMEBRINGER             = 27292
};

struct Position FlamebringerSpawnPos = { 2798.01f, -2505.25f, 47.61f, 3.72f };

struct npc_flamebringer : public VehicleAI
{
public:
    ...
    void sGossipSelect(Player* player, uint32 /*sender*/, uint32 /*action*/) override
    {
        ...
        if (player->IsMounted())
            player->Dismount();
        if (Creature* cr = me->SummonCreature(NPC_FLAMEBRINGER, FlamebringerSpawnPos, TEMPSUMMON_TIMED_DESPAWN, 300000))
        {
            cr->RemoveFlag(UNIT_NPC_FLAGS, UNIT_NPC_FLAG_GOSSIP);
            player->CastSpell(cr, SPELL_RIDE_FLAMEBRINGER, true);
