...
inline void SetCreatureAttackable(Creature* creature, bool apply)
{
    if (apply)
    {
        creature->SetImmuneToAll(false);
        creature->RemoveFlag(UNIT_FIELD_FLAGS, UNIT_FLAG_NON_ATTACKABLE | UNIT_FLAG_PACIFIED);
...
enum eProgress
{
    ...
    INSTANCE_PROGRESS_ARGENT_CHALLENGE_WITHOUT_SOLDIERS,
