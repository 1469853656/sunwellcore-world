...
enum Progress
{
    ...
    INSTANCE_PROGRESS_FACTION_CHAMPIONS_INTRO_DONE,
    INSTANCE_PROGRESS_FACTION_CHAMPIONS_DEAD = 6,
    INSTANCE_PROGRESS_VALKYR_INTRO_DONE,
    INSTANCE_PROGRESS_VALKYR_DEAD = 8,
    INSTANCE_PROGRESS_ANUBARAK_INTRO_DONE,
...
enum NPCs
{
    ...
    // Boost (Horde)
    NPC_HORDE_DEMON_HUNTER        = 110000,
    NPC_HORDE_ELEMENTAL_SHAMAN    = 110001,
    NPC_HORDE_FERAL_DRUID         = 110002,
    NPC_HORDE_BEAST_MASTER_HUNTER = 110003,
    NPC_HORDE_DEMONOLOGY_WARLOCK  = 110004,
    // Boost (Alliance)
    NPC_ALLIANCE_DEMON_HUNTER        = 110005,
    NPC_ALLIANCE_ELEMENTAL_SHAMAN    = 110006,
    NPC_ALLIANCE_FERAL_DRUID         = 110007,
    NPC_ALLIANCE_BEAST_MASTER_HUNTER = 110008,
    NPC_ALLIANCE_DEMONOLOGY_WARLOCK  = 110009,
    // Boost (Pets)
    NPC_BOOST_FELGUARD     = 110010,
    NPC_BOOST_LOQUENAHAK   = 110011,
    NPC_BOOST_KING_KRUSH   = 110012,
    NPC_BOOST_FERAL_SPIRIT = 110013,
...
Position const BoostFactionChampionLoc[] = {
    { 514.231f, 105.569f, 418.234f, 0 }, // 0 - Horde Initial Pos 0
    { 508.334f, 115.377f, 418.234f, 0 }, // 1 - Horde Initial Pos 1
    { 506.454f, 126.291f, 418.234f, 0 }, // 2 - Horde Initial Pos 2
    { 506.243f, 106.596f, 421.592f, 0 }, // 3 - Horde Initial Pos 3
    { 499.885f, 117.717f, 421.557f, 0 }, // 4 - Horde Initial Pos 4
    { 511.276f, 98.3740f, 421.580f, 0 }, // 5 - Horde Initial Pos 5 (Boost)

    { 613.127f, 100.443f, 419.74f, 0 },  // 6 - Ally Initial Pos 0
    { 621.126f, 128.042f, 418.231f, 0 }, // 7 - Ally Initial Pos 1
    { 618.829f, 113.606f, 418.232f, 0 }, // 8 - Ally Initial Pos 2
    { 625.845f, 112.914f, 421.575f, 0 }, // 9 - Ally Initial Pos 3
    { 615.566f, 109.653f, 418.234f, 0 }, // 10 - Ally Initial Pos 4
    { 628.135f, 122.641f, 421.566f, 0 }, // 11 - Ally Initial Pos 5 (Boost)

    { 535.469f, 113.012f, 394.55f, 0 }, // 12 - Final Pos 0
    { 526.417f, 137.465f, 394.55f, 0 }, // 13 - Final Pos 1
    { 528.108f, 111.057f, 394.55f, 0 }, // 14 - Final Pos 2
    { 519.92f, 134.285f, 394.55f, 0 },  // 15 - Final Pos 3
    { 533.648f, 119.148f, 394.55f, 0 }, // 16 - Final Pos 4
    { 531.399f, 125.63f, 394.55f, 0 },  // 17 - Final Pos 5
    { 528.958f, 131.47f, 394.55f, 0 },  // 18 - Final Pos 6
    { 526.309f, 116.667f, 394.55f, 0 }, // 19 - Final Pos 7
    { 524.238f, 122.411f, 394.55f, 0 }, // 20 - Final Pos 8
    { 521.901f, 128.488f, 394.55f, 0 }, // 21 - Final Pos 9
    { 533.086f, 106.667f, 394.55f, 0 }, // 22 - Final Pos 10 (Boost)
};
...
enum MiscStuff
{
    DATA_START_FIGHT_TIMER = 1000,
    DATA_GET_FIGHT_TIMER   = 1001
};
...
// Boost
Position const FeralDruidSpawnPositions[] = {
    { 563.36999f, 103.24748f, 394.53097f },
    { 563.49963f, 167.78463f, 394.53097f }
};
