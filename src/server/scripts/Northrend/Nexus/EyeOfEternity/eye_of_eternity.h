...
enum Data
{
    DATA_IRIS_ACTIVATED       = 0,
    DATA_ENCOUNTER_STATUS     = 1,
    DATA_SET_IRIS_INACTIVE    = 2,
    DATA_HIDE_IRIS_AND_PORTAL = 3,
    DATA_MALYGOS_GUID         = 4,
};
...
{
public:
    EoEDrakeEnterVehicleEvent(Creature& owner, uint64 playerGUID)
        : _owner(owner)
