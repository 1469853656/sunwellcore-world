                ...
                case DATA_ENCOUNTER_STATUS:
                    ...
                    switch (data)
                    {
                        case NOT_STARTED:
                            ...
                            break;
                        case IN_PROGRESS:
                            StartEncounterStatsCounting(NPC_MalygosGUID, "Malygos");
                        ...
                        case DONE:
                            ...
                            if (GameObject* go = instance->GetGameObject(GO_AlexstraszaGiftGUID))
                            {
                                ...
                                if (malygos)
                                    go->SetLootRecipient(malygos->GetLootRecipient(), malygos);
                            }
