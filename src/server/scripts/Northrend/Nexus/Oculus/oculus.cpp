...
public:
    npc_oculus_drakegiver()
        : CreatureScript("npc_oculus_drakegiver")
    {
    }
...
public:
    npc_oculus_drake()
        : CreatureScript("npc_oculus_drake")
    {
    }
    ...
    {
        npc_oculus_drakeAI(Creature* pCreature)
            : VehicleAI(pCreature)
        {
        ...
        void PassengerBoarded(Unit* who, int8 seatid, bool add) override
        {
            if (add)
            {
...
// 49838 - Stop Time
class spell_oculus_stop_time final : public SpellScript
{
    PrepareSpellScript(spell_oculus_stop_time)
    ...
    void FilterTargets(std::list<WorldObject*>& targets)
    {
        ...
        std::erase_if(targets, [](WorldObject const* target) { return target->IsPlayer(); });
    }

    void Register() override
    {
        OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_oculus_stop_time::FilterTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
    }
};
...
{
public:
    spell_oculus_shock_lance()
        : SpellScriptLoader("spell_oculus_shock_lance")
    {
    }
...
public:
    spell_oculus_dream_funnel()
        : SpellScriptLoader("spell_oculus_dream_funnel")
    {
    }
...
public:
    at_oculus_exit_5001()
        : AreaTriggerScript("at_oculus_exit_5001")
    {
    }
...
{
public:
    condition_cache_of_lay_guardian()
        : ConditionScript("condition_cache_of_lay_guardian")
    {
    }
...
void AddSC_oculus()
{
    ...
    RegisterSpellAndAuraScriptPair(spell_oculus_stop_time, spell_oculus_stop_time_aura);
