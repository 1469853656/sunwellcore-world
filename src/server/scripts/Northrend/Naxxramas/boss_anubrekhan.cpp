...
public:
    ...
    {
        boss_anubrekhanAI(Creature* creature)
            : BossAI(creature, EVENT_ANUB)
        {
            sayGreet = false;
        }
        ...
        void EnterCombat(Unit* who) override
        {
            ...
            events.ScheduleEvent(EVENT_SPELL_BERSERK, sCustomMgr->GetBoolConfig(CONFIG_NAXXRAMAS_25_BOOST_ENABLED) && me->GetMap()->Is25ManRaid() ? 300000 : 480000);
