...
public:
    ...
    struct boss_thaddiusAI : public BossAI
    {
        ...
        void DespawnThaddiusAtEvade()
        {
            ...
            if (GameObject* go = me->GetMap()->GetGameObject(instance->GetData64(DATA_THADDIUS_GATE)))
        ...
        void JustDied(Unit* /*killer*/) override
        {
            ...
            instance->DoRemoveAurasDueToSpellOnPlayers(28059);
            instance->DoRemoveAurasDueToSpellOnPlayers(28084);
        }
        ...
        void UpdateAI(uint32 diff) override
        {
            ...
            switch (events.GetEvent())
            {
                ...
                case EVENT_THADDIUS_START_2:
                    ...
                    events.ScheduleEvent(EVENT_THADDIUS_SPELL_BERSERK, sCustomMgr->GetBoolConfig(CONFIG_NAXXRAMAS_25_BOOST_ENABLED) && me->GetMap()->Is25ManRaid() ? 480000 : 540000);
                ...
                case EVENT_THADDIUS_POLARITY_SHIFT:
                    ...
                    PolarityDamage();
                    events.RepeatEvent(sCustomMgr->GetBoolConfig(CONFIG_NAXXRAMAS_25_BOOST_ENABLED) && me->GetMap()->Is25ManRaid() ? 20000 : 30000);
                    break;
            }
...
{
public:
    boss_thaddius_summon()
        : CreatureScript("boss_thaddius_summon")
    {
    }
