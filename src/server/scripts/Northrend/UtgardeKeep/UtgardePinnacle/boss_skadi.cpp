...
public:
    boss_skadi_grauf()
        : CreatureScript("boss_skadi_grauf")
    {
    }

    struct boss_skadi_graufAI : public VehicleAI
    {
        boss_skadi_graufAI(Creature* creature)
            : VehicleAI(creature)
            , instance(creature->GetInstanceScript())
            , summons(me)
        {
...
public:
    go_harpoon_canon()
        : GameObjectScript("go_harpoon_canon")
    {
    }
...
public:
    npc_ymirjar_warrior()
        : CreatureScript("npc_ymirjar_warrior")
    {
    }

    struct npc_ymirjar_warriorAI : public npc_skadi_trashAI
    {
        npc_ymirjar_warriorAI(Creature* creature)
            : npc_skadi_trashAI(creature)
        {
        }
...
public:
    npc_ymirjar_witch_doctor()
        : CreatureScript("npc_ymirjar_witch_doctor")
    {
    }

    struct npc_ymirjar_witch_doctorAI : public npc_skadi_trashAI
    {
        npc_ymirjar_witch_doctorAI(Creature* creature)
            : npc_skadi_trashAI(creature)
        {
        }
...
public:
    npc_ymirjar_harpooner()
        : CreatureScript("npc_ymirjar_harpooner")
    {
    }

    struct npc_ymirjar_harpoonerAI : public npc_skadi_trashAI
    {
        npc_ymirjar_harpoonerAI(Creature* creature)
            : npc_skadi_trashAI(creature)
        {
        }
...
{
public:
    spell_skadi_poisoned_spear()
        : SpellScriptLoader("spell_skadi_poisoned_spear")
    {
    }
...
{
public:
    spell_skadi_launch_harpoon()
        : SpellScriptLoader("spell_skadi_launch_harpoon")
    {
    }
...
{
public:
    spell_freezing_cloud_area_right()
        : SpellScriptLoader("spell_freezing_cloud_area_right")
    {
    }
...
{
public:
    spell_freezing_cloud_area_left()
...
{
public:
    spell_freezing_cloud_damage()
        : SpellScriptLoader("spell_freezing_cloud_damage")
    {
    }
