...
public:
    npc_massive_jormungar()
        : CreatureScript("npc_massive_jormungar")
    {
    }
...
public:
    npc_ferocious_rhino()
        : CreatureScript("npc_ferocious_rhino")
    {
    }
    ...
    {
        npc_ferocious_rhinoAI(Creature* pCreature)
            : ScriptedAI(pCreature)
        {
            m_pInstance = pCreature->GetInstanceScript();
        }
...
public:
    npc_ravenous_furbolg()
        : CreatureScript("npc_ravenous_furbolg")
    {
    }
    ...
    {
        npc_ravenous_furbolgAI(Creature* pCreature)
            : ScriptedAI(pCreature)
        {
            m_pInstance = pCreature->GetInstanceScript();
        }
...
public:
    npc_frenzied_worgen()
        : CreatureScript("npc_frenzied_worgen")
    {
    }
    ...
    {
        npc_frenzied_worgenAI(Creature* pCreature)
            : ScriptedAI(pCreature)
        {
            m_pInstance = pCreature->GetInstanceScript();
        }
...
public:
    go_palehoof_sphere()
        : GameObjectScript("go_palehoof_sphere")
    {
    }
