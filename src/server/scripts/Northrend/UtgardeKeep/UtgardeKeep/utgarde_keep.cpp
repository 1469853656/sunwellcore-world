...
public:
    ...
    {
        npc_dragonflayer_forge_masterAI(Creature* c)
            : ScriptedAI(c)
        {
...
public:
    npc_enslaved_proto_drake()
        : CreatureScript("npc_enslaved_proto_drake")
    {
    }

    struct npc_enslaved_proto_drakeAI : public ScriptedAI
    {
        npc_enslaved_proto_drakeAI(Creature* creature)
            : ScriptedAI(creature)
        {
            _setData = false;
        }
...
{
public:
    spell_ticking_time_bomb()
        : SpellScriptLoader("spell_ticking_time_bomb")
    {
    }
