...
public:
    npc_nerubar_victim()
        : CreatureScript("npc_nerubar_victim")
    {
    }
...
{
    npc_lunchboxAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
...
{
public:
    spell_blow_cenarion_horn()
        : SpellScriptLoader("spell_blow_cenarion_horn")
    {
    }
...
{
public:
    npc_stamped_creature()
        : CreatureScript("npc_stamped_creature")
    {
    }

    struct npc_stamped_creatureAI : public ScriptedAI
    {
        npc_stamped_creatureAI(Creature* creature)
            : ScriptedAI(creature)
        {
        }
...
{
    npc_oil_stained_wolfAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
...
{
    npc_den_verminAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
...
struct npc_reprogrammed_robot : ScriptedAI
{
    npc_reprogrammed_robot(Creature* creature) : ScriptedAI(creature) { }

    void IsSummonedBy(Unit* /*summoner*/) override
    {
        me->SetReactState(REACT_AGGRESSIVE);
        Talk(SAY_REPROGRAMMED);
    }
};
...
void AddSC_borean_tundra()
{
    ...
    RegisterCreatureAI(npc_reprogrammed_robot);
}
