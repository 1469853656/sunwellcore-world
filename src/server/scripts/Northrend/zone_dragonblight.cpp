            ...
            if (running)
            {
                ...
                if (timer != 0)
                {
                    ...
                    switch (step)
                    {
                        ...
                        case 1:
                        {
                            Creature* c = me->SummonCreature(NPC_OACHANOA, 2406.24f, 1701.98f, 0.1f, 0.3f, TEMPSUMMON_TIMED_DESPAWN, 90000, nullptr);
                            if (!c)
                            {
                                Reset();
                                return;
...
{
    npc_hourglass_of_eternityAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
...
{
    npc_future_youAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
...
public:
    npc_mindless_ghoul()
        : CreatureScript("npc_mindless_ghoul")
    {
    }
    ...
    {
        npc_mindless_ghoulAI(Creature* c)
            : ScriptedAI(c)
        {
            me->SetCorpseDelay(1);
        }
...
public:
    ...
    {
        npc_injured_7th_legion_soldierAI(Creature* c)
            : NullCreatureAI(c)
        {
        }
...
public:
    npc_heated_battle()
        : CreatureScript("npc_heated_battle")
    {
    }
    ...
    {
        npc_heated_battleAI(Creature* c)
            : CombatAI(c)
        {
        }
...
public:
    npc_q24545_lich_king()
        : CreatureScript("npc_q24545_lich_king")
    {
    }
...
{
public:
    SACActivateEvent(Creature* owner)
        : _owner(owner)
    {
    }
...
{
public:
    SACDeactivateEvent(Creature* owner)
        : _owner(owner)
    {
    }
...
public:
    ...
    {
        npc_q24545_wretched_ghoulAI(Creature* c)
            : ScriptedAI(c)
        {
            Deactivate();
        }
...
{
public:
    explicit GhoulTargetCheck(bool alive)
        : _alive(alive)
    {
    }
...
public:
    spell_q24545_aod_special()
        : SpellScriptLoader("spell_q24545_aod_special")
    {
    }
...
public:
    npc_q24545_vegard_dummy()
        : CreatureScript("npc_q24545_vegard_dummy")
    {
    }
    ...
    {
        npc_q24545_vegard_dummyAI(Creature* c)
            : NullCreatureAI(c)
        {
            done = false;
        }
...
public:
    npc_q24545_vegard()
        : CreatureScript("npc_q24545_vegard")
    {
    }
    ...
    {
        npc_q24545_vegardAI(Creature* c)
            : ScriptedAI(c)
        {
            me->SetReactState(REACT_PASSIVE);
...
{
public:
    npc_spiritual_insight()
        : CreatureScript("npc_spiritual_insight")
    {
    }
    ...
    {
        npc_spiritual_insightAI(Creature* c)
            : NullCreatureAI(c)
        {
        }
...
public:
    spell_q12096_q12092_dummy()
        : SpellScriptLoader("spell_q12096_q12092_dummy")
    {
    }
...
public:
    spell_q12096_q12092_bark()
        : SpellScriptLoader("spell_q12096_q12092_bark")
    {
    }
...
public:
    npc_torturer_lecraft()
        : CreatureScript("npc_torturer_lecraft")
    {
    }

    struct npc_torturer_lecraftAI : public ScriptedAI
    {
        npc_torturer_lecraftAI(Creature* creature)
            : ScriptedAI(creature)
        {
            _playerGUID = 0;
        }
...
enum Onslaught_warhorse
{
    ...
    SPELL_EJECT_ALL          = 50630,
    SPELL_PLAGUE_SHOWER      = 48298,
...
{
    npc_onslaught_warhorseAI(Creature* creature)
        : ScriptedAI(creature)
        , summons(me)
    {
    }
...
{
    npc_onslaught_knightAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
...
public:
    spell_mystical_bolt()
        : SpellScriptLoader("spell_mystical_bolt")
    {
    }
...
{
public:
    npc_sarathstra_dragonblight()
        : CreatureScript("npc_sarathstra_dragonblight")
    {
    }

    struct npc_sarathstra_dragonblight_AI : public ScriptedAI
    {
        npc_sarathstra_dragonblight_AI(Creature* creature)
            : ScriptedAI(creature)
        {
            _spawned = false;
        }
...
{
public:
    npc_overlord_agmar_dragonblightAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
...
{
    npc_roanauk_icemistAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
...
public:
    npc_wintergarde_gryphon()
        : CreatureScript("npc_wintergarde_gryphon")
    {
    }

    struct npc_wintergarde_gryphonAI : public VehicleAI
    {
        npc_wintergarde_gryphonAI(Creature* creature)
            : VehicleAI(creature)
        {
        }
