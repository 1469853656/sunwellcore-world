...
{
    npc_watcher_gashraAI(Creature* creature)
        : npc_gatewatcher_petAI(creature, true)
    {
    }
...
{
    npc_watcher_narjilAI(Creature* creature)
        : npc_gatewatcher_petAI(creature, true)
    {
    }
...
{
    npc_watcher_silthikAI(Creature* creature)
        : npc_gatewatcher_petAI(creature, true)
    {
    }
...
{
    npc_anub_ar_warriorAI(Creature* creature)
        : npc_gatewatcher_petAI(creature, false)
    {
    }
...
{
    npc_anub_ar_skirmisherAI(Creature* creature)
        : npc_gatewatcher_petAI(creature, false)
    {
    }
...
{
    npc_anub_ar_shadowcasterAI(Creature* creature)
        : npc_gatewatcher_petAI(creature, false)
    {
    }
...
{
    npc_skittering_swarmerAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
...
{
    npc_skittering_infectorAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
...
{
    npc_gatewatcher_web_wrapAI(Creature* creature)
