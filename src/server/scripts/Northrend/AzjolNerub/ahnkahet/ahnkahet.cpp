...
{
    npc_deep_crawlerAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
...
{
    npc_ahnkahar_spell_flingerAI(Creature* creature)
        : ScriptedAI(creature)
    {
...
{
    npc_ahnkahar_slasherAI(Creature* creature)
        : ScriptedAI(creature)
    {
        _scheduler.SetValidator([this] { return !me->HasUnitState(UNIT_STATE_CASTING); });
    }
...
{
    npc_plundering_geistAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
...
{
    npc_eye_of_taldaramAI(Creature* creature)
        : ScriptedAI(creature)
    {
        _scheduler.SetValidator([this] { return !me->HasUnitState(UNIT_STATE_CASTING); });
    }
...
{
    npc_bonegrinderAI(Creature* creature)
        : ScriptedAI(creature)
    {
        _scheduler.SetValidator([this] { return !me->HasUnitState(UNIT_STATE_CASTING); });
    }
...
{
    npc_frostbringerAI(Creature* creature)
        : ScriptedAI(creature)
    {
        _scheduler.SetValidator([this] { return !me->HasUnitState(UNIT_STATE_CASTING); });
    }
...
{
    npc_twilight_apostleAI(Creature* creature)
        : ScriptedAI(creature)
    {
        _scheduler.SetValidator([this] { return !me->HasUnitState(UNIT_STATE_CASTING); });
    }
...
{
    npc_twilight_darkcasterAI(Creature* creature)
        : ScriptedAI(creature)
    {
        _scheduler.SetValidator([this] { return !me->HasUnitState(UNIT_STATE_CASTING); });
    }
...
{
    npc_forgotten_oneAI(Creature* creature)
        : ScriptedAI(creature)
    {
        _scheduler.SetValidator([this] { return !me->HasUnitState(UNIT_STATE_CASTING); });
    }
...
{
    npc_ahnkahar_web_winderAI(Creature* creature)
        : ScriptedAI(creature)
    {
        _scheduler.SetValidator([this] { return !me->HasUnitState(UNIT_STATE_CASTING); });
    }
