...
{
    npc_amanitar_healthy_mushroomAI(Creature* creature)
        : npc_amanitar_mushroomsAI(creature)
    {
    }
...
{
    npc_amanitar_poisonous_mushroomAI(Creature* creature)
        : npc_amanitar_mushroomsAI(creature)
    {
    }
