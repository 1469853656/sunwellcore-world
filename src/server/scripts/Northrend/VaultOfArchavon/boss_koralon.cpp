...
{
public:
    spell_voa_flaming_cinder()
        : SpellScriptLoader("spell_voa_flaming_cinder")
    {
    }
...
{
public:
    spell_koralon_burning_breath()
        : SpellScriptLoader("spell_koralon_burning_breath")
    {
    }
