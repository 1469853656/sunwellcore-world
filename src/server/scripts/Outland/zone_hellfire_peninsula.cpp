...
public:
    npc_ancestral_wolf()
        : CreatureScript("npc_ancestral_wolf")
    {
    }
...
public:
    npc_wounded_blood_elf()
        : CreatureScript("npc_wounded_blood_elf")
    {
    }
...
{
    npc_deranged_helboarAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
...
{
public:
    npc_foreman_razelcraz()
        : CreatureScript("npc_foreman_razelcraz")
    {
    }
...
public:
    npc_fel_cannon_mki()
        : CreatureScript("npc_fel_cannon_mki")
    {
    }

    struct npc_fel_cannon_mkiAI : public ScriptedAI
    {
        npc_fel_cannon_mkiAI(Creature* creature)
            : ScriptedAI(creature)
        {
...
public:
    npc_aggonis()
        : CreatureScript("npc_aggonis")
    {
    }

    struct npc_aggonisAI : public ScriptedAI
    {
        npc_aggonisAI(Creature* creature)
            : ScriptedAI(creature)
        {
        }
...
{
public:
    explicit AbyssalShelfRespawn(Creature& owner)
        : _owner(owner)
    {
    }
...
{
    npc_abyssal_shelfAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
...
{
    npc_demoniac_scryerAI(Creature* creature)
        : ScriptedAI(creature)
        , _summons(creature)
    {
        _summons.DespawnAll();
