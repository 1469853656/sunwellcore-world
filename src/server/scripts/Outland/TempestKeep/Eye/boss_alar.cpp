...
{
public:
    CastQuill(Unit* caster, uint32 spellId)
        : _caster(caster)
        , _spellId(spellId)
    {
    }
...
{
public:
    spell_alar_flame_quills()
        : SpellScriptLoader("spell_alar_flame_quills")
    {
    }
...
{
public:
    spell_alar_ember_blast()
        : SpellScriptLoader("spell_alar_ember_blast")
    {
    }
...
{
public:
    spell_alar_ember_blast_death()
        : SpellScriptLoader("spell_alar_ember_blast_death")
    {
    }
...
{
public:
    spell_alar_dive_bomb()
        : SpellScriptLoader("spell_alar_dive_bomb")
    {
    }
