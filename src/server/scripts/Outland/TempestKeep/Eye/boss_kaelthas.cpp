...
{
public:
    spell_kaelthas_kael_phase_two()
        : SpellScriptLoader("spell_kaelthas_kael_phase_two")
    {
    }
...
public:
    spell_kaelthas_remote_toy()
        : SpellScriptLoader("spell_kaelthas_remote_toy")
    {
    }
...
{
public:
    spell_kaelthas_summon_weapons()
        : SpellScriptLoader("spell_kaelthas_summon_weapons")
    {
    }
...
{
public:
    spell_kaelthas_resurrection()
        : SpellScriptLoader("spell_kaelthas_resurrection")
    {
    }
...
public:
    spell_kaelthas_mind_control()
        : SpellScriptLoader("spell_kaelthas_mind_control")
    {
    }
...
public:
    spell_kaelthas_burn()
        : SpellScriptLoader("spell_kaelthas_burn")
    {
    }
...
{
public:
    spell_kaelthas_flame_strike()
        : SpellScriptLoader("spell_kaelthas_flame_strike")
    {
    }
...
public:
    spell_kaelthas_gravity_lapse()
        : SpellScriptLoader("spell_kaelthas_gravity_lapse")
    {
    }
...
public:
    spell_kaelthas_nether_beam()
        : SpellScriptLoader("spell_kaelthas_nether_beam")
    {
    }
...
public:
    spell_kaelthas_summon_nether_vapor()
        : SpellScriptLoader("spell_kaelthas_summon_nether_vapor")
    {
    }
