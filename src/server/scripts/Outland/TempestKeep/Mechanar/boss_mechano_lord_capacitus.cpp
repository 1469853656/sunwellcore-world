...
public:
    boss_mechano_lord_capacitus()
        : CreatureScript("boss_mechano_lord_capacitus")
    {
    }
...
public:
    spell_capacitus_polarity_charge()
        : SpellScriptLoader("spell_capacitus_polarity_charge")
    {
    }
...
{
public:
    spell_capacitus_polarity_shift()
        : SpellScriptLoader("spell_capacitus_polarity_shift")
    {
    }
