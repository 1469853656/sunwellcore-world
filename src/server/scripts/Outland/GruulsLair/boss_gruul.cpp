...
public:
    spell_gruul_ground_slam()
        : SpellScriptLoader("spell_gruul_ground_slam")
    {
    }
...
{
public:
    spell_gruul_ground_slam_trigger()
        : SpellScriptLoader("spell_gruul_ground_slam_trigger")
    {
    }
...
public:
    spell_gruul_shatter()
        : SpellScriptLoader("spell_gruul_shatter")
    {
    }
...
public:
    spell_gruul_shatter_effect()
        : SpellScriptLoader("spell_gruul_shatter_effect")
    {
    }
