...
public:
    boss_high_king_maulgar()
        : CreatureScript("boss_high_king_maulgar")
    {
    }
...
public:
    boss_kiggler_the_crazed()
        : CreatureScript("boss_kiggler_the_crazed")
    {
    }
...
public:
    boss_blindeye_the_seer()
        : CreatureScript("boss_blindeye_the_seer")
    {
    }
...
public:
    boss_krosh_firehand()
        : CreatureScript("boss_krosh_firehand")
    {
    }
