...
public:
    npc_invis_infernal_caster()
        : CreatureScript("npc_invis_infernal_caster")
    {
    }
...
public:
    npc_infernal_attacker()
        : CreatureScript("npc_infernal_attacker")
    {
    }
...
public:
    npc_dragonmaw_peon()
        : CreatureScript("npc_dragonmaw_peon")
    {
    }
    ...
    {
        npc_dragonmaw_peonAI(Creature* creature)
            : ScriptedAI(creature)
        {
        }
...
public:
    npc_drake_dealer_hurlunk()
        : CreatureScript("npc_drake_dealer_hurlunk")
    {
    }
...
public:
    ...
    struct npc_earthmender_wildaAI : public npc_escortAI
    {
        ...
        void WaypointReached(uint32 waypointId) override
        {
            ...
            {
                case 0:
                    Talk(SAY_START_2, player);
                    break;
                case 10:
                    events.ScheduleEvent(EVENT_FREE_ELEMENTAL, 1s);
                    break;
                case 15:
                ...
                case 20:
                    ...
                    break;
                case 25:
                    Talk(RAND(SAY_PROGRESS2, SAY_PROGRESS4, SAY_PROGRESS5), player);
                    break;
                case 28:
                    SummonAssassin();
                    break;
                case 31:
                    Talk(SAY_PROGRESS6, player);
                    break;
                case 35:
                    Talk(RAND(SAY_PROGRESS2, SAY_PROGRESS4, SAY_PROGRESS5), player);
                    break;
                ...
                case 44:
                    ...
                    player->GroupEventHappens(QUEST_ESCAPE_FROM_COILSKAR_CISTERN, nullptr);
                    Completed = true;
                    break;
            }
        }
...
public:
    npc_lord_illidan_stormrage()
        : CreatureScript("npc_lord_illidan_stormrage")
    {
    }
...
public:
    npc_illidari_spawn()
        : CreatureScript("npc_illidari_spawn")
    {
    }
...
public:
    go_crystal_prison()
        : GameObjectScript("go_crystal_prison")
    {
    }
...
public:
    npc_enraged_spirit()
        : CreatureScript("npc_enraged_spirit")
    {
    }
...
public:
    npc_shadowmoon_tuber_node()
        : CreatureScript("npc_shadowmoon_tuber_node")
    {
    }
...
{
public:
    npc_karsius_the_ancient()
        : CreatureScript("npc_karsius_the_ancient")
    {
    }

    struct npc_karsius_the_ancient_AI : public ScriptedAI
    {
        npc_karsius_the_ancient_AI(Creature* creature)
            : ScriptedAI(creature)
        {
        }
...
{
public:
    npc_captain_skyshatter()
        : CreatureScript("npc_captain_skyshatter")
    {
    }
    ...
    {
        npc_captain_skyshatterAI(Creature* creature)
            : npc_escortAI(creature)
        {
        }
        ...
        void UpdateEscortAI(uint32 const diff) override
        {
            ...
            for (int i = 0; i < MAX_MISSLES; i++)
            {
                ...
                {
                    if (Creature* target = me->SummonCreature(NPC_DRAGONMAW_RACE_SKYSHATTERS_TARGET, player->GetPositionX(), player->GetPositionY(), player->GetPositionZ(), player->GetOrientation(), TEMPSUMMON_TIMED_DESPAWN, 5000))
                    {
