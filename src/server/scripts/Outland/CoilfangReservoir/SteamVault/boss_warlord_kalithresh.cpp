...
public:
    boss_warlord_kalithresh()
        : CreatureScript("boss_warlord_kalithresh")
    {
    }
    ...
    {
        boss_warlord_kalithreshAI(Creature* creature)
            : ScriptedAI(creature)
        {
...
public:
    npc_naga_distiller()
        : CreatureScript("npc_naga_distiller")
    {
    }
    ...
    {
        npc_naga_distillerAI(Creature* creature)
