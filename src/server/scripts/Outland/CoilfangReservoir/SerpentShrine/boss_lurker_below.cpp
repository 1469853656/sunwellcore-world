...
public:
    boss_the_lurker_below()
        : CreatureScript("boss_the_lurker_below")
    {
    }
...
public:
    go_strange_pool()
        : GameObjectScript("go_strange_pool")
    {
    }
...
public:
    spell_lurker_below_spout()
        : SpellScriptLoader("spell_lurker_below_spout")
    {
    }
...
{
public:
    spell_lurker_below_spout_cone()
        : SpellScriptLoader("spell_lurker_below_spout_cone")
    {
    }
