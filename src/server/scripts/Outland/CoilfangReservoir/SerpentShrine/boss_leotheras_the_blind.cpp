...
public:
    boss_leotheras_the_blind()
        : CreatureScript("boss_leotheras_the_blind")
    {
    }
...
public:
    npc_inner_demon()
        : CreatureScript("npc_inner_demon")
    {
    }
    ...
    {
        npc_inner_demonAI(Creature* creature)
            : ScriptedAI(creature)
        {
        }
...
public:
    spell_leotheras_whirlwind()
        : SpellScriptLoader("spell_leotheras_whirlwind")
    {
    }
...
public:
    spell_leotheras_chaos_blast()
        : SpellScriptLoader("spell_leotheras_chaos_blast")
    {
    }
...
public:
    spell_leotheras_insidious_whisper()
        : SpellScriptLoader("spell_leotheras_insidious_whisper")
    {
    }
...
{
public:
    spell_leotheras_demon_link()
        : SpellScriptLoader("spell_leotheras_demon_link")
    {
    }
...
{
public:
    spell_leotheras_clear_consuming_madness()
