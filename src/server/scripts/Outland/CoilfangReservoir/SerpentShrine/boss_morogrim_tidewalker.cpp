...
public:
    boss_morogrim_tidewalker()
        : CreatureScript("boss_morogrim_tidewalker")
    {
    }
    ...
    {
        boss_morogrim_tidewalkerAI(Creature* creature)
...
public:
    spell_morogrim_tidewalker_watery_grave()
        : SpellScriptLoader("spell_morogrim_tidewalker_watery_grave")
    {
    }
...
{
public:
    spell_morogrim_tidewalker_water_globule_new_target()
        : SpellScriptLoader("spell_morogrim_tidewalker_water_globule_new_target")
    {
    }
