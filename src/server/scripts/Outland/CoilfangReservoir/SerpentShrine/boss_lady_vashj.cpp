...
public:
    boss_lady_vashj()
        : CreatureScript("boss_lady_vashj")
    {
    }
    ...
    struct boss_lady_vashjAI : public BossAI
    {
        boss_lady_vashjAI(Creature* creature)
            : BossAI(creature, DATA_LADY_VASHJ)
        {
            intro = false;
        }
...
{
public:
    spell_lady_vashj_magic_barrier()
        : SpellScriptLoader("spell_lady_vashj_magic_barrier")
    {
    }
...
public:
    spell_lady_vashj_remove_tainted_cores()
        : SpellScriptLoader("spell_lady_vashj_remove_tainted_cores")
    {
    }
...
{
public:
    spell_lady_vashj_summon_sporebat()
        : SpellScriptLoader("spell_lady_vashj_summon_sporebat")
    {
    }
...
public:
    spell_lady_vashj_spore_drop_effect()
        : SpellScriptLoader("spell_lady_vashj_spore_drop_effect")
    {
    }
