...
public:
    boss_hydross_the_unstable()
        : CreatureScript("boss_hydross_the_unstable")
    {
    }
    ...
    struct boss_hydross_the_unstableAI : public BossAI
    {
        boss_hydross_the_unstableAI(Creature* creature)
            : BossAI(creature, DATA_HYDROSS_THE_UNSTABLE)
        {
        }
...
public:
    spell_hydross_cleansing_field_aura()
        : SpellScriptLoader("spell_hydross_cleansing_field_aura")
    {
    }
...
public:
    spell_hydross_cleansing_field_command()
        : SpellScriptLoader("spell_hydross_cleansing_field_command")
    {
    }
