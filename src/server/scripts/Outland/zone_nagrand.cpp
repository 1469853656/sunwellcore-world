...
public:
    npc_maghar_captive()
        : CreatureScript("npc_maghar_captive")
    {
    }
...
public:
    go_corkis_prison()
        : GameObjectScript("go_corkis_prison")
    {
    }
...
public:
    npc_kurenai_captive()
        : CreatureScript("npc_kurenai_captive")
    {
    }
...
public:
    go_warmaul_prison()
        : GameObjectScript("go_warmaul_prison")
    {
    }
