...
public:
    ...
    {
        boss_murmurAI(Creature* creature)
            : ScriptedAI(creature)
        {
...
{
public:
    spell_murmur_sonic_boom_effect()
        : SpellScriptLoader("spell_murmur_sonic_boom_effect")
    {
    }
    ...
    class spell_murmur_sonic_boom_effect_SpellScript : public SpellScript
    {
        PrepareSpellScript(spell_murmur_sonic_boom_effect_SpellScript)
            ...
            public : spell_murmur_sonic_boom_effect_SpellScript()
            : SpellScript()
        {
        }
...
{
public:
    spell_murmur_thundering_storm()
        : SpellScriptLoader("spell_murmur_thundering_storm")
    {
    }
