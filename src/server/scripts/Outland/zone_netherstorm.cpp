...
public:
    npc_captain_saeed()
        : CreatureScript("npc_captain_saeed")
    {
    }
...
public:
    npc_commander_dawnforge()
        : CreatureScript("npc_commander_dawnforge")
    {
    }
...
public:
    at_commander_dawnforge()
        : AreaTriggerScript("at_commander_dawnforge")
    {
    }
...
public:
    npc_professor_dabiri()
        : CreatureScript("npc_professor_dabiri")
    {
    }
...
public:
    npc_phase_hunter()
        : CreatureScript("npc_phase_hunter")
    {
    }
...
public:
    npc_maxx_a_million_escort()
        : CreatureScript("npc_maxx_a_million_escort")
    {
    }
...
{
    npc_naberiusAI(Creature* creature)
        : ScriptedAI(creature)
    {
    }
