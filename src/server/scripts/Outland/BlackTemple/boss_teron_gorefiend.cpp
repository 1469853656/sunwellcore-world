...
public:
    boss_teron_gorefiend()
        : CreatureScript("boss_teron_gorefiend")
    {
    }
    ...
    struct boss_teron_gorefiendAI : public BossAI
    {
        boss_teron_gorefiendAI(Creature* creature)
            : BossAI(creature, DATA_TERON_GOREFIEND)
        {
            intro = false;
        }
...
public:
    spell_teron_gorefiend_shadow_of_death()
        : SpellScriptLoader("spell_teron_gorefiend_shadow_of_death")
    {
    }
...
public:
    spell_teron_gorefiend_spirit_lance()
        : SpellScriptLoader("spell_teron_gorefiend_spirit_lance")
    {
    }
...
public:
    spell_teron_gorefiend_spiritual_vengeance()
        : SpellScriptLoader("spell_teron_gorefiend_spiritual_vengeance")
    {
    }
...
public:
    spell_teron_gorefiend_shadowy_construct()
        : SpellScriptLoader("spell_teron_gorefiend_shadowy_construct")
    {
    }
