...
public:
    boss_shade_of_akama()
        : CreatureScript("boss_shade_of_akama")
    {
    }
...
public:
    npc_akama_shade()
        : CreatureScript("npc_akama_shade")
    {
    }
...
public:
    npc_creature_generator_akama()
        : CreatureScript("npc_creature_generator_akama")
    {
    }
...
public:
    spell_shade_of_akama_shade_soul_channel()
        : SpellScriptLoader("spell_shade_of_akama_shade_soul_channel")
    {
    }
...
{
public:
    spell_shade_of_akama_akama_soul_expel()
        : SpellScriptLoader("spell_shade_of_akama_akama_soul_expel")
    {
    }
