...
public:
    boss_illidan_stormrage()
        : CreatureScript("boss_illidan_stormrage")
    {
    }
...
public:
    npc_akama_illidan()
        : CreatureScript("npc_akama_illidan")
    {
    }
...
public:
    spell_illidan_draw_soul()
        : SpellScriptLoader("spell_illidan_draw_soul")
    {
    }
...
public:
    spell_illidan_flame_burst()
        : SpellScriptLoader("spell_illidan_flame_burst")
    {
    }
...
public:
    spell_illidan_cage_trap()
        : SpellScriptLoader("spell_illidan_cage_trap")
    {
    }
