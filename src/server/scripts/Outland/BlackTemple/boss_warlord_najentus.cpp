...
public:
    ...
    {
        boss_najentusAI(Creature* creature)
            : BossAI(creature, DATA_HIGH_WARLORD_NAJENTUS)
        {
        }
...
{
public:
    spell_najentus_needle_spine()
        : SpellScriptLoader("spell_najentus_needle_spine")
    {
    }
...
public:
    spell_najentus_hurl_spine()
        : SpellScriptLoader("spell_najentus_hurl_spine")
    {
    }
