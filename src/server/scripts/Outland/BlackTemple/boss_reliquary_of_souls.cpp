...
public:
    boss_reliquary_of_souls()
        : CreatureScript("boss_reliquary_of_souls")
    {
    }
...
public:
    boss_essence_of_suffering()
        : CreatureScript("boss_essence_of_suffering")
    {
    }
...
public:
    boss_essence_of_desire()
        : CreatureScript("boss_essence_of_desire")
    {
    }
...
public:
    boss_essence_of_anger()
        : CreatureScript("boss_essence_of_anger")
    {
    }
