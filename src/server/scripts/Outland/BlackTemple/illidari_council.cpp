...
{
public:
    VerasEnvenom(Unit& owner, uint64 targetGUID)
        : _owner(owner)
...
public:
    boss_illidari_council()
        : CreatureScript("boss_illidari_council")
    {
    }
...
{
    boss_illidari_council_memberAI(Creature* creature)
        : ScriptedAI(creature)
    {
...
public:
    boss_lady_malande()
        : CreatureScript("boss_lady_malande")
    {
    }
...
public:
    boss_veras_darkshadow()
        : CreatureScript("boss_veras_darkshadow")
    {
    }
