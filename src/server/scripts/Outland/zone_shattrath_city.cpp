...
public:
    npc_raliq_the_drunk()
        : CreatureScript("npc_raliq_the_drunk")
    {
    }
...
public:
    npc_shattrathflaskvendors()
        : CreatureScript("npc_shattrathflaskvendors")
    {
    }
