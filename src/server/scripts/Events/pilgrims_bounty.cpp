...
public:
    npc_pilgrims_bounty_chair()
        : CreatureScript("npc_pilgrims_bounty_chair")
    {
    }

    struct npc_pilgrims_bounty_chairAI : public VehicleAI
    {
        npc_pilgrims_bounty_chairAI(Creature* creature)
            : VehicleAI(creature)
        {
            plateGUID        = 0;
            timerSpawnPlate  = 1;
...
{
public:
    npc_pilgrims_bounty_plate()
        : CreatureScript("npc_pilgrims_bounty_plate")
    {
    }

    struct npc_pilgrims_bounty_plateAI : public NullCreatureAI
    {
        npc_pilgrims_bounty_plateAI(Creature* creature)
...
public:
    spell_pilgrims_bounty_pass_generic()
        : SpellScriptLoader("spell_pilgrims_bounty_pass_generic")
    {
    }
...
{
public:
    spell_pilgrims_bounty_feast_on_generic()
        : SpellScriptLoader("spell_pilgrims_bounty_feast_on_generic")
    {
    }
...
{
public:
    spell_pilgrims_bounty_turkey_tracker()
        : SpellScriptLoader("spell_pilgrims_bounty_turkey_tracker")
    {
    }
...
public:
    spell_pilgrims_bounty_serve_generic()
        : SpellScriptLoader("spell_pilgrims_bounty_serve_generic")
    {
    }
...
{
public:
    spell_pilgrims_bounty_food()
        : SpellScriptLoader("spell_pilgrims_bounty_food")
    {
    }
