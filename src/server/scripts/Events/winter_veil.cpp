...
{
public:
    spell_winter_veil_mistletoe()
        : SpellScriptLoader("spell_winter_veil_mistletoe")
    {
    }
    ...
    class spell_winter_veil_mistletoe_SpellScript : public SpellScript
    {
        ...
        {
            if (!sSpellMgr->GetSpellInfo(SPELL_CREATE_MISTLETOE) || !sSpellMgr->GetSpellInfo(SPELL_CREATE_HOLLY) || !sSpellMgr->GetSpellInfo(SPELL_CREATE_SNOWFLAKES))
                return false;
            return true;
        }
...
{
public:
    spell_winter_wondervolt_trap()
        : SpellScriptLoader("spell_winter_wondervolt_trap")
    {
    }
...
{
public:
    spell_winter_veil_racer_rocket_slam()
        : SpellScriptLoader("spell_winter_veil_racer_rocket_slam")
    {
    }
...
public:
    spell_winter_veil_racer_slam_hit()
        : SpellScriptLoader("spell_winter_veil_racer_slam_hit")
    {
    }
...
{
public:
    spell_winter_veil_shoot_air_rifle()
        : SpellScriptLoader("spell_winter_veil_shoot_air_rifle")
    {
    }
