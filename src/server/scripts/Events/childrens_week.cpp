...
public:
    npc_winterfin_playmate()
        : CreatureScript("npc_winterfin_playmate")
    {
    }
...
public:
    npc_snowfall_glade_playmate()
        : CreatureScript("npc_snowfall_glade_playmate")
    {
    }
...
public:
    npc_the_biggest_tree()
        : CreatureScript("npc_the_biggest_tree")
    {
    }
...
public:
    npc_high_oracle_soo_roo()
        : CreatureScript("npc_high_oracle_soo_roo")
    {
    }
...
public:
    npc_elder_kekek()
        : CreatureScript("npc_elder_kekek")
    {
    }
...
public:
    npc_the_etymidian()
        : CreatureScript("npc_the_etymidian")
    {
    }
...
public:
    npc_alexstraza_the_lifebinder()
        : CreatureScript("npc_alexstraza_the_lifebinder")
    {
    }
...
public:
    at_bring_your_orphan_to()
        : AreaTriggerScript("at_bring_your_orphan_to")
    {
    }
    ...
    bool OnTrigger(Player* player, AreaTriggerEntry const* trigger)
    {
        ...
        switch (trigger->id)
        {
            ...
            case AT_STONEWROUGHT_DAM:
                ...
                break;
            case AT_DARK_PORTAL:
                questId  = player->GetTeam(CF_DENY) == TEAM_ALLIANCE ? QUEST_DARK_PORTAL_A : QUEST_DARK_PORTAL_H;
                orphanId = player->GetTeam(CF_DENY) == TEAM_ALLIANCE ? ORPHAN_DRAENEI : ORPHAN_BLOOD_ELF;
                break;
        }
...
public:
    npc_cw_area_trigger()
        : CreatureScript("npc_cw_area_trigger")
    {
    }
                    ...
                    if (player->HasAura(SPELL_ORPHAN_OUT))
                    {
                        ...
                        switch (me->GetEntry())
                        {
                            case NPC_CAVERNS_OF_TIME_CW_TRIGGER:
                                questId  = player->GetTeam(CF_DENY) == TEAM_ALLIANCE ? QUEST_TIME_TO_VISIT_THE_CAVERNS_A : QUEST_TIME_TO_VISIT_THE_CAVERNS_H;
                                orphanId = player->GetTeam(CF_DENY) == TEAM_ALLIANCE ? ORPHAN_DRAENEI : ORPHAN_BLOOD_ELF;
                                break;
...
public:
    npc_grizzlemaw_cw_trigger()
        : CreatureScript("npc_grizzlemaw_cw_trigger")
    {
    }
